#ifndef UE4SS_SDK_UI_Easter_2022_Banner_HPP
#define UE4SS_SDK_UI_Easter_2022_Banner_HPP

class UUI_Easter_2022_Banner_C : public UUserWidget
{
    ...
    void Construct();
    void ExecuteUbergraph_UI_Easter_2022_Banner(int32 EntryPoint);
};
