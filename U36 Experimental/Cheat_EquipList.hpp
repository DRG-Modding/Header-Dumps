...
class UCheat_EquipList_C : public UUserWidget
{
    ...
    void AddEntry(FText InName, FText InDescription, bool InOwned, bool InEquipped, class UObject* InData, FText InCategory, bool AlwaysOwned, class UCheat_EquipList_Entry_C*& OutEntryWidget);
    void Clear();
