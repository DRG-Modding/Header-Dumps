...
class UCharacterVanityComponent : public UActorComponent
{
    ...
    class UVanityItem* SpecialTemporaryArmor;
...
class ACoilGun : public AChargedWeapon
{
    ...
    TArray<class TSubclassOf<UStatusEffect>> NoSpreadEffects;
...
class ACrossbowProjectileBase : public AProjectile
{
    ...
    void OnCrossbowDamageDealt(const FHitResult& HitResult);
...
class AMicrowaveWeapon : public AAmmoDrivenWeapon
{
    ...
    TSubclassOf<class AActor> ExplodableBlisterClass;
    ...
    class UEnemyTemperatureComponent* FrostShockTarget;
    bool SlowOnHit;
