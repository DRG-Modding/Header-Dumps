...
enum class EHeavyParticleCannonUpgrade {
    ...
    BoosterModule = 1,
    KillAddsBeamSeconds = 2,
    RadialDamageIncPerSecond = 3,
    RadialRangeIncPerSecond = 4,
    BulkyBeam = 5,
    ProjectionModule = 6,
    EHeavyParticleCannonUpgrade_MAX = 7,
};
...
enum class ECrossbowUpgrades {
    ...
    Pentafork = 9,
    BattleFrenzy = 10,
    IncreaseSpecialAmmo = 11,
    IncreaseSpecialAmmoPercent = 12,
    SuperFast = 13,
    IncreaseSpecialEffectDuration = 14,
    FasterSwitch = 15,
    CryoArrow = 16,
    FireArrow = 17,
    ReloadTimeDefaultArrow = 18,
    RateOfFireDefaultArrow = 19,
    ECrossbowUpgrades_MAX = 20,
};
