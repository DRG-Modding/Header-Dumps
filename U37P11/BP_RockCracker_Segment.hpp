#ifndef UE4SS_SDK_BP_RockCracker_Segment_HPP
#define UE4SS_SDK_BP_RockCracker_Segment_HPP

class ABP_RockCracker_Segment_C : public AFuelLineSegment
{
    ...
    void ExecuteUbergraph_BP_RockCracker_Segment(int32 EntryPoint);
};
