#ifndef UE4SS_SDK_SLVL_SpaceRig_Season03_HPP
#define UE4SS_SDK_SLVL_SpaceRig_Season03_HPP

class ASLVL_SpaceRig_Season03_C : public ALevelScriptActor
{
    ...
    void ExecuteUbergraph_SLVL_SpaceRig_Season03(int32 EntryPoint);
};
