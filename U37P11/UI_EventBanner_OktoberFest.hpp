#ifndef UE4SS_SDK_UI_EventBanner_OktoberFest_HPP
#define UE4SS_SDK_UI_EventBanner_OktoberFest_HPP

class UUI_EventBanner_OktoberFest_C : public UUserWidget
{
    ...
    void Construct();
    void ExecuteUbergraph_UI_EventBanner_OktoberFest(int32 EntryPoint);
};
