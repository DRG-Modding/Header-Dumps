#ifndef UE4SS_SDK_BP_Phys_Anniversary_Bottle_HPP
#define UE4SS_SDK_BP_Phys_Anniversary_Bottle_HPP

class ABP_Phys_Anniversary_Bottle_C : public AActor
{
    ...
    void ExecuteUbergraph_BP_Phys_Anniversary_Bottle(int32 EntryPoint);
};
