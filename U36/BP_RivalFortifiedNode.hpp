...
class ABP_RivalFortifiedNode_C : public AActor
{
    ...
    void OnRep_Active();
    void SpawnDefenses(TSubclassOf<class AActor> SpawnedActorClass, float Radius, class UDebrisPositioning* DebrisPositioning, class UCurveFloat* AvoidCostCurve);
