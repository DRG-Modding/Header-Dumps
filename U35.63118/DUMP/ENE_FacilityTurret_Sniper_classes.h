...
// Size: 0x5b4 (Inherited: 0x568)
struct AENE_FacilityTurret_Sniper_C : AENE_FacilityTurret_Base_C {
	FPointerToUberGraphFrame UberGraphFrame; // 0x568(0x08)
	UBoxComponent* AoECollision; // 0x570(0x08)
	UParticleSystemComponent* BeamLockOn; // 0x578(0x08)
	UProjectileAttackComponent* SniperAttack; // 0x580(0x08)
	UPointLightComponent* PointLight; // 0x588(0x08)
	UPointLightComponent* PointLight2; // 0x590(0x08)
	UPointLightComponent* PointLight1; // 0x598(0x08)
	UNiagaraComponent* LockonParticles; // 0x5a0(0x08)
	UParticleSystemComponent* Beam; // 0x5a8(0x08)
	float Timer; // 0x5b0(0x04)
