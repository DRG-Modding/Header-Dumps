...
struct ABP_HoopsGame_C : AActor {
	...
	void Restart();
	void BndEvt__InstantUsable_K2Node_ComponentBoundEvent_3_UsedBySignature__DelegateSignature(APlayerCharacter* User, enum class EInputKeys Key);
	...
	void On Player In Hoop(APlayerCharacter* Player);
