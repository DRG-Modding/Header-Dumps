...
struct ABP_Spacerig_Spaceball_Goal_C : AGem {
	...
	UWidgetComponent* Widget; // 0x288(0x08)
	UBoxComponent* GoalBox; // 0x290(0x08)
	USphereComponent* UseSphere; // 0x298(0x08)
	UParticleSystemComponent* ParticleSystem2; // 0x2a0(0x08)
	UParticleSystemComponent* ParticleSystem1; // 0x2a8(0x08)
	UParticleSystemComponent* ParticleSystem; // 0x2b0(0x08)
	UStaticMeshComponent* Goal; // 0x2b8(0x08)
	UStaticMeshComponent* SM_GoalEmitter_01; // 0x2c0(0x08)
	UBoxComponent* Box; // 0x2c8(0x08)
	UCarriableComponent* Carriable; // 0x2d0(0x08)
	FVector throwForce; // 0x2d8(0x0c)
	int32_t GoalsScored; // 0x2e4(0x04)
	float StartYaw; // 0x2e8(0x04)
	USoundBase* GoalScoredSound; // 0x2f0(0x08)
	USoundBase* ThrowSound; // 0x2f8(0x08)
	float StartedDeploying; // 0x300(0x04)
	bool HasReachedPeak; // 0x304(0x01)
	float SmoothCoff; // 0x308(0x04)
	bool BeginActive; // 0x30c(0x01)
	bool HasBounced; // 0x30d(0x01)
	float GoalClosedTimer; // 0x310(0x04)
