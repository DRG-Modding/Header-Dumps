...
struct ABP_Grenade_Axe_Stuck_C : AFSDPhysicsActor {
	...
	USimpleObjectInfoComponent* SimpleObjectInfo; // 0x240(0x08)
	UInstantUsable* InstantUsable; // 0x248(0x08)
	UBoxComponent* Blade; // 0x250(0x08)
	UBoxComponent* Handle; // 0x258(0x08)
	UBoxComponent* WorldCollision; // 0x260(0x08)
	USphereComponent* Sphere; // 0x268(0x08)
	UStaticMeshComponent* SM_HandGrenade_M_Thrown2; // 0x270(0x08)
	AThrownGrenadeItem* AxeGrenadeItem; // 0x278(0x08)
	UMaterialInstanceDynamic* Dynamic Material; // 0x280(0x08)
	bool StandOnMe; // 0x288(0x01)
	...
	void BndEvt__InstantUsable_K2Node_ComponentBoundEvent_2_UsedBySignature__DelegateSignature(APlayerCharacter* User, enum class EInputKeys Key);
