...
struct USCREEN_CharacterSelection_Clean_C : USCREEN_CharacterSelection_Base_C {
	...
	UITM_Challenge_InfoBox_C* ITM_Challenge_InfoBox; // 0x2d0(0x08)
	...
	USafeZone* PlatformSafeZone; // 0x2f0(0x08)
	UScreen_CharacterInfo_C* Screen_CharacterInfo; // 0x2f8(0x08)
	UHorizontalBox* SelectionBox_Active; // 0x300(0x08)
	UUI_AdvancedLabel_C* UI_AdvancedLabel; // 0x308(0x08)
	FMulticastInlineDelegate CharacterSelected; // 0x310(0x10)
	AFSDPlayerState* PlayerState; // 0x320(0x08)
	bool DoSelectedShouts; // 0x328(0x01)
	bool DoMovie; // 0x329(0x01)
	bool AllowBack; // 0x32a(0x01)
	UPlayerCharacterID* InitialCharacterClassOnShow; // 0x330(0x08)
	bool IsBeingClosed; // 0x338(0x01)
	bool OnCloseMenuHasBeenHandled; // 0x339(0x01)

	void HighlightClassChallenges(TArray<UObject*> assetReferences, bool ShouldHighlight, USeasonChallenge* Challenge);
