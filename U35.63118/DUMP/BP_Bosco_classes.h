...
// Size: 0x734 (Inherited: 0x6b8)
struct ABP_Bosco_C : ABosco {
	FPointerToUberGraphFrame UberGraphFrame; // 0x6b8(0x08)
	UPawnStatsComponent* PawnStats; // 0x6c0(0x08)
	UStaticMeshComponent* TerrainScannerMesh; // 0x6c8(0x08)
	UChildActorComponent* StateDisplay; // 0x6d0(0x08)
	UActorTrackingComponent* ActorTracking; // 0x6d8(0x08)
	UBoxComponent* Box; // 0x6e0(0x08)
	UStaticMeshComponent* StaticMesh; // 0x6e8(0x08)
	UWidgetComponent* ReviveWidget; // 0x6f0(0x08)
	UStaticMeshComponent* LightConeMesh; // 0x6f8(0x08)
	USimpleObjectInfoComponent* SimpleObjectInfo; // 0x700(0x08)
	UPlayerResourceComponent* PlayerResource; // 0x708(0x08)
	UOutlineComponent* outline; // 0x710(0x08)
	bool FoundEnemies; // 0x718(0x01)
	UParticleSystem* ScareParicles; // 0x720(0x08)
	USoundCue* ScareSound; // 0x728(0x08)
	float ScareDuration; // 0x730(0x04)
