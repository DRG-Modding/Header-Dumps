...
struct UITEM_SpaceRig_TeamMember_C : UUserWidget {
	...
	UUI_PlayerSpeaking_C* UI_PlayerSpeaking; // 0x2f0(0x08)
	APlayerCharacter* PlayerCharacter; // 0x2f8(0x08)
	AFSDPlayerState* PlayerState; // 0x300(0x08)
	AFSDPlayerState* NewVar_1; // 0x308(0x08)
