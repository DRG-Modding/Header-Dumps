...
struct ABP_PlayerController_SpaceRig_C : ABP_SR_PlayerControllerBase_C {
	...
	void InpActEvt_Nine_K2Node_InputKeyEvent_4(FKey Key);
	void InpActEvt_Nine_K2Node_InputKeyEvent_3(FKey Key);
	void InpActEvt_Ctrl+Alt_H_K2Node_InputKeyEvent_2(FKey Key);
	...
	void InpActEvt_Home_K2Node_InputKeyEvent_1(FKey Key);
