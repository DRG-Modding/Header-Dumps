...
struct U_MENU_ServerList_C : UWindowWidget {
	...
	UBasic_RadioButton_C* Basic_RadioButton_Open; // 0x290(0x08)
	UBasic_RadioButton_C* Basic_RadioButton_Password; // 0x298(0x08)
	UBasic_RadioButton_C* Basic_RadioButton_SD_Close; // 0x2a0(0x08)
	UBasic_RadioButton_C* Basic_RadioButton_SD_Far; // 0x2a8(0x08)
	UBasic_RadioButton_C* Basic_RadioButton_SD_Medium; // 0x2b0(0x08)
	UBasic_RadioButton_C* Basic_RadioButton_SD_World; // 0x2b8(0x08)
	UBorder* BG_Filters; // 0x2c0(0x08)
	UBorder* BG_Servers; // 0x2c8(0x08)
	UBorder* Border_Categories; // 0x2d0(0x08)
	UBorder* Border_Filters; // 0x2d8(0x08)
	UBasic_ButtonScalable2_C* BTN_DeepDives; // 0x2e0(0x08)
	UBasic_ButtonScalable2_C* BTN_Full_ServerList; // 0x2e8(0x08)
	UBasic_ButtonScalable2_C* BTN_QuickJoin; // 0x2f0(0x08)
	UBasic_ButtonScalable2_C* BTN_Refresh; // 0x2f8(0x08)
	UButton* Button_Complexity; // 0x300(0x08)
	UButton* Button_Distance; // 0x308(0x08)
	UButton* Button_Hazard; // 0x310(0x08)
	UButton* Button_Length; // 0x318(0x08)
	UButton* Button_Mission; // 0x320(0x08)
	UButton* Button_Team; // 0x328(0x08)
	UButton* Button_Time; // 0x330(0x08)
	UCircularThrobber* CircularThrobber_1; // 0x338(0x08)
	UFilter_ServerGameType_C* Filter_ServerGameType; // 0x340(0x08)
	UFilter_ServerWorkEnvironment_C* Filter_ServerWorkEnvironment; // 0x348(0x08)
	UImage* IMG_MissionIcon; // 0x350(0x08)
	UITM_OnlineRestricted_C* ITM_OnlineRestricted; // 0x358(0x08)
	UITM_ServerList_Entry_C* ITM_ServerList_Entry; // 0x360(0x08)
	UITM_ServerList_Entry_C* ITM_ServerList_Entry_1; // 0x368(0x08)
	UITM_ServerList_Entry_C* ITM_ServerList_Entry_2; // 0x370(0x08)
	UMENU_SpaceRigTemplate_C* MENU_SpaceRigTemplate; // 0x378(0x08)
	UBasic_ExpandableMenu_C* MenuSearchDistance; // 0x380(0x08)
	UBasic_ExpandableMenu_C* MenuServerType; // 0x388(0x08)
	UScrollBox* ScrollBox_Servers; // 0x390(0x08)
