...
struct UITM_BigButton_C : UUserWidget {
	...
	USizeBox* SizeBox_1; // 0x2c0(0x08)
	UTextBlock* TextBlock_93; // 0x2c8(0x08)
	FMulticastInlineDelegate OnClicked; // 0x2d0(0x10)
	FText Text; // 0x2e0(0x18)
	USoundBase* AudioClick; // 0x2f8(0x08)
	USoundBase* AudioHover; // 0x300(0x08)
