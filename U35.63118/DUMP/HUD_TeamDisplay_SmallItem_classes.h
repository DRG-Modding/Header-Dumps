...
struct UHUD_TeamDisplay_SmallItem_C : UUserWidget {
	...
	UITM_CharacterIcon_C* ITM_CharacterIcon; // 0x298(0x08)
	UTextBlock* PlayerName; // 0x2a0(0x08)
	UCircularThrobber* PlayerOnHisWayIndicator; // 0x2a8(0x08)
	UUI_PlayerSpeaking_C* PlayerSpeaking; // 0x2b0(0x08)
