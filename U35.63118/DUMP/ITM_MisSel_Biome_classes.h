...
struct UITM_MisSel_Biome_C : UUserWidget {
	...
	UITM_SeasonChallengeIcon_C* Icon_Challenge; // 0x268(0x08)
	UImage* IMG_Shadow; // 0x270(0x08)
	UITM_Campaign_Icon_C* ITM_Campaign_Icon; // 0x278(0x08)
	UButton* MainButton; // 0x280(0x08)
	UHorizontalBox* MissionsAvailiable; // 0x288(0x08)
	UTextBlock* NoMissionsAvailbable; // 0x290(0x08)
	UTextBlock* TextBlock_BiomeName; // 0x298(0x08)
	UBiome* Biome; // 0x2a0(0x08)
	FMulticastInlineDelegate BiomeSelected; // 0x2a8(0x10)
	int32_t NumberOfMissions; // 0x2b8(0x04)
	TArray<UGeneratedMission*> missions; // 0x2c0(0x10)
	float Biome Image Size; // 0x2d0(0x04)
	FVector2D Biome Image Position; // 0x2d4(0x08)
	float Biome Image Angle; // 0x2dc(0x04)
	FVector2D Biome Image Shear; // 0x2e0(0x08)
	UITM_MisSel_ZoneImage_C* PlanetZone; // 0x2e8(0x08)
	bool IsNew; // 0x2f0(0x01)
	UMaterialInstanceDynamic* DynamicMaterial; // 0x2f8(0x08)
	FSlateBrush OldTexture; // 0x300(0x88)
	float UnlockStartTime; // 0x388(0x04)
	float UnlockAnimationTime; // 0x38c(0x04)
	int32_t BiomeIndex; // 0x390(0x04)
