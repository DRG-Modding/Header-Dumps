...
struct ULIB_Game_UI_C : UBlueprintFunctionLibrary {
	...
	void GetRewardText(UReward* Reward, UObject* __WorldContext, FText Title, FText Category, FText Description, bool HasOptionalCharacterID, UPlayerCharacterID* characterID);
