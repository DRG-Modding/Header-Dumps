// BlueprintGeneratedClass TSK_FindPointBelowTarget.TSK_FindPointBelowTarget_C
// Size: 0x118 (Inherited: 0xa8)
struct UTSK_FindPointBelowTarget_C : UBTTask_BlueprintBase {
	...
	void ExecuteUbergraph_TSK_FindPointBelowTarget(int32_t EntryPoint);
};
