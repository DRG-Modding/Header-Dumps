...
enum class ESonyInputSettingsBools : uint8 {
	...
	AdaptiveTriggersEnabled = 2,
	TouchPadTerrainScannerEnabled = 3,
	TouchPadGesturesEnabled = 4,
	ControllerSpeakerMissionControl = 5,
	ControllerSpeakerSalute = 6,
	ControllerSpeakerFlare = 7,
	ControllerSpeakerMineralCollection = 8,
	ESonyInputSettingsBools_MAX = 9
};
...
enum class EBoltActionWeaponConditions : uint8 {
	WasAimedShot = 0,
	EBoltActionWeaponConditions_MAX = 1
};
...
enum class ELockOnWeaponUpgrades : uint8 {
	...
	LockedShotsIgnoreArmor = 13,
	FearOnFullLockShot = 14,
...
struct FPlatformComponent {
	UActorComponent* ComponentClass; // 0x00(0x08)
...
struct FNetworkConnectionInfo {
	AFSDPlayerController* PlayerController; // 0x00(0x08)
...
struct FSonyInputSettings {
	...
	bool MotionControlFlight; // 0x0c(0x01)
	enum class ESonyControllerMotionMapping MotionXMapping; // 0x0d(0x01)
	bool AdaptiveTriggersEnabled; // 0x0e(0x01)
	float ControllerSpeakerVolume; // 0x10(0x04)
	bool ControllerSpeakerMissionControl; // 0x14(0x01)
	bool ControllerSpeakerSalute; // 0x15(0x01)
	bool ControllerSpeakerFlare; // 0x16(0x01)
	bool ControllerSpeakerMineralCollection; // 0x17(0x01)
	bool TouchPadTerrainScannerEnabled; // 0x18(0x01)
	float TouchPadTerrainScannerXSensitivity; // 0x1c(0x04)
	float TouchPadTerrainScannerYSensitivity; // 0x20(0x04)
	float TouchPadTerrainScannerZoomSensitivity; // 0x24(0x04)
	bool TouchPadGesturesEnabled; // 0x28(0x01)
	enum class ESonyControllerLightMode ControllerLightMode; // 0x29(0x01)
};
...
struct FConsoleOptionsInSaveGame {
	...
	int32_t ShowNetInfoLevel; // 0x88(0x04)
	float FOV; // 0x8c(0x04)
	float HeadbobbingScale; // 0x90(0x04)
	float CameraShakeScale; // 0x94(0x04)
	float UIDPIScale; // 0x98(0x04)
	float volumeCharacterVoice; // 0x9c(0x04)
	float volumeMaster; // 0xa0(0x04)
	float volumeMissionControl; // 0xa4(0x04)
	float volumeSFX; // 0xa8(0x04)
	float volumeMusic; // 0xac(0x04)
	bool bShowSubtitles; // 0xb0(0x01)
	bool InvertMouse; // 0xb1(0x01)
	bool PhotosensitiveMode; // 0xb2(0x01)
	bool bHoldToSprint; // 0xb3(0x01)
	bool bToggleLaserPointer; // 0xb4(0x01)
	bool bToggleTerrainScanner; // 0xb5(0x01)
	bool bUseMouseSmoothing; // 0xb6(0x01)
	float MouseXSensitivity; // 0xb8(0x04)
	float MouseYSensitivity; // 0xbc(0x04)
	bool bUseSeperateSensitivity; // 0xc0(0x01)
	bool bInvertMouseWheel; // 0xc1(0x01)
	bool bInvertIncapacitatedX_Mouse; // 0xc2(0x01)
	bool bInvertIncapacitatedX_Controller; // 0xc3(0x01)
	bool bInvertFlightControls; // 0xc4(0x01)
	bool bShowUIAnimations; // 0xc5(0x01)
	bool bPlaySoundOnChatMessage; // 0xc6(0x01)
	float ChatFadeTime; // 0xc8(0x04)
	float ForceFeedbackScale; // 0xcc(0x04)
	int32_t ChatFontSize; // 0xd0(0x04)
	float HDRColorGamma; // 0xd4(0x04)
	enum class EConsoleGraphicsMode ConsoleGraphicsMode; // 0xd8(0x01)
	FString Language; // 0xe0(0x10)
	FCharacterOptions CharacterOptions; // 0xf0(0x02)
	TArray<FCustomKeyBinding> CustomKeyBindings; // 0xf8(0x10)
	TArray<FCustomKeyBinding> CustomControllerBindings; // 0x108(0x10)
...
// Size: 0x50 (Inherited: 0x00)
struct FSeasonSave {
	TMap<FGuid, FSeasonSaveEntry> Seasons; // 0x00(0x50)
};
...
struct FSeasonSaveEntry {
	...
	TArray<FRewardsClaimed> RewardsClaimed; // 0x08(0x10)
	bool HasClaimedAllRewards; // 0x18(0x01)
	int32_t RewardsClaimedAfterMaxLevel; // 0x1c(0x04)
	TMap<int32_t, bool> NodesBought; // 0x20(0x50)
	TArray<FChallengeSaveInfo> ActiveChallenges; // 0x70(0x10)
	FDateTime LastNewChallengeGiven; // 0x80(0x08)
	FDateTime LastChallengeReroll; // 0x88(0x08)
	TMap<FGuid, int32_t> CompletedSpecialChallenges; // 0x90(0x50)
...
struct FChallengeSaveInfo {
	TArray<int32_t> StatIndices; // 0x00(0x10)
	FGuid ChallengeGuid; // 0x10(0x10)
...
struct FHackingUsableState {
	...
	TWeakObjectPtr<AHackingToolItem> BeingHackedByItem; // 0x04(0x08)
	TWeakObjectPtr<APlayerCharacter> HackedBy; // 0x0c(0x08)
};
...
struct FLockCounter {
	...
	TWeakObjectPtr<AActor> LockedActor; // 0x04(0x08)
};
...
struct FScaledEffect {
	UFXSystemAsset* ParticleSystem; // 0x00(0x08)
...
struct FGameActivitySubTask {
	FString SubActivityId; // 0x00(0x10)
};
...
struct FUsableRepliactional {
	UUsableComponentBase* UsableComp; // 0x00(0x08)
	char Key; // 0x08(0x01)
};
...
struct FCloudSaveRequest {
	FString SteamTicket; // 0x00(0x10)
	FString PSTicket; // 0x10(0x10)
	int32_t PlayerRank; // 0x20(0x04)
	int32_t SaveToDiskCounter; // 0x24(0x04)
	FString RawData; // 0x28(0x10)
	FString Branch; // 0x38(0x10)
};
...
struct FCharacterShouts {
	...
	UDialogDataAsset* CallDonkey_NotInMission; // 0x70(0x08)
	UDialogDataAsset* Depositing; // 0x78(0x08)
	UDialogDataAsset* DepositingNoDonkey; // 0x80(0x08)
	UDialogDataAsset* OutOfAmmo; // 0x88(0x08)
	UDialogDataAsset* Reloading; // 0x90(0x08)
	UDialogDataAsset* CharacterSelected; // 0x98(0x08)
	UDialogDataAsset* UpgradeBought; // 0xa0(0x08)
	UDialogDataAsset* WaitingInDropPod; // 0xa8(0x08)
	UDialogDataAsset* Carrying; // 0xb0(0x08)
};
...
struct FCommunityFactionResponse {
	TArray<FString> Goals; // 0x00(0x10)
	TArray<float> Values; // 0x10(0x10)
	TArray<float> Members; // 0x20(0x10)
};
...
struct FCommunityGoalRequest {
	...
	FString SteamTicket; // 0x18(0x10)
	FString Branch; // 0x28(0x10)
};
...
struct FSubObjective {
	UDialogDataAsset* OnProgressShout; // 0x00(0x08)
	UDialogDataAsset* OnCompletedShout; // 0x08(0x08)
	FText ObjectiveText; // 0x10(0x18)
...
struct FDamageData : FDamageDataBase {
	...
	UDamageClass* DamageClass; // 0x08(0x08)
};
...
struct FModdingUISettings {
	...
	TSet<char> ServerFilters; // 0x08(0x50)
...
struct FSplineHitResult {
	FHitResult HitResult; // 0x00(0x88)
	float SplineDistance; // 0x88(0x04)
	FVector SplineTangent; // 0x8c(0x0c)
};
...
struct FGDDamageClasses {
	...
	UDamageClass* Corrosive; // 0x40(0x08)
};
...
struct FGooPuddleStatusEffectTrigger {
	TArray<UDamageClass*> Trigger; // 0x00(0x10)
	UStatusEffect* NewStatusEffect; // 0x10(0x08)
};
...
struct FGuntowerModuleLevel {
	TArray<AGuntowerModule*> PossibleModules; // 0x00(0x10)
...
struct FGenerateIconInfo {
	...
	FPickaxeSet PickaxeSet; // 0x10(0x38)
	enum class EPickaxePartLocation PickaxePartLocation; // 0x48(0x01)
	UItemSkin* ItemSkin; // 0x50(0x08)
	UVanityItem* Item; // 0x58(0x08)
	UPlayerCharacterID* Character; // 0x60(0x08)
	FVector2D Size; // 0x68(0x08)
...
// Size: 0x38 (Inherited: 0x00)
struct FPickaxeSet {
	UPickaxePart* BladeFront; // 0x00(0x08)
	UPickaxePart* OptionalBladeBack; // 0x08(0x08)
	UPickaxePart* Pommel; // 0x10(0x08)
	UPickaxePart* Handle; // 0x18(0x08)
	UPickaxePart* Shaft; // 0x20(0x08)
	UPickaxePart* Head; // 0x28(0x08)
	UPickaxePart* Material; // 0x30(0x08)
};
...
struct FGDMissionStats {
	...
	UMissionStat* SeasonEventsCompleted; // 0x90(0x08)
	UMissionStat* SeasonChallengesCompleted; // 0x98(0x08)
	UMissionStat* DeepDivesCompleted; // 0xa0(0x08)
	UMissionStat* EliteDeepDivesCompleted; // 0xa8(0x08)
	UMissionStat* CosmeticsCrafted; // 0xb0(0x08)
	UMissionStat* WeaponSkinsCrafted; // 0xb8(0x08)
	UMissionStat* WeaponOverclocksCrafted; // 0xc0(0x08)
	UMissionStat* CraftingMasteryLevel; // 0xc8(0x08)
	UMissionStat* DefendBlackBoxObjectivesCompleted; // 0xd0(0x08)
	UMissionStat* RepairMiniMuleObjectivesCompleted; // 0xd8(0x08)
	UMissionStat* DeepDiveCompletedBestTime; // 0xe0(0x08)
	UMissionStat* EliteDeepDiveCompletedBestTime; // 0xe8(0x08)
	UMissionStat* SpecialBeersUnlocked; // 0xf0(0x08)
	TArray<UMissionStat*> AllMissionStats; // 0xf8(0x10)
	TMap<UPlayerCharacterID*, UMissionStat*> CharacterMissionsCompleted; // 0x108(0x50)
};
...
struct FPlanetZoneItem {
	...
	TArray<UGeneratedMission*> missions; // 0x10(0x10)
	UPlanetZone* Zone; // 0x20(0x08)
};
...
struct FMultiHitScanHits {
	TArray<FMultiHitscanHit> Hits; // 0x00(0x10)
	TArray<UPrimitiveComponent*> Components; // 0x10(0x10)
	TArray<UFSDPhysicalMaterial*> PhysicalMaterials; // 0x20(0x10)
};
...
struct FMultiHitscanHit {
	...
	FVector_NetQuantize HitLocation; // 0x04(0x0c)
	FVector_NetQuantizeNormal ImpactNormal; // 0x10(0x0c)
...
struct FDeepDiveTesterItem {
	UMissionTemplate* mission; // 0x00(0x08)
	UMissionMutator* Mutator; // 0x08(0x08)
	UMissionWarning* Warning; // 0x10(0x08)
};
...
struct FProjectileSwitch {
	AProjectileBase* projectileClass; // 0x00(0x08)
...
struct FRichTextParseResult {
	FText SourceText; // 0x00(0x18)
	FString UnformattedString; // 0x18(0x10)
	int32_t UnformattedLength; // 0x28(0x04)
	TArray<FRichTextToken> Tokens; // 0x30(0x10)
};
...
struct FSeasonLevel {
	UReward* Reward; // 0x00(0x08)
	UReward* specialReward; // 0x08(0x08)
};

// ScriptStruct FSD.TrackedStatInfo
// Size: 0x50 (Inherited: 0x00)
struct FTrackedStatInfo {
	UMissionStat* Stat; // 0x00(0x08)
	FText Name; // 0x08(0x18)
	TSoftObjectPtr<UTexture2D> Image; // 0x20(0x28)
	UDataAsset* assetReference; // 0x48(0x08)
};
...
struct FChallengeInfo {
	FText Text; // 0x00(0x18)
	UTexture2D* Icon; // 0x18(0x08)
	UTexture2D* IconOutlined; // 0x20(0x08)
	...
	TSoftObjectPtr<UTexture2D> Stat1Image; // 0x48(0x28)
	TSoftObjectPtr<UTexture2D> Stat2Image; // 0x70(0x28)
...
struct FSeasonalEventEntry {
	USpecialEvent* SpecialEvent; // 0x00(0x08)
	TArray<UMissionTemplate*> BannedMissions; // 0x08(0x10)
};
...
struct FSeasonMissionResult {
	...
	TArray<FChallengeInfo> UpdatedChallenges; // 0x10(0x10)
	TArray<FSeasonEvent> CompletedEvents; // 0x20(0x10)
};

// ScriptStruct FSD.SeasonEvent
// Size: 0x20 (Inherited: 0x00)
struct FSeasonEvent {
	USeasonEventData* Event; // 0x00(0x08)
	int32_t count; // 0x08(0x04)
};
...
struct FFSDServerListResponse {
	TArray<FFSDServerListEntryModel> Lobbies; // 0x00(0x10)
};
...
struct FFSDServerListEntryModel {
	...
	FString DRG_SERVERNAME; // 0x10(0x10)
	FString DRG_SERVERNAME_SAN; // 0x20(0x10)
	...
	FString DRG_CLASSES; // 0x50(0x10)
	int32_t DRG_CLASSLOCK; // 0x60(0x04)
	int32_t DRG_FULL; // 0x64(0x04)
	FString DRG_REGION; // 0x68(0x10)
	FString DRG_START; // 0x78(0x10)
	int32_t DRG_VERSION; // 0x88(0x04)
	FString HostUserID; // 0x90(0x10)
	FString DRG_MISSIONSTRUCTURE; // 0xa0(0x10)
	FString P2PAddr; // 0xb0(0x10)
	int32_t P2PPORT; // 0xc0(0x04)
	float Distance; // 0xc4(0x04)
	TArray<FFSDServerListEntryModModel> Mods; // 0xc8(0x10)
};
...
struct FFSDServerListRequest {
	FString AuthenticationTicket; // 0x08(0x10)
	FString IgnoreId; // 0x18(0x10)
	int32_t Distance; // 0x28(0x04)
	int32_t DRG_PWREQUIRED; // 0x2c(0x04)
	FString DRG_REGION; // 0x30(0x10)
	...
	FString SearchString; // 0x50(0x10)
...
struct FFSDSteamServerListRequest : FFSDServerListRequest {
	FString SteamTicket; // 0x68(0x10)
	FString SteamPingLoc; // 0x78(0x10)
	TArray<int32_t> GameTypes; // 0x88(0x10)
};
...
struct FLookupSessionResponse {
	...
	FString LobbyId; // 0x08(0x10)
	FString P2PAddr; // 0x18(0x10)
...
struct FRegisterSessionRequest {
	FString serverName; // 0x00(0x10)
	int32_t NumPlayers; // 0x10(0x04)
	FString LobbyId; // 0x18(0x10)
	FString P2PAddr; // 0x28(0x10)
...
struct FActiveStatusEffectBank {
	...
	TArray<FActiveStatusEffect> Effects; // 0x38(0x10)
};

// ScriptStruct FSD.ActiveStatusEffect
// Size: 0x08 (Inherited: 0x00)
struct FActiveStatusEffect {
	TWeakObjectPtr<AActor> Owner; // 0x00(0x08)
};
...
struct FAnimNode_Tentacle : FAnimNode_SkeletalControlBase {
	TArray<FBoneReference> BonesToModify; // 0xc8(0x10)
};
...
struct FVanityNode {
	...
	TArray<int32_t> ConnectedNodes; // 0x10(0x10)
	bool bIsBig; // 0x20(0x01)
	bool bIsStartingNode; // 0x21(0x01)
	FVector2D Position; // 0x24(0x08)
};
...
struct FWeakpointChannel {
	...
	FName Bone; // 0x18(0x08)
	UMaterialInstanceDynamic* Mid; // 0x20(0x08)
};

// ScriptStruct FSD.WeakpointTask
// Size: 0x110 (Inherited: 0x00)
struct FWeakpointTask {
	FRichCurve GrowCurve; // 0x00(0x80)
	FRichCurve FadeCurve; // 0x80(0x80)
};
