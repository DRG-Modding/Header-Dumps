#ifndef UE4SS_SDK_DLCclaimPopup_DLC06_RobotRebellion_HPP
#define UE4SS_SDK_DLCclaimPopup_DLC06_RobotRebellion_HPP

class UDLCclaimPopup_DLC06_RobotRebellion_C : public UWindowWidget
{
    ...
    void ExecuteUbergraph_DLCclaimPopup_DLC06_RobotRebellion(int32 EntryPoint);
};
