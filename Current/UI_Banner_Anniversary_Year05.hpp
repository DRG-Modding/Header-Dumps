#ifndef UE4SS_SDK_UI_Banner_Anniversary_Year05_HPP
#define UE4SS_SDK_UI_Banner_Anniversary_Year05_HPP

class UUI_Banner_Anniversary_Year05_C : public UUserWidget
{
    ...
    void Construct();
    void ExecuteUbergraph_UI_Banner_Anniversary_Year05(int32 EntryPoint);
};
