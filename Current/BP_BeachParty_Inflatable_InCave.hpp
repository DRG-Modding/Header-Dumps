#ifndef UE4SS_SDK_BP_BeachParty_Inflatable_InCave_HPP
#define UE4SS_SDK_BP_BeachParty_Inflatable_InCave_HPP
...
class ABP_BeachParty_Inflatable_InCave_C : public AGem
{
    ...
    void TalkToSelf();
    void ExecuteUbergraph_BP_BeachParty_Inflatable_InCave(int32 EntryPoint);
};
