#ifndef UE4SS_SDK_BP_InCaveOktoberfestMug_HPP
#define UE4SS_SDK_BP_InCaveOktoberfestMug_HPP

class ABP_InCaveOktoberfestMug_C : public AGem
{
    ...
    void TalkToSelf();
    void ExecuteUbergraph_BP_InCaveOktoberfestMug(int32 EntryPoint);
};
