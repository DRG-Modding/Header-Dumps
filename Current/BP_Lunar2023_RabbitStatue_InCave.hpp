#ifndef UE4SS_SDK_BP_Lunar2023_RabbitStatue_InCave_HPP
#define UE4SS_SDK_BP_Lunar2023_RabbitStatue_InCave_HPP

class ABP_Lunar2023_RabbitStatue_InCave_C : public AGem
{
    ...
    void TalkToSelf();
    void ExecuteUbergraph_BP_Lunar2023_RabbitStatue_InCave(int32 EntryPoint);
};
