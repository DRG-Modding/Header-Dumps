#ifndef UE4SS_SDK_BP_CleanupPod_Marker_HPP
#define UE4SS_SDK_BP_CleanupPod_Marker_HPP

class ABP_CleanupPod_Marker_C : public AItemMarker
{
    ...
    void ExecuteUbergraph_BP_CleanupPod_Marker(int32 EntryPoint);
};
