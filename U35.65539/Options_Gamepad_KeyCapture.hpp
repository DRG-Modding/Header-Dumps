...
class UOptions_Gamepad_KeyCapture_C : UInputCaptureWidget
{
    FPointerToUberGraphFrame UberGraphFrame;
    UWidgetSwitcher* DisplaySwitcher;
    UImage* FocusedIndicator;
    USizeBox* IconSizeBox;
    UImage* InputImage;
    UBasic_Label_C* InputLabel;
    float IconSize;
    int32 FontSize;
    ...
    void ExecuteUbergraph_Options_Gamepad_KeyCapture(int32 EntryPoint, bool Temp_bool_Variable, ESlateVisibility Temp_byte_Variable, ESlateVisibility Temp_byte_Variable_1, CustomKeyBindingsChanged__DelegateSignature K2Node_CreateDelegate_OutputDelegate, bool K2Node_Event_InCapturing, FKey K2Node_Event_InKey_1, ESlateVisibility K2Node_Select_Default, UFSDGameUserSettings* CallFunc_GetFSDGameUserSettings_ReturnValue, FKey CallFunc_GetCurrentBinding_ReturnValue, FKey K2Node_Event_InKey, FCustomKeySetting CallFunc_FindCurrentSettingsForKey_OutSettings, bool CallFunc_FindCurrentSettingsForKey_ReturnValue, FKey CallFunc_GetCurrentBinding_ReturnValue_1, bool K2Node_Event_IsDesignTime);
