...
class AENE_JellyBreeder_C : UJellyBreeder
{
    FPointerToUberGraphFrame UberGraphFrame;
    UCapsuleComponent* Capsule;
    UWeakpointGlowComponent* WeakpointGlow;
    UAudioComponent* JellyBreederDeath_Cue;
    UAudioComponent* JellyBreederIdle_Cue;
    UImpactComponent* Impact;
    ...
    void ExecuteUbergraph_ENE_JellyBreeder(int32 EntryPoint, UBlackboardComponent* CallFunc_GetBlackboard_ReturnValue, FName CallFunc_MakeLiteralName_ReturnValue, UBlackboardComponent* CallFunc_GetBlackboard_ReturnValue_1, FName CallFunc_MakeLiteralName_ReturnValue_1, float CallFunc_GetMidZpointFromCielingAndFloor_distanceFromCieling, float CallFunc_GetMidZpointFromCielingAndFloor_distanceFromFloor, float CallFunc_GetMidZpointFromCielingAndFloor_ReturnValue, FVector CallFunc_GetValueAsVector_ReturnValue, float CallFunc_FMin_ReturnValue, float CallFunc_BreakVector_X, float CallFunc_BreakVector_Y, float CallFunc_BreakVector_Z, float CallFunc_Subtract_FloatFloat_ReturnValue, FVector CallFunc_MakeVector_ReturnValue, float CallFunc_FMax_ReturnValue, FVector CallFunc_GetRandomReachablePointAtApproximateDistance_outPos, bool CallFunc_GetRandomReachablePointAtApproximateDistance_ReturnValue, UHealthComponentBase* K2Node_ComponentBoundEvent_HealthComponent, bool K2Node_Event_aIsLayingEggs, UParticleSystemComponent* CallFunc_SpawnEmitterAttached_ReturnValue, FName K2Node_Event_triggerName, bool K2Node_SwitchName_CmpSuccess, bool CallFunc_StopLoopingGlow_ReturnValue, bool CallFunc_StopLoopingGlow_ReturnValue_1, UGameData* CallFunc_GetFSDGameData_ReturnValue, UGoogleAnalyticsWrapper* CallFunc_GetGoogleAnalyticsWrapper_ReturnValue, bool CallFunc_IsValid_ReturnValue, UCommunityGoal* CallFunc_GetGoal_ReturnValue, bool CallFunc_IsAlive_ReturnValue);
}
