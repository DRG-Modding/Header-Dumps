...
class UOptions_MouseKeyboard_KeyCapture_C : UInputCaptureWidget
{
    ...
    void ExecuteUbergraph_Options_MouseKeyboard_KeyCapture(int32 EntryPoint, YesNoOutputPin__DelegateSignature K2Node_CreateDelegate_OutputDelegate, FKey CallFunc_GetCurrentBinding_ReturnValue, CustomKeyBindingsChanged__DelegateSignature K2Node_CreateDelegate_OutputDelegate_1, YesNoOutputPin__DelegateSignature K2Node_CreateDelegate_OutputDelegate_2, FFormatArgumentData K2Node_MakeStruct_FormatArgumentData, TArray<FFormatArgumentData>& K2Node_MakeArray_Array, FFormatArgumentData K2Node_MakeStruct_FormatArgumentData_1, FText CallFunc_Format_ReturnValue, TArray<FFormatArgumentData>& K2Node_MakeArray_Array_1, FText CallFunc_Format_ReturnValue_1, FYesNoPromptSettings K2Node_MakeStruct_YesNoPromptSettings, UYesNoPromptAction* CallFunc_PromptYesNo_ReturnValue, FCustomKeySetting CallFunc_FindCurrentSettingsForKey_OutSettings, bool CallFunc_FindCurrentSettingsForKey_ReturnValue, bool CallFunc_IsValid_ReturnValue, bool CallFunc_EqualEqual_KeyKey_ReturnValue, FGeometry K2Node_Event_MyGeometry, const FPointerEvent K2Node_Event_MouseEvent_1, bool CallFunc_Not_PreBool_ReturnValue, const FPointerEvent K2Node_Event_MouseEvent, bool K2Node_Event_IsDesignTime, UFSDGameUserSettings* CallFunc_GetFSDGameUserSettings_ReturnValue, FKey K2Node_Event_InKey_1, FKey K2Node_Event_InKey, bool K2Node_Event_InCapturing, bool CallFunc_SelectVisibility_IsVisible, bool CallFunc_SelectVisibility_VisibilityChanged, ESlateVisibility CallFunc_SelectVisibility_New_Visibility);
