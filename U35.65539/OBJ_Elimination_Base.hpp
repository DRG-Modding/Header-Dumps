...
class UOBJ_Elimination_Base_C : UEliminationObjective
{
    ...
    void ExecuteUbergraph_OBJ_Elimination_Base(int32 EntryPoint, UFSDGameMode* CallFunc_GetFSDGameMode_ReturnValue, UMusicManager* CallFunc_GetWorldSubsystem_ReturnValue, UEnemyWaveManager* CallFunc_GetWaveManager_ReturnValue, UFSDGameMode* CallFunc_GetFSDGameMode_ReturnValue_1, UEnemyWaveManager* CallFunc_GetWaveManager_ReturnValue_1);
}
