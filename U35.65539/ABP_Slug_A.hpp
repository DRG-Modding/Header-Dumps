...
class UABP_Slug_A_C : UEnemyAnimInstance
{
    ...
    void ExecuteUbergraph_ABP_Slug_A(int32 EntryPoint, float CallFunc_GetInstanceAssetPlayerTimeFromEnd_ReturnValue, bool CallFunc_LessEqual_FloatFloat_ReturnValue);
}
