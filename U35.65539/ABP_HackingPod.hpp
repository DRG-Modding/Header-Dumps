...
class UABP_HackingPod_C : UFacilityHackingPodAnimInstance
{
    ...
    void ExecuteUbergraph_ABP_HackingPod(int32 EntryPoint, float CallFunc_GetRelevantAnimTimeRemaining_ReturnValue, float CallFunc_BreakRotator_Roll, float CallFunc_BreakRotator_Pitch, float CallFunc_BreakRotator_Yaw, bool CallFunc_LessEqual_FloatFloat_ReturnValue, FRotator CallFunc_MakeRotator_ReturnValue, FRotator CallFunc_MakeRotator_ReturnValue_1);
}
