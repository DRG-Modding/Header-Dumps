...
class ABP_TransmitterNode_C : UTether
{
    FPointerToUberGraphFrame UberGraphFrame;
    USphereComponent* TetherConnectionCollider;
    UOutlineComponent* outline;
    USimpleObjectInfoComponent* SimpleObjectInfo;
    UAudioComponent* TetherCreateConnection_Cue;
    UAudioComponent* TetherIdle_Cue;
    ...
    void BndEvt__UsableComponent_K2Node_ComponentBoundEvent_3_UsedBySignature__DelegateSignature(UPlayerCharacter* User, EInputKeys Key);
    ...
    void BndEvt__PysicalCollision_K2Node_ComponentBoundEvent_4_ComponentHitSignature__DelegateSignature(UPrimitiveComponent* HitComponent, AActor* OtherActor, UPrimitiveComponent* OtherComp, FVector NormalImpulse, const FHitResult& Hit);
