...
class UABP_Spider_Boss_Heavy_C : USpiderAnimInstance
{
    ...
    void ExecuteUbergraph_ABP_Spider_Boss_Heavy(int32 EntryPoint, UAnimSequenceBase* K2Node_Event_animation);
}
