...
class AWPN_DetPack_Detonator_C : UDetPackItem
{
    ...
    void ExecuteUbergraph_WPN_DetPack_Detonator(int32 EntryPoint, bool CallFunc_IsLocallyControlled_ReturnValue, UAnimInstance* CallFunc_GetAnimInstance_ReturnValue, int32 CallFunc_GetCurrentGrenades_ReturnValue, UABP_Detonator_C* K2Node_DynamicCast_AsABP_Detonator, bool K2Node_DynamicCast_bSuccess, bool CallFunc_Greater_IntInt_ReturnValue, bool CallFunc_BooleanOR_ReturnValue, int32 CallFunc_GetCurrentGrenades_ReturnValue_1, float K2Node_Event_percentage, bool CallFunc_Greater_IntInt_ReturnValue_1, bool CallFunc_BooleanOR_ReturnValue_1, float CallFunc_SelectFloat_ReturnValue, int32 CallFunc_GetCurrentGrenades_ReturnValue_2, bool CallFunc_Greater_IntInt_ReturnValue_2);
}
