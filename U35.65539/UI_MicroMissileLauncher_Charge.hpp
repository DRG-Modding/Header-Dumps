...
class UUI_MicroMissileLauncher_Charge_C : UUserWidget
{
    FPointerToUberGraphFrame UberGraphFrame;
    UWidgetAnimation* AnimCharged;
    UImage* Background;
    UImage* Charged;
    bool On;
