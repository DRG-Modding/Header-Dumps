...
class UItm_TreeOfVanity_NodeConnection_C : UUserWidget
{
    FPointerToUberGraphFrame UberGraphFrame;
    UWidgetAnimation* TurnOpaque;
    UImage* Image_Line;
    UTreeOfVanityItemWidget* Node1;
    UTreeOfVanityItemWidget* Node2;
    bool BothBought;
    bool OneBought;
