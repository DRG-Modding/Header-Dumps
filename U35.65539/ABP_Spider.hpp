...
class UABP_Spider_C : USpiderAnimInstance
{
    ...
    void ExecuteUbergraph_ABP_Spider(int32 EntryPoint, APawn* CallFunc_TryGetPawnOwner_ReturnValue, UENE_PF_SpiderBase_C* K2Node_DynamicCast_AsENE_PF_Spider_Base, bool K2Node_DynamicCast_bSuccess);
}
