...
class UTSK_GetForwardDownLocation_C : UBTTask_BlueprintBase
{
    ...
    void ExecuteUbergraph_TSK_GetForwardDownLocation(int32 EntryPoint, AActor* CallFunc_GetBlackboardValueAsActor_ReturnValue, bool CallFunc_IsValid_ReturnValue, FVector CallFunc_GetBlackboardValueAsVector_ReturnValue, FVector CallFunc_K2_GetActorLocation_ReturnValue, ADeepCSGWorld* CallFunc_GetCSGWorld_ReturnValue, UAIController* K2Node_Event_OwnerController, APawn* K2Node_Event_ControlledPawn, FVector CallFunc_GetActorForwardVector_ReturnValue, UDeepPathfinderMovement* CallFunc_GetComponentByClass_ReturnValue, FVector CallFunc_K2_GetActorLocation_ReturnValue_1, bool CallFunc_IsValid_ReturnValue_1, FCSGRaycastHitInfo CallFunc_Linecast_hitInfo, bool CallFunc_Linecast_ReturnValue, FVector CallFunc_FindNearestPathfinderPointOverrideType_ReturnValue);
}
