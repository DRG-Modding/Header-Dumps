...
class UOptions_Scalability_Textures_C : UUserWidget
{
    ...
    void ExecuteUbergraph_Options_Scalability_Textures(int32 EntryPoint, UFSDGameInstance* CallFunc_GetFSDGameInstance_ReturnValue, GenericSignature__DelegateSignature K2Node_CreateDelegate_OutputDelegate, UGameUserSettings* CallFunc_GetGameUserSettings_ReturnValue, int32 CallFunc_GetTextureQuality_ReturnValue, UFSDGameInstance* CallFunc_GetFSDGameInstance_ReturnValue_1, FText K2Node_ComponentBoundEvent_Value, int32 K2Node_ComponentBoundEvent_Index, UGameUserSettings* CallFunc_GetGameUserSettings_ReturnValue_1);
}
