...
class UABP_DestoyedModule_C : UGunTowerModuleAnimInstance
{
    ...
    void ExecuteUbergraph_ABP_DestoyedModule(int32 EntryPoint, float CallFunc_BreakRotator_Roll, float CallFunc_BreakRotator_Pitch, float CallFunc_BreakRotator_Yaw, FRotator CallFunc_MakeRotator_ReturnValue);
}
