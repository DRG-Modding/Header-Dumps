...
class UHUD_EnemyTargeting_HealthBar_C : ULookingAtContentWidget
{
    ...
    void Construct();
    void ExecuteUbergraph_HUD_EnemyTargeting_HealthBar(int32 EntryPoint, bool Temp_bool_Variable, bool K2Node_Event_IsDesignTime, AActor* K2Node_Event_InCurrentTarget_1, AActor* K2Node_Event_InCurrentTarget, float K2Node_Event_DeltaTime, UWidgetAnimation* K2Node_Select_Default);
}
