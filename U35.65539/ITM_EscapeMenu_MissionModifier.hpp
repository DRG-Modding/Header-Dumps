...
class UITM_EscapeMenu_MissionModifier_C : UUserWidget
{
    ...
    void SetVisuals(FText InText, UTexture2D* Icon, uint8 Color);
    void ExecuteUbergraph_ITM_EscapeMenu_MissionModifier(int32 EntryPoint, FText K2Node_CustomEvent_InText, UTexture2D* K2Node_CustomEvent_Icon, uint8 K2Node_CustomEvent_Color, FLinearColor CallFunc_MenuColors_OutputColor, FLinearColor CallFunc_MenuColors_OutputColor_1, UMissionWarning* K2Node_CustomEvent_Warning, FSlateColor K2Node_MakeStruct_SlateColor, bool CallFunc_IsValid_ReturnValue, UMissionMutator* K2Node_CustomEvent_Mutator, bool CallFunc_IsValid_ReturnValue_1, bool K2Node_Event_IsDesignTime);
