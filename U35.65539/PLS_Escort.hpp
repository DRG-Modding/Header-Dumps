...
class APLS_Escort_C : UPLS_Linear_Base_C
{
    FPointerToUberGraphFrame UberGraphFrame;
    FRoomGeneratorGroupInstance RoomGroupInstance;
    URoomGeneratorGroup* Room Group;
    URoomGenerator* Starting Room;
    URoomGenerator* End Room;
    URoomGeneratorGroup* Small Room Group;
    ...
    bool MidWayRoom2;
    bool MidWayRoom3;
    URoomGenerator* FirstStopRoom;
    URoomGenerator* SecondStopRoom;
    URoomGenerator* LastStopRoom;
