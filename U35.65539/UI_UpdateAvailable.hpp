...
class UUI_UpdateAvailable_C : UWindowWidget
{
    ...
    void Close();
    void ExecuteUbergraph_UI_UpdateAvailable(int32 EntryPoint, UPlayerController* CallFunc_GetPlayerController_ReturnValue, bool K2Node_Event_IsDesignTime);
}
