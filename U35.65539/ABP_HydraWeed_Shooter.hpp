...
class UABP_HydraWeed_Shooter_C : UShootingPlantAnimInstance
{
    ...
    void ExecuteUbergraph_ABP_HydraWeed_Shooter(int32 EntryPoint, bool CallFunc_Greater_FloatFloat_ReturnValue, float CallFunc_MapRangeClamped_ReturnValue, float CallFunc_Abs_ReturnValue, float CallFunc_MapRangeClamped_ReturnValue_1, bool CallFunc_Less_FloatFloat_ReturnValue);
}
