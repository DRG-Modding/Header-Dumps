...
class UABP_FacilityTurret_Barrier_C : UFacilityTurretAnimInstance
{
    ...
    void ExecuteUbergraph_ABP_FacilityTurret_Barrier(int32 EntryPoint, float CallFunc_BreakRotator_Roll, float CallFunc_BreakRotator_Pitch, float CallFunc_BreakRotator_Yaw, FRotator CallFunc_MakeRotator_ReturnValue);
}
