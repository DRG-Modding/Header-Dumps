...
class UUI_InfoScreen_Xbox_C : UUserWidget
{
    ...
    UUI_InfoScreen_Overlay_DLC_Season01_C* UI_InfoScreen_Overlay_DLC_Season01;
    UUI_PatchNotes_C* UI_PatchNotes;
    FUI_InfoScreen_Xbox_COnClose OnClose;
    void OnClose(UUI_InfoScreen_Xbox_C* Screen);
    int32 PathNodeIndex;
    ...
    void HasJoinedXboxClub(bool& joined, UFSDSaveGame* CallFunc_GetFSDSaveGame_ReturnValue);
