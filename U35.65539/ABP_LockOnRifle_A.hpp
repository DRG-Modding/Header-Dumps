...
class UABP_LockOnRifle_A_C : UAnimInstance
{
    ...
    void ExecuteUbergraph_ABP_LockOnRifle_A(int32 EntryPoint, LockonTargetRotationUpdated__DelegateSignature K2Node_CreateDelegate_OutputDelegate, float CallFunc_BreakRotator_Roll, float CallFunc_BreakRotator_Pitch, float CallFunc_BreakRotator_Yaw, FRotator CallFunc_MakeRotator_ReturnValue, AActor* CallFunc_GetOwningActor_ReturnValue, bool K2Node_CustomEvent_hasTargetLockon, FRotator K2Node_CustomEvent_socketRotation, ULockOnWeapon* K2Node_DynamicCast_AsLock_on_Weapon, bool K2Node_DynamicCast_bSuccess);
}
