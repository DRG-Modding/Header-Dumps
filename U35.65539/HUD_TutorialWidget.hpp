...
class UHUD_TutorialWidget_C : UTutorialWidget
{
    FPointerToUberGraphFrame UberGraphFrame;
    UWidgetAnimation* Enter/Exit;
    ...
    void ContinueChange();
    void ExecuteUbergraph_HUD_TutorialWidget(int32 EntryPoint, bool Temp_bool_Variable, bool K2Node_Event_watched, bool CallFunc_BooleanAND_ReturnValue, bool CallFunc_IsVisible_ReturnValue, bool CallFunc_BooleanAND_ReturnValue_1, const FText K2Node_Event_Text, const FText K2Node_Event_Title, const FText K2Node_Event_TaskText, UTexture2D* K2Node_Event_Image, bool CallFunc_TextIsEmpty_ReturnValue, FText K2Node_Select_Default);
}
