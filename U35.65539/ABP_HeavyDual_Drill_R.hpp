...
class UABP_HeavyDual_Drill_R_C : UDoubleDrillAnimInstance
{
    ...
    void ExecuteUbergraph_ABP_HeavyDual_Drill_R(int32 EntryPoint, float CallFunc_GetInstanceAssetPlayerTimeFromEnd_ReturnValue, bool CallFunc_Not_PreBool_ReturnValue, bool CallFunc_LessEqual_FloatFloat_ReturnValue, bool CallFunc_Not_PreBool_ReturnValue_1, bool CallFunc_BooleanAND_ReturnValue, bool CallFunc_BooleanOR_ReturnValue, bool CallFunc_BooleanOR_ReturnValue_1);
}
