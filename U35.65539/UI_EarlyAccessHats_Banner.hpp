...
class UUI_EarlyAccessHats_Banner_C : UUserWidget
{
    ...
    void Construct();
    void ExecuteUbergraph_UI_EarlyAccessHats_Banner(int32 EntryPoint, UUMGSequencePlayer* CallFunc_PlayAnimation_ReturnValue);
}
