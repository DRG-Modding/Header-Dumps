...
class UCheat_SetFastFlares_C : UUserWidget
{
    ...
    void ExecuteUbergraph_Cheat_SetFastFlares(int32 EntryPoint, UCheatMenu_BasicButtonWText_C* K2Node_ComponentBoundEvent_Button, UFSDCheatManager* CallFunc_GetCheatManager_ReturnValue);
}
