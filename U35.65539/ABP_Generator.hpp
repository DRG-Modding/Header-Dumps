...
class UABP_Generator_C : UAnchorTurnerAnimInstance
{
    ...
    void ExecuteUbergraph_ABP_Generator(int32 EntryPoint, float CallFunc_Multiply_FloatFloat_ReturnValue, FRotator CallFunc_MakeRotator_ReturnValue);
}
