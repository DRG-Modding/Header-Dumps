...
class UITM_DragRotateCharacter_C : UUserWidget
{
    UImage* Image_0;
    bool GrabMouse;
    ...
    FEventReply OnMouseMove(FGeometry MyGeometry, const FPointerEvent& MouseEventFVector2D CallFunc_PointerEvent_GetCursorDelta_ReturnValue, bool CallFunc_IsValid_ReturnValue, float CallFunc_BreakVector2D_X, float CallFunc_BreakVector2D_Y, float CallFunc_Multiply_FloatFloat_ReturnValue, float CallFunc_Multiply_FloatFloat_ReturnValue_1, UFSDGameInstance* CallFunc_GetFSDGameInstance_ReturnValue, FEventReply CallFunc_Handled_ReturnValue, FEventReply CallFunc_Unhandled_ReturnValue);
}
