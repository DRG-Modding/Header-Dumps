...
class UBP_AudioControl_LowHealth_C : UActorComponent
{
    FPointerToUberGraphFrame UberGraphFrame;
    USoundSubmix* ExplosionsSubmix;
    USoundSubmix* WeaponFireSubmix;
    float CurrentAttack;
