...
class UHUD_ActorTrackingIcon_C : UActorTrackingWidget
{
    ...
    void SetInfo(FText InText, UTexture2D* Texture, FLinearColor InTint, FSlateColor K2Node_MakeStruct_SlateColor);
