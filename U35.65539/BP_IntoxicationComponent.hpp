...
class UBP_IntoxicationComponent_C : UCharacterIntoxicationComponent
{
    ...
    bool IgnoreYaw;
    bool IgnorePitch;
    UMaterialInstanceDynamic* DrunkenEffect;
    FName EffectID;
