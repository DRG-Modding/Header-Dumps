...
class UWeaponDisplay_Pistol_AmmoCount2_C : UWeaponDisplay_Base_AmmoCount_C
{
    ...
    void ExecuteUbergraph_WeaponDisplay_Pistol_AmmoCount2(int32 EntryPoint, int32 K2Node_Event_value_1, int32 K2Node_Event_value, FText CallFunc_Conv_IntToText_ReturnValue, FText CallFunc_Conv_IntToText_ReturnValue_1);
}
