...
class UITM_Trading_BasketItem_C : UUserWidget
{
    FPointerToUberGraphFrame UberGraphFrame;
    UWidgetAnimation* Intro;
    UBorder* Border_ColorGradient;
    UBorder* Border_Diff;
    UBorder* Border_Outline;
    UImage* CreditsDiffIcon;
    UImage* Icon_Resource_small;
    UBasic_AnimatedNumber_C* ResourceDiff;
    UTextBlock* Text_CreditsDiff;
