...
class UBasic_PasswordField_C : UUserWidget
{
    FPointerToUberGraphFrame UberGraphFrame;
    UEditableTextBox* ServerPassword;
    UBorder* ServerPasswordBorder;
    FText HintText;
    ...
    void BndEvt__ServerPassword_K2Node_ComponentBoundEvent_11_OnEditableTextBoxCommittedEvent__DelegateSignature(const FText& Text, uint8 CommitMethod);
    void ExecuteUbergraph_Basic_PasswordField(int32 EntryPoint, bool K2Node_Event_IsDesignTime, FLinearColor CallFunc_MenuColors_OutputColor, const FText K2Node_ComponentBoundEvent_Text_1, const FText K2Node_ComponentBoundEvent_Text, uint8 K2Node_ComponentBoundEvent_CommitMethod);
