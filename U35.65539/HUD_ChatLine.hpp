...
class UHUD_ChatLine_C : UUserWidget
{
    FPointerToUberGraphFrame UberGraphFrame;
    URichTextSizable* ChatRichText;
    UImage* SenderIcon;
    float Duration;
    float FadeOut;
    FFSDChatMessage Msg;
    ...
    void UpdateUserIcon(EChatMessageType MessageType, EChatSenderType SenderType, EChatSenderType Temp_byte_Variable, UTexture2D* Temp_object_Variable, UTexture2D* Temp_object_Variable_1, UTexture2D* Temp_object_Variable_2, UTexture2D* Temp_object_Variable_3, UTexture2D* Temp_object_Variable_4, bool CallFunc_EqualEqual_ByteByte_ReturnValue, bool CallFunc_EqualEqual_ByteByte_ReturnValue_1, bool CallFunc_EqualEqual_ByteByte_ReturnValue_2, bool CallFunc_BooleanOR_ReturnValue, bool CallFunc_BooleanOR_ReturnValue_1, UTexture2D* K2Node_Select_Default, bool CallFunc_SelectVisibility_IsVisible, bool CallFunc_SelectVisibility_VisibilityChanged, ESlateVisibility CallFunc_SelectVisibility_New_Visibility);
    void UpdateOpacity(float alpha, UFSDGameUserSettings* CallFunc_FSDGameUserSettings_ReturnValue, float CallFunc_GetChatFadeTime_ReturnValue, float CallFunc_MessageAge_ReturnValue, float CallFunc_Subtract_FloatFloat_ReturnValue, float CallFunc_Divide_FloatFloat_ReturnValue, float CallFunc_FClamp_ReturnValue, bool CallFunc_Greater_FloatFloat_ReturnValue);
