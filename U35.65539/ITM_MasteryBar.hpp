...
class UITM_MasteryBar_C : UUserWidget
{
    FPointerToUberGraphFrame UberGraphFrame;
    USizeBox* BarSize;
    UHorizontalBox* MasteryBar;
    UBorder* MasteryBar_BG;
    AFSDPlayerState* PlayerState;
    UItemID* itemClass;
    UMasteryIconWidget* CurrentMasteryWidget;
    float Height;
    ...
    void SetMasteryData(UFSDPlayerState* Player, UItemID* Item, bool& HasMasteryLevels, int32 CallFunc_GetMasteryProgress_maxMastery, int32 CallFunc_GetMasteryProgress_ReturnValue, TArray<FMasteryItem>& CallFunc_GetMasteryLevels_ReturnValue, int32 CallFunc_Array_Length_ReturnValue, bool CallFunc_Greater_IntInt_ReturnValue);
    void AddMasteryBox(UWidget* Content, FSlateChildSize K2Node_MakeStruct_SlateChildSize, UHorizontalBoxSlot* CallFunc_AddChildToHorizontalBox_ReturnValue);
    void CreateMasteryLevels(int32 maxMastery, int32 CurrentMastery, UItemID* Item, TArray<FMasteryItem>& masteryLevels, int32 CurrentMasteryIndex, bool Filled, int32 Index, int32 CallFunc_Subtract_IntInt_ReturnValue, int32 Temp_int_Variable, int32 CallFunc_Add_IntInt_ReturnValue, UPlayerController* CallFunc_GetOwningPlayer_ReturnValue, UITM_MasteryBar_Block_C* CallFunc_Create_ReturnValue, int32 CallFunc_Add_IntInt_ReturnValue_1, bool CallFunc_GreaterEqual_IntInt_ReturnValue, FMasteryItem CallFunc_GetMasteryForLevel_outLevel, bool CallFunc_GetMasteryForLevel_ReturnValue, int32 CallFunc_Subtract_IntInt_ReturnValue_1, bool CallFunc_LessEqual_IntInt_ReturnValue, UPlayerController* CallFunc_GetOwningPlayer_ReturnValue_1, UITM_MasteryBar_Icon_C* CallFunc_Create_ReturnValue_1);
