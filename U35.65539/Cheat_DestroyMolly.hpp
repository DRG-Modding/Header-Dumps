...
class UCheat_DestroyMolly_C : UUserWidget
{
    ...
    void ExecuteUbergraph_Cheat_DestroyMolly(int32 EntryPoint, TArray<UMolly*>& CallFunc_GetAllActorsOfClass_OutActors, int32 CallFunc_Array_Length_ReturnValue, int32 Temp_int_Array_Index_Variable, int32 Temp_int_Loop_Counter_Variable, UMolly* CallFunc_Array_Get_Item, bool CallFunc_HasAuthority_ReturnValue, bool CallFunc_Less_IntInt_ReturnValue, int32 CallFunc_Add_IntInt_ReturnValue);
