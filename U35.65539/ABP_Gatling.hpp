...
class UABP_Gatling_C : UBeltDrivenAnimInstance
{
    ...
    void ExecuteUbergraph_ABP_Gatling(int32 EntryPoint, float CallFunc_GetInstanceAssetPlayerTimeFromEndFraction_ReturnValue, bool CallFunc_LessEqual_FloatFloat_ReturnValue);
}
