...
class AENE_Spider_Boss_TwinBase_C : UENE_Spider_Boss_Base_C
{
    FPointerToUberGraphFrame UberGraphFrame;
    UAudioComponent* TwinBurrow_Cue;
    UBP_Meet_Attack_C* BP_Meet_Attack;
    ...
    void ExecuteUbergraph_ENE_Spider_Boss_TwinBase(int32 EntryPoint, FName CallFunc_MakeLiteralName_ReturnValue, float CallFunc_Multiply_FloatFloat_ReturnValue, FName CallFunc_MakeLiteralName_ReturnValue_1, FVector CallFunc_K2_GetActorLocation_ReturnValue, FVector CallFunc_GetRandomReachablePointAtApproximateDistance_outPos, bool CallFunc_GetRandomReachablePointAtApproximateDistance_ReturnValue, bool CallFunc_Not_PreBool_ReturnValue, bool CallFunc_IsAlive_ReturnValue, bool CallFunc_BooleanAND_ReturnValue, FVector CallFunc_GetRandomReachablePointAtApproximateDistance_outPos_1, bool CallFunc_GetRandomReachablePointAtApproximateDistance_ReturnValue_1, UBlackboardComponent* CallFunc_GetBlackboard_ReturnValue, float CallFunc_GetHealthPct_ReturnValue, bool CallFunc_IsAlive_ReturnValue_1, UBlackboardComponent* CallFunc_GetBlackboard_ReturnValue_1, float CallFunc_GetHealthPct_ReturnValue_1, FName CallFunc_MakeLiteralName_ReturnValue_2, bool CallFunc_Less_FloatFloat_ReturnValue, bool CallFunc_GetValueAsBool_ReturnValue, bool CallFunc_Not_PreBool_ReturnValue_1, bool CallFunc_BooleanAND_ReturnValue_1, UAnimInstance* CallFunc_GetAnimInstance_ReturnValue, FVector K2Node_CustomEvent_GreeveLocation, FName CallFunc_MakeLiteralName_ReturnValue_3, UBlackboardComponent* CallFunc_GetBlackboard_ReturnValue_2, FName CallFunc_MakeLiteralName_ReturnValue_4, FVector CallFunc_K2_GetActorLocation_ReturnValue_1, FVector CallFunc_GetRandomReachablePointAtApproximateDistance_outPos_2, bool CallFunc_GetRandomReachablePointAtApproximateDistance_ReturnValue_2, UHealthComponentBase* K2Node_ComponentBoundEvent_HealthComponent, bool CallFunc_IsAlive_ReturnValue_2, bool CallFunc_IsAlive_ReturnValue_3, float CallFunc_GetHealth_ReturnValue, float CallFunc_GetHealth_ReturnValue_1, float CallFunc_Subtract_FloatFloat_ReturnValue, float CallFunc_Heal_ReturnValue, float CallFunc_Multiply_FloatFloat_ReturnValue_1, float CallFunc_GetHealth_ReturnValue_2, bool CallFunc_GreaterEqual_FloatFloat_ReturnValue, float CallFunc_Abs_ReturnValue, float CallFunc_Multiply_FloatFloat_ReturnValue_2, float CallFunc_Multiply_FloatFloat_ReturnValue_3, float CallFunc_Heal_ReturnValue_1, float CallFunc_Subtract_FloatFloat_ReturnValue_1, UBlackboardComponent* CallFunc_GetBlackboard_ReturnValue_3, FName CallFunc_MakeLiteralName_ReturnValue_5, UBlackboardComponent* CallFunc_GetBlackboard_ReturnValue_4, float CallFunc_GetHealthPct_ReturnValue_2, bool CallFunc_Less_FloatFloat_ReturnValue_1, bool CallFunc_Not_PreBool_ReturnValue_2, bool CallFunc_BooleanAND_ReturnValue_2, int32 Temp_int_Variable, float K2Node_ComponentBoundEvent_Amount, int32 K2Node_Event_AnimationIndex, bool CallFunc_HasAuthority_ReturnValue, float K2Node_CustomEvent_HealthChange, bool CallFunc_EqualEqual_FloatFloat_ReturnValue, bool CallFunc_BooleanAND_ReturnValue_3, UAudioComponent* CallFunc_SpawnSoundAttached_ReturnValue, UAudioComponent* CallFunc_SpawnSoundAttached_ReturnValue_1, float CallFunc_GetHealthPct_ReturnValue_3, bool CallFunc_Less_FloatFloat_ReturnValue_2, UAnimMontage* Temp_object_Variable, bool CallFunc_RandomBoolWithWeight_ReturnValue, bool CallFunc_Not_PreBool_ReturnValue_3, bool CallFunc_BooleanAND_ReturnValue_4, UAnimMontage* Temp_object_Variable_1, float CallFunc_GetHealthPct_ReturnValue_4, float CallFunc_Subtract_FloatFloat_ReturnValue_2, UAnimMontage* K2Node_Select_Default, float CallFunc_Abs_ReturnValue_1, float CallFunc_Montage_Play_ReturnValue, bool CallFunc_Greater_FloatFloat_ReturnValue, bool CallFunc_IsAlive_ReturnValue_4, bool CallFunc_BooleanAND_ReturnValue_5, FVector CallFunc_K2_GetActorLocation_ReturnValue_2, UPlayerCharacter* CallFunc_FindNearestPlayerCharacter_ReturnValue, bool CallFunc_IsValid_ReturnValue);
