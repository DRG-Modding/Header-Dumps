...
class UOptions_MouseKeyboard_CustomizeControls_C : UUserWidget
{
    ...
    void ExecuteUbergraph_Options_MouseKeyboard_CustomizeControls(int32 EntryPoint, UFSDGameUserSettings* CallFunc_GetFSDGameUserSettings_ReturnValue, bool CallFunc_Not_PreBool_ReturnValue, UBasic_ButtonCutCorner_C* K2Node_ComponentBoundEvent_Button, bool K2Node_Event_IsDesignTime);
}
