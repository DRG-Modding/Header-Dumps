...
class ABP_StabberVine_Claw_C : AActor
{
    FPointerToUberGraphFrame UberGraphFrame;
    UEnemyComponent* enemy;
    UStaticMeshComponent* SM_StabberVine_Blade;
