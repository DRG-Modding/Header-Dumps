...
class UOptions_ShowNetInfo_C : UUserWidget
{
    ...
    void ExecuteUbergraph_Options_ShowNetInfo(int32 EntryPoint, bool K2Node_CustomEvent_NewValue_1, FText K2Node_ComponentBoundEvent_Value, int32 K2Node_ComponentBoundEvent_Index, UFSDGameUserSettings* CallFunc_FSDGameUserSettings_ReturnValue, int32 CallFunc_GetShowNetInfoLevel_ReturnValue, int32 K2Node_CustomEvent_NewValue, bool CallFunc_NotEqual_IntInt_ReturnValue, UFSDGameUserSettings* CallFunc_FSDGameUserSettings_ReturnValue_1);
}
