...
class UABP_FlameThrower_A_C : UAmmoDrivenWeaponAnimInstance
{
    ...
    void ExecuteUbergraph_ABP_FlameThrower_A(int32 EntryPoint, float CallFunc_RandomFloatInRangeFromStream_ReturnValue, FRotator CallFunc_MakeRotator_ReturnValue);
}
