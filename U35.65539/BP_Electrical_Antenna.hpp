...
class ABP_Electrical_Antenna_C : AActor
{
    ...
    void Retract();
    void ExecuteUbergraph_BP_Electrical_Antenna(int32 EntryPoint, float CallFunc_Multiply_FloatFloat_ReturnValue, FVector CallFunc_MakeVector_ReturnValue, FHitResult CallFunc_K2_SetRelativeLocation_SweepHitResult);
}
