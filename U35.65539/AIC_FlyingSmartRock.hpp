...
class AAIC_FlyingSmartRock_C : UFSDAIController
{
    ...
    void ExecuteUbergraph_AIC_FlyingSmartRock(int32 EntryPoint, DeathSig__DelegateSignature K2Node_CreateDelegate_OutputDelegate, bool CallFunc_RunBehaviorTree_ReturnValue, UHealthComponentBase* K2Node_CustomEvent_HealthComponent, APawn* K2Node_Event_PossessedPawn, UEnemyHealthComponent* CallFunc_GetComponentByClass_ReturnValue, FName CallFunc_MakeLiteralName_ReturnValue, TArray<UEscortMule*>& CallFunc_GetAllActorsOfClass_OutActors, UEscortMule* CallFunc_Array_Get_Item, int32 CallFunc_Array_Length_ReturnValue, bool CallFunc_Greater_IntInt_ReturnValue);
}
