...
class UABP_CaveLeech_C : UCaveLeechAnimInstance
{
    ...
    void ExecuteUbergraph_ABP_CaveLeech(int32 EntryPoint, FVector CallFunc_GetForwardVector_ReturnValue, FVector CallFunc_Multiply_VectorFloat_ReturnValue, FVector CallFunc_Add_VectorVector_ReturnValue);
}
