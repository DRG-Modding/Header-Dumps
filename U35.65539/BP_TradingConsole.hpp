...
class ABP_TradingConsole_C : AActor
{
    FPointerToUberGraphFrame UberGraphFrame;
    UBoxComponent* Box1;
    UWidgetComponent* Widget_Second;
    UTextRenderComponent* TextRender;
    UWidgetComponent* Widget_Main;
    ...
    void ExecuteUbergraph_BP_TradingConsole(int32 EntryPoint, UUserWidget* CallFunc_GetUserWidgetObject_ReturnValue, UDealWidget* K2Node_DynamicCast_AsDeal_Widget, bool K2Node_DynamicCast_bSuccess, UFSDGameInstance* CallFunc_GetFSDGameInstance_ReturnValue, UPlayerCharacter* K2Node_ComponentBoundEvent_user, EInputKeys K2Node_ComponentBoundEvent_key, bool CallFunc_IsLocallyControlled_ReturnValue, AController* CallFunc_GetController_ReturnValue, UBP_PlayerController_SpaceRig_C* K2Node_DynamicCast_AsBP_Player_Controller_Space_Rig, bool K2Node_DynamicCast_bSuccess_1, bool CallFunc_IsNewPlayer_IsNewPlayer);
}
