...
class UABP_Spider_Boss_Adult_C : USpiderAnimInstance
{
    ...
    void ExecuteUbergraph_ABP_Spider_Boss_Adult(int32 EntryPoint, UAnimSequenceBase* K2Node_Event_animation);
}
