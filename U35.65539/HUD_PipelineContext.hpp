...
class UHUD_PipelineContext_C : UActorContextWidget
{
    ...
    void ExecuteUbergraph_HUD_PipelineContext(int32 EntryPoint, APawn* CallFunc_GetOwningPlayerPawn_ReturnValue, UPlayerCharacter* K2Node_DynamicCast_AsPlayer_Character, bool K2Node_DynamicCast_bSuccess, AActor* K2Node_Event_InContextActor, UPipelineSegment* K2Node_DynamicCast_AsPipeline_Segment, bool K2Node_DynamicCast_bSuccess_1, bool K2Node_Event_IsDesignTime, FLinearColor CallFunc_MenuColors_OutputColor, FLinearColor CallFunc_MenuColors_OutputColor_1, UPrimitiveComponent* K2Node_Event_InContextPrimitive_1, UPrimitiveComponent* K2Node_Event_InContextPrimitive);
}
