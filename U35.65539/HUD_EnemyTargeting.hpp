...
class UHUD_EnemyTargeting_C : ULookingAtWidget
{
    ...
    UImage* DeadIcon;
    UHUD_EnemyTargeting_HealthBar_C* HealthBar;
    UHUD_EnemyTargeting_HealthBar_Elite_C* HealthBar_Elite;
    ...
    void GetContent(ULookingAtContentWidget*& OutActiveContent, UWidget* CallFunc_GetActiveWidget_ReturnValue, ULookingAtContentWidget* K2Node_DynamicCast_AsLooking_at_Content_Widget, bool K2Node_DynamicCast_bSuccess);
