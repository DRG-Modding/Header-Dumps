...
class UABP_DroppodAirlock_C : UAnimInstance
{
    ...
    void ExecuteUbergraph_ABP_DroppodAirlock(int32 EntryPoint, AActor* CallFunc_GetOwningActor_ReturnValue, float K2Node_Event_DeltaTimeX, UBP_DropPod_Base_C* K2Node_DynamicCast_AsBP_Drop_Pod_Base, bool K2Node_DynamicCast_bSuccess, bool CallFunc_IsValid_ReturnValue, bool K2Node_SwitchEnum_CmpSuccess);
}
