...
class UUI_RichTextInput_C : URichTextInputWidget
{
    FPointerToUberGraphFrame UberGraphFrame;
    UImage* InputIcon;
    UTextBlock* InputText;
    UTextBlock* InteractionText;
    UOverlay* OverlayIcon;
    UOverlay* OverlayText;
    USizeBox* Sizer;
    ...
    void ShowAsIcon(UTexture2D* InTexture, FLinearColor InTint, float Height, int32 CallFunc_Blueprint_GetSizeY_ReturnValue, int32 CallFunc_Blueprint_GetSizeX_ReturnValue, int32 CallFunc_Max_ReturnValue, float CallFunc_Conv_IntToFloat_ReturnValue, float CallFunc_Conv_IntToFloat_ReturnValue_1, float CallFunc_Divide_FloatFloat_ReturnValue, float CallFunc_GetLineHeight_ReturnValue, float CallFunc_Multiply_FloatFloat_ReturnValue);
