...
class UABP_BombSpitter_C : UAnimInstance
{
    ...
    void ExecuteUbergraph_ABP_BombSpitter(int32 EntryPoint, bool K2Node_CustomEvent_Closed, bool K2Node_CustomEvent_Open, OnChangeState__DelegateSignature K2Node_CreateDelegate_OutputDelegate, AActor* CallFunc_GetOwningActor_ReturnValue, ABP_BombSpitter_C* K2Node_DynamicCast_AsBP_Bomb_Spitter, bool K2Node_DynamicCast_bSuccess);
}
