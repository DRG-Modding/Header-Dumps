...
class UUI_PatchNotes_C : UUserWidget
{
    FPointerToUberGraphFrame UberGraphFrame;
    UBasic_Menu_SmallWindowWithHeader_Redesign_C* Basic_Menu_SmallWindowWithHeader;
    UBasic_ScrollBarBox_C* Basic_ScrollBarBox;
    URichTextBlock* PatchTextBlock;
    UBasic_ScrollArrow_C* ScrollArrow_Left;
    UBasic_ScrollArrow_C* ScrollArrow_Right;
