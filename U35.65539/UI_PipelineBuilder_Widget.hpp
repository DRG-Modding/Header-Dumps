...
class UUI_PipelineBuilder_Widget_C : UUserWidget
{
    FPointerToUberGraphFrame UberGraphFrame;
    UImage* BarSlope;
    UImage* InvalidBackground;
    UFSDLabelWidget* LabelLength;
    UFSDLabelWidget* LabelObstruction;
    UFSDLabelWidget* LabelSlope;
    UProgressBar* ProgressBarLength;
    USlider* SliderElevation;
    USlider* SliderObstruction;
    UImage* ValidBackground;
