...
class UHud_LockOnTarget_C : ULockOnTrackingWidget
{
    FPointerToUberGraphFrame UberGraphFrame;
    UWidgetAnimation* SavedAmmoOutro;
    UWidgetAnimation* TargetLocked;
    UImage* Arrow;
    UImage* CrossHair_Base;
    UImage* CrossHair_Glow;
    UImage* CrossHair_Glow_1;
    USizeBox* CrosshairSize;
    UTextBlock* Text_LockOnCount;
    UVerticalBox* VerticalBox_Crosshair;
    float ArrowRadius;
    float ArrowRotation;
    float ArrowAngle;
