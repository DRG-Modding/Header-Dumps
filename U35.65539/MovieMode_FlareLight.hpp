...
class UMovieMode_FlareLight_C : UUserWidget
{
    ...
    void Update(FLinearColor SlideBarColor, UPointLightComponent* PointLight, float CallFunc_GetValue_ReturnValue, float CallFunc_GetValue_ReturnValue_1, float CallFunc_GetValue_ReturnValue_2, float CallFunc_Square_ReturnValue, float CallFunc_GetValue_ReturnValue_3, float CallFunc_Square_ReturnValue_1, bool CallFunc_NotEqual_ObjectObject_ReturnValue, APawn* CallFunc_GetOwningPlayerPawn_ReturnValue, UBP_PlayerCameraDrone_C* K2Node_DynamicCast_AsBP_Player_Camera_Drone, bool K2Node_DynamicCast_bSuccess, FLinearColor CallFunc_GetLightColor_ReturnValue, float CallFunc_RGBToHSV_H, float CallFunc_RGBToHSV_S, float CallFunc_RGBToHSV_V, float CallFunc_RGBToHSV_A, FLinearColor CallFunc_HSVToRGB_ReturnValue);
    void Construct();
