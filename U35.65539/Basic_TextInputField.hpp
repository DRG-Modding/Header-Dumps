...
class UBasic_TextInputField_C : UUserWidget
{
    FPointerToUberGraphFrame UberGraphFrame;
    UEditableTextBox* InputField;
    UBorder* InputFieldBorder;
    FText HintText;
    ...
    void BndEvt__InputField_K2Node_ComponentBoundEvent_1_OnEditableTextBoxCommittedEvent__DelegateSignature(const FText& Text, uint8 CommitMethod);
    void ExecuteUbergraph_Basic_TextInputField(int32 EntryPoint, const FText K2Node_ComponentBoundEvent_Text, uint8 K2Node_ComponentBoundEvent_CommitMethod, bool K2Node_Event_IsDesignTime, FLinearColor CallFunc_MenuColors_OutputColor, const FText K2Node_ComponentBoundEvent_Text_1);
