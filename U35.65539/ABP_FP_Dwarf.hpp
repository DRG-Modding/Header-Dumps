...
class UABP_FP_Dwarf_C : UPlayerFPAnimInstance
{
    ...
    void ExecuteUbergraph_ABP_FP_Dwarf(int32 EntryPoint, UItemCharacterAnimationSet* CallFunc_GetAnimationSet_ReturnValue, float CallFunc_Montage_Play_ReturnValue);
}
