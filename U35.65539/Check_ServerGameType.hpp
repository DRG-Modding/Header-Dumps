...
class UCheck_ServerGameType_C : UUserWidget
{
    ...
    void Reset(bool InSandbox, UUGCRegistry* CallFunc_GetUGCRegistry_ReturnValue, UUGCRegistry* CallFunc_GetUGCRegistry_ReturnValue_1, bool CallFunc_IsValid_ReturnValue, bool CallFunc_IsValid_ReturnValue_1, UFSDGameUserSettings* CallFunc_GetFSDGameUserSettings_ReturnValue, bool CallFunc_GetModdingServerFilterEnabled_ReturnValue, bool CallFunc_BooleanAND_ReturnValue);
    bool IsInteractable();
