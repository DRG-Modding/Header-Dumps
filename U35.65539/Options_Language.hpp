...
class UOptions_Language_C : UUserWidget
{
    FPointerToUberGraphFrame UberGraphFrame;
    UBasic_OptionSwitcher_C* Basic_OptionSwitcher;
    UUI_AdvancedLabel_C* WorkInProgress;
