...
class ABP_ReturningPromotionKey_C : UDeepPathfinderCharacter
{
    FPointerToUberGraphFrame UberGraphFrame;
    UAudioComponent* MovingAudioComponent;
    UStaticMeshComponent* KeyMesh;
    USceneComponent* KeyMover;
