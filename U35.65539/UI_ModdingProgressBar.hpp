...
class UUI_ModdingProgressBar_C : UUserWidget
{
    FPointerToUberGraphFrame UberGraphFrame;
    UProgressBar* ActionProgressBar;
    USizeBox* HeightSizeBox;
    UBasic_Label_C* LabelAction;
    int32 Height;
    ...
    void ExecuteUbergraph_UI_ModdingProgressBar(int32 EntryPoint, bool Temp_bool_Variable, uint8 Temp_byte_Variable, bool K2Node_Event_IsDesignTime, float CallFunc_Conv_IntToFloat_ReturnValue, uint8 Temp_byte_Variable_1, bool CallFunc_Greater_IntInt_ReturnValue, UOverlaySlot* CallFunc_SlotAsOverlaySlot_ReturnValue, bool CallFunc_Greater_IntInt_ReturnValue_1, bool CallFunc_Greater_IntInt_ReturnValue_2, UOverlaySlot* CallFunc_SlotAsOverlaySlot_ReturnValue_1, bool CallFunc_Greater_IntInt_ReturnValue_3, float CallFunc_Conv_IntToFloat_ReturnValue_1, uint8 K2Node_Select_Default, bool Temp_bool_Variable_1, uint8 K2Node_Select_Default_1);
}
