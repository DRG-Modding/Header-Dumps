...
class AENE_Spider_Hoarder_C : UENE_SpiderBase_Large_C
{
    FPointerToUberGraphFrame UberGraphFrame;
    UPointLightComponent* PointLight3;
    UPointLightComponent* PointLight2;
    UPhysicalAnimationComponent* PhysicalAnimation;
    USkeletalMeshComponent* SK_HoarderHead_A;
    USkeletalMeshComponent* SK_HoarderBack_A;
    UPointLightComponent* PointLight1;
    UAudioComponent* AudioScaredEnd;
    UAudioComponent* AudioScaredLoop;
    UAudioComponent* AudioScaredBegin;
    ...
    void UpdateTarget(float MaxDistance, bool& OutTargetChanged, bool TargetChanged, AActor* NewTarget, FName KeyTarget, FName KeyIsAlerted, UBlackboardComponent* Blackboard, bool CallFunc_IsValid_ReturnValue, UBlackboardComponent* CallFunc_GetBlackboard_ReturnValue, bool CallFunc_IsAlive_ReturnValue, bool CallFunc_IsValid_ReturnValue_1, bool CallFunc_IsValid_ReturnValue_2, bool CallFunc_NotEqual_BoolBool_ReturnValue, float CallFunc_GetDistanceTo_ReturnValue, bool CallFunc_Greater_FloatFloat_ReturnValue, UObject* CallFunc_GetValueAsObject_ReturnValue, AActor* K2Node_DynamicCast_AsActor, bool K2Node_DynamicCast_bSuccess, bool CallFunc_GetValueAsBool_ReturnValue, bool CallFunc_IsValid_ReturnValue_3);
