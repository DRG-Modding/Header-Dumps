...
class UWND_JobsEntryV2_C : UWND_Jobs_Entry_Base_C
{
    ...
    void Refresh();
    void Event_Updated();
    void ExecuteUbergraph_WND_JobsEntryV2(int32 EntryPoint, ESlateVisibility Temp_byte_Variable, UMaterialInstanceDynamic* CallFunc_GetDynamicMaterial_ReturnValue, int32 Temp_int_Array_Index_Variable, int32 Temp_int_Loop_Counter_Variable, bool CallFunc_EqualEqual_IntInt_ReturnValue, int32 CallFunc_Add_IntInt_ReturnValue, bool K2Node_Event_IsDesignTime, bool CallFunc_IsActiveCampaign_ReturnValue, UCampaignManager* CallFunc_GetCampaingManager_ReturnValue, UCampaign* K2Node_Event_Campaign, UWindowManager* CallFunc_GetWindowManager_ReturnValue, ESlateVisibility Temp_byte_Variable_1, UWND_Assignment_Popup_C* CallFunc_OpenWindowFromClass_ReturnValue, FLinearColor CallFunc_MenuColors_OutputColor, FLinearColor CallFunc_MenuColors_OutputColor_1, FLinearColor CallFunc_MenuColors_OutputColor_2, bool Temp_bool_Variable, int32 CallFunc_Array_Length_ReturnValue, Updated__DelegateSignature K2Node_CreateDelegate_OutputDelegate, bool CallFunc_Less_IntInt_ReturnValue, UMaterialInstanceDynamic* CallFunc_CreateDynamicMaterialInstance_ReturnValue, bool CallFunc_IsActiveCampaign_ReturnValue_1, bool CallFunc_SetData_RequirementsMet, ESlateVisibility K2Node_Select_Default, UITM_CampaignItem_SmallEmpty_C* CallFunc_Create_ReturnValue, UHorizontalBoxSlot* CallFunc_AddChildToHorizontalBox_ReturnValue, FLinearColor CallFunc_MenuColors_OutputColor_3);
}
