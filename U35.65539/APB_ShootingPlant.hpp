...
class UAPB_ShootingPlant_C : UShootingPlantAnimInstance
{
    ...
    AENE_ShootingPlant_C* ShootingPlant;
    ...
    void ExecuteUbergraph_APB_ShootingPlant(int32 EntryPoint, APawn* CallFunc_TryGetPawnOwner_ReturnValue, bool CallFunc_IsValid_ReturnValue, bool CallFunc_Greater_FloatFloat_ReturnValue, UENE_ShootingPlant_C* K2Node_DynamicCast_AsENE_Shooting_Plant, bool K2Node_DynamicCast_bSuccess, bool CallFunc_Less_FloatFloat_ReturnValue, float CallFunc_Abs_ReturnValue, float CallFunc_MapRangeClamped_ReturnValue, float CallFunc_MapRangeClamped_ReturnValue_1);
}
