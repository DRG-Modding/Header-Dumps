...
class ABP_ShowroomStageSeason_C : AShowroomStage
{
    ...
    void ExecuteUbergraph_BP_ShowroomStageSeason(int32 EntryPoint, int32 Temp_int_Array_Index_Variable, int32 Temp_int_Loop_Counter_Variable, int32 CallFunc_Add_IntInt_ReturnValue, TArray<ABP_Skysphere_HoxxesStars_C*>& CallFunc_GetAllActorsOfClass_OutActors, int32 CallFunc_Array_Length_ReturnValue, ABP_Skysphere_HoxxesStars_C* CallFunc_Array_Get_Item, bool CallFunc_Less_IntInt_ReturnValue, int32 CallFunc_Array_Add_ReturnValue);
}
