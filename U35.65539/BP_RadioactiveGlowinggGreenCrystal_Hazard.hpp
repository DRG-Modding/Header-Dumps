...
class ABP_RadioactiveGlowinggGreenCrystal_Hazard_C : ABP_GlowingBlueCrystal_Base_C
{
    ...
    UTimelineComponent* DamageGlowPulse;
    bool DoPulse;
    ...
    void OnRep_DoPulse();
    void CanApplyEffect(TSubclassOf<UStatusEffect> effect, bool& Result, UPawnStatsComponent* StatComponent, float CallFunc_GetMaxResistance_ReturnValue, bool CallFunc_IsValid_ReturnValue, UDamageClass* CallFunc_GetDamageClass_ReturnValue, float CallFunc_GetStatValue_ReturnValue, UPawnStatsComponent* CallFunc_GetComponentByClass_ReturnValue, bool CallFunc_GreaterEqual_FloatFloat_ReturnValue);
