...
class UITM_NewsTicker_C : UUserWidget
{
    FPointerToUberGraphFrame UberGraphFrame;
    UUI_TickerText_C* UI_TickerText;
    UNewsTextHeadlines* MineralTradeData;
    int32 LastSeed;
    bool IsTesting;
    UMissionNameBank* MissionNames;
    UNewsTextLists* NewsTexts;
