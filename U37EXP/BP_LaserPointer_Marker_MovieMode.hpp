#ifndef UE4SS_SDK_BP_LaserPointer_Marker_MovieMode_HPP
#define UE4SS_SDK_BP_LaserPointer_Marker_MovieMode_HPP

class ABP_LaserPointer_Marker_MovieMode_C : public ALaserPointerMarker
{
    ...
    void ExecuteUbergraph_BP_LaserPointer_Marker_MovieMode(int32 EntryPoint);
};
