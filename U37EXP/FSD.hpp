...
class ABouncyBoomerang : public AGrenade
{
    ...
    TSubclassOf<class UStatusEffect> SnareSTE;
...
class ACrossbow : public AAmmoDrivenWeapon
{
    ...
    void Server_CallSwitchAmmoType(class UProjectileLauncherBaseComponent* projectileLauncher);
    ...
    void All_SetTPReloadAnim(class UAnimMontage* TPMontage, class UAnimMontage* WeaponMontage);
};
...
class ACrossbowProjectileBase : public AProjectile
{
    ...
    class UDamageComponent* DamageComponent;
    class UTerrainDetectComponent* TerrainDetectComponent;
...
class ACrossbowProjectileStuck : public AFSDPhysicsActor
{
    ...
    class USphereComponent* LaserCollider;
    TWeakObjectPtr<class ACrossbowProjectileBase> BaseProjectile;
...
class USessionHandling : public UBlueprintFunctionLibrary
{
    ...
    bool GetBlockedUsersList(int32 localUserNum, TArray<FFriendInfo>& BlockedPlayers);
...
class UTerrainFunctionLibrary : public UBlueprintFunctionLibrary
{
    ...
    bool GetDebrisTransformsInSphere(class UObject* WorldContextObject, TArray<FMatrix>& outPositions, const FVector& Location, const float& Radius, const ESpecialDebrisType& debrisType, float minDistToOther);
