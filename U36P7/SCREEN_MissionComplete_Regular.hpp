...
class USCREEN_MissionComplete_Regular_C : public UWindowWidget
{
    ...
    int32 Sum;
    FSCREEN_MissionComplete_Regular_COnContinue OnContinue;
    void OnContinue();
    float WarningBonusTotal;
    bool SeasonFlowSeen;
    float ContinueToSeasonTime;
    int32 ContinueStartTime;
    FSCREEN_MissionComplete_Regular_COnShowCursor OnShowCursor;
