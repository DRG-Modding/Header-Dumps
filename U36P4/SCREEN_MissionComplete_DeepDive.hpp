...
class USCREEN_MissionComplete_DeepDive_C : public UUserWidget
{
    ...
    FSCREEN_MissionComplete_DeepDive_COnShowCursor OnShowCursor;
    void OnShowCursor(class UUserWidget* InWidget);
    ...
    void OnShowCursor__DelegateSignature(class UUserWidget* InWidget);
