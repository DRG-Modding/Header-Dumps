...
struct UABP_LineCutter_C : UAnimInstance {
	...
	void AnimGraph(struct FPoseLink AnimGraph); // Function ABP_LineCutter.ABP_LineCutter_C.AnimGraph
	void ExecuteUbergraph_ABP_LineCutter(int32_t EntryPoint); // Function ABP_LineCutter.ABP_LineCutter_C.ExecuteUbergraph_ABP_LineCutter
};
