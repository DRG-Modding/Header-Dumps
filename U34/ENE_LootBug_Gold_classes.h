...
struct AENE_LootBug_Gold_C : AENE_LootBug_C {
	...
	void OnLootBugDeath(); // Function ENE_LootBug_Gold.ENE_LootBug_Gold_C.OnLootBugDeath
	void ExecuteUbergraph_ENE_LootBug_Gold(int32_t EntryPoint); // Function ENE_LootBug_Gold.ENE_LootBug_Gold_C.ExecuteUbergraph_ENE_LootBug_Gold
};
