...
struct UTutorial_Hint_LowO2_C : UTutorialHintComponent {
	...
	void ReceiveOnInitialized(); // Function Tutorial_Hint_LowO2.Tutorial_Hint_LowO2_C.ReceiveOnInitialized
	void ExecuteUbergraph_Tutorial_Hint_LowO2(int32_t EntryPoint); // Function Tutorial_Hint_LowO2.Tutorial_Hint_LowO2_C.ExecuteUbergraph_Tutorial_Hint_LowO2
};
