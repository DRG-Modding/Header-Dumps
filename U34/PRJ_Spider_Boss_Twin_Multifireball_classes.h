...
struct APRJ_Spider_Boss_Twin_Multifireball_C : AProjectile {
	...
	void OnImpacted(bool PredictedImpact, struct FHitResult HitResult); // Function PRJ_Spider_Boss_Twin_Multifireball.PRJ_Spider_Boss_Twin_Multifireball_C.OnImpacted
	void ReceiveBeginPlay(); // Function PRJ_Spider_Boss_Twin_Multifireball.PRJ_Spider_Boss_Twin_Multifireball_C.ReceiveBeginPlay
	void ExecuteUbergraph_PRJ_Spider_Boss_Twin_Multifireball(int32_t EntryPoint); // Function PRJ_Spider_Boss_Twin_Multifireball.PRJ_Spider_Boss_Twin_Multifireball_C.ExecuteUbergraph_PRJ_Spider_Boss_Twin_Multifireball
};
