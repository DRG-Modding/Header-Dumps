...
struct UAnnouncement_Vanity_C : UUserWidget {
	...
	void PreConstruct(bool IsDesignTime); // Function Announcement_Vanity.Announcement_Vanity_C.PreConstruct
	void Construct(); // Function Announcement_Vanity.Announcement_Vanity_C.Construct
	void OnAnnounceAnimFinished(); // Function Announcement_Vanity.Announcement_Vanity_C.OnAnnounceAnimFinished
	void ExecuteUbergraph_Announcement_Vanity(int32_t EntryPoint); // Function Announcement_Vanity.Announcement_Vanity_C.ExecuteUbergraph_Announcement_Vanity
};
