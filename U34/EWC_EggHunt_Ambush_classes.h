...
struct UEWC_EggHunt_Ambush_C : UEWC_Base_C {
	...
	void StartWave(); // Function EWC_EggHunt_Ambush.EWC_EggHunt_Ambush_C.StartWave
	void ExecuteUbergraph_EWC_EggHunt_Ambush(int32_t EntryPoint); // Function EWC_EggHunt_Ambush.EWC_EggHunt_Ambush_C.ExecuteUbergraph_EWC_EggHunt_Ambush
};
