...
struct UABP_BurstPistol_C : UAnimInstance {
	...
	void AnimGraph(struct FPoseLink AnimGraph); // Function ABP_BurstPistol.ABP_BurstPistol_C.AnimGraph
	void ExecuteUbergraph_ABP_BurstPistol(int32_t EntryPoint); // Function ABP_BurstPistol.ABP_BurstPistol_C.ExecuteUbergraph_ABP_BurstPistol
};
