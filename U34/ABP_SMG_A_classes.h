...
struct UABP_SMG_A_C : UAnimInstance {
	...
	void AnimGraph(struct FPoseLink AnimGraph); // Function ABP_SMG_A.ABP_SMG_A_C.AnimGraph
	void ExecuteUbergraph_ABP_SMG_A(int32_t EntryPoint); // Function ABP_SMG_A.ABP_SMG_A_C.ExecuteUbergraph_ABP_SMG_A
};
