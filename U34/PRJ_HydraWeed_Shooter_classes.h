...
struct APRJ_HydraWeed_Shooter_C : AProjectile {
	...
	void OnImpacted(bool PredictedImpact, struct FHitResult HitResult); // Function PRJ_HydraWeed_Shooter.PRJ_HydraWeed_Shooter_C.OnImpacted
	void GoBoom(); // Function PRJ_HydraWeed_Shooter.PRJ_HydraWeed_Shooter_C.GoBoom
	void BndEvt__SimpleHealth_K2Node_ComponentBoundEvent_1_DeathSig__DelegateSignature(struct UHealthComponentBase* HealthComponent); // Function PRJ_HydraWeed_Shooter.PRJ_HydraWeed_Shooter_C.BndEvt__SimpleHealth_K2Node_ComponentBoundEvent_1_DeathSig__DelegateSignature
	void ExecuteUbergraph_PRJ_HydraWeed_Shooter(int32_t EntryPoint); // Function PRJ_HydraWeed_Shooter.PRJ_HydraWeed_Shooter_C.ExecuteUbergraph_PRJ_HydraWeed_Shooter
};
