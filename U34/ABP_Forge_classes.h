...
struct UABP_Forge_C : UAnimInstance {
	...
	void AnimGraph(struct FPoseLink AnimGraph); // Function ABP_Forge.ABP_Forge_C.AnimGraph
	void ExecuteUbergraph_ABP_Forge(int32_t EntryPoint); // Function ABP_Forge.ABP_Forge_C.ExecuteUbergraph_ABP_Forge
};
