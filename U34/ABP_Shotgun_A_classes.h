...
struct UABP_Shotgun_A_C : UAnimInstance {
	...
	void AnimGraph(struct FPoseLink AnimGraph); // Function ABP_Shotgun_A.ABP_Shotgun_A_C.AnimGraph
	void ExecuteUbergraph_ABP_Shotgun_A(int32_t EntryPoint); // Function ABP_Shotgun_A.ABP_Shotgun_A_C.ExecuteUbergraph_ABP_Shotgun_A
};
