...
struct UBasic_BG_CutCorner_Gradient_C : UUserWidget {
	...
	void PreConstruct(bool IsDesignTime); // Function Basic_BG_CutCorner_Gradient.Basic_BG_CutCorner_Gradient_C.PreConstruct
	void SetBorderColor(struct FLinearColor InputPin); // Function Basic_BG_CutCorner_Gradient.Basic_BG_CutCorner_Gradient_C.SetBorderColor
	void ExecuteUbergraph_Basic_BG_CutCorner_Gradient(int32_t EntryPoint); // Function Basic_BG_CutCorner_Gradient.Basic_BG_CutCorner_Gradient_C.ExecuteUbergraph_Basic_BG_CutCorner_Gradient
};
