...
struct UABP_AssaultRifle_B_C : UAnimInstance {
	...
	void AnimGraph(struct FPoseLink AnimGraph); // Function ABP_AssaultRifle_B.ABP_AssaultRifle_B_C.AnimGraph
	void ExecuteUbergraph_ABP_AssaultRifle_B(int32_t EntryPoint); // Function ABP_AssaultRifle_B.ABP_AssaultRifle_B_C.ExecuteUbergraph_ABP_AssaultRifle_B
};
