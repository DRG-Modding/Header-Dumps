...
struct UABP_Sideburns_Rig_A_C : UVanityAnimInstance {
	...
	void AnimGraph(struct FPoseLink AnimGraph); // Function ABP_Sideburns_Rig_A.ABP_Sideburns_Rig_A_C.AnimGraph
	void ExecuteUbergraph_ABP_Sideburns_Rig_A(int32_t EntryPoint); // Function ABP_Sideburns_Rig_A.ABP_Sideburns_Rig_A_C.ExecuteUbergraph_ABP_Sideburns_Rig_A
};
