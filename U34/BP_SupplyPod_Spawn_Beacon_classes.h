...
struct ABP_SupplyPod_Spawn_Beacon_C : AActor {
	...
	char Light_Animation__Direction_E164D22C46553D83DD4416AB36BC320A; // 0x2c4(0x01)
	...
	void UserConstructionScript(); // Function BP_SupplyPod_Spawn_Beacon.BP_SupplyPod_Spawn_Beacon_C.UserConstructionScript
	void Light Animation__FinishedFunc(); // Function BP_SupplyPod_Spawn_Beacon.BP_SupplyPod_Spawn_Beacon_C.Light Animation__FinishedFunc
	void Light Animation__UpdateFunc(); // Function BP_SupplyPod_Spawn_Beacon.BP_SupplyPod_Spawn_Beacon_C.Light Animation__UpdateFunc
	void ReceiveTick(float DeltaSeconds); // Function BP_SupplyPod_Spawn_Beacon.BP_SupplyPod_Spawn_Beacon_C.ReceiveTick
	void ReceiveBeginPlay(); // Function BP_SupplyPod_Spawn_Beacon.BP_SupplyPod_Spawn_Beacon_C.ReceiveBeginPlay
	void ExecuteUbergraph_BP_SupplyPod_Spawn_Beacon(int32_t EntryPoint); // Function BP_SupplyPod_Spawn_Beacon.BP_SupplyPod_Spawn_Beacon_C.ExecuteUbergraph_BP_SupplyPod_Spawn_Beacon
};
