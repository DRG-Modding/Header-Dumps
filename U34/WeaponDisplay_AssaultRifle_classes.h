...
struct UWeaponDisplay_AssaultRifle_C : UWeaponDisplay_Base_AmmoCount_C {
	...
	void SetTotalCount(int32_t Value); // Function WeaponDisplay_AssaultRifle.WeaponDisplay_AssaultRifle_C.SetTotalCount
	void SetClipCount(int32_t Value); // Function WeaponDisplay_AssaultRifle.WeaponDisplay_AssaultRifle_C.SetClipCount
	void ExecuteUbergraph_WeaponDisplay_AssaultRifle(int32_t EntryPoint); // Function WeaponDisplay_AssaultRifle.WeaponDisplay_AssaultRifle_C.ExecuteUbergraph_WeaponDisplay_AssaultRifle
};
