...
struct ABP_OilShaleChunk_C : AResourceChunk {
	...
	void ReceiveBeginPlay(); // Function BP_OilShaleChunk.BP_OilShaleChunk_C.ReceiveBeginPlay
	void ExecuteUbergraph_BP_OilShaleChunk(int32_t EntryPoint); // Function BP_OilShaleChunk.BP_OilShaleChunk_C.ExecuteUbergraph_BP_OilShaleChunk
};
