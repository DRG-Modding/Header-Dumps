...
struct APRJ_Spider_Tank_Boss_C : AProjectile {
	...
	void OnImpacted(bool PredictedImpact, struct FHitResult HitResult); // Function PRJ_Spider_Tank_Boss.PRJ_Spider_Tank_Boss_C.OnImpacted
	void ExecuteUbergraph_PRJ_Spider_Tank_Boss(int32_t EntryPoint); // Function PRJ_Spider_Tank_Boss.PRJ_Spider_Tank_Boss_C.ExecuteUbergraph_PRJ_Spider_Tank_Boss
};
