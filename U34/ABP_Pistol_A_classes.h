...
struct UABP_Pistol_A_C : UAnimInstance {
	...
	void AnimGraph(struct FPoseLink AnimGraph); // Function ABP_Pistol_A.ABP_Pistol_A_C.AnimGraph
	void ExecuteUbergraph_ABP_Pistol_A(int32_t EntryPoint); // Function ABP_Pistol_A.ABP_Pistol_A_C.ExecuteUbergraph_ABP_Pistol_A
};
