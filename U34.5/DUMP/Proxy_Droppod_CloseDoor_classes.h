// BlueprintGeneratedClass Proxy_Droppod_CloseDoor.Proxy_Droppod_CloseDoor_C
// Size: 0x238 (Inherited: 0x220)
struct AProxy_Droppod_CloseDoor_C : AActor {
	...
	void ExecuteUbergraph_Proxy_Droppod_CloseDoor(int32_t EntryPoint);
};
