...
struct UHUD_TeamDisplay_SmallItem_C : UUserWidget {
	...
	AFSDPlayerState* PlayerState; // 0x2b8(0x08)
	UPlayerHealthComponent* HealthComponent; // 0x2c0(0x08)
	APlayerCharacter* PlayerCharacter; // 0x2c8(0x08)
	bool IsDown; // 0x2d0(0x01)
	bool IsParalyzed; // 0x2d1(0x01)
	bool AnimateIntro; // 0x2d2(0x01)
	bool LaserpointerEquipped; // 0x2d3(0x01)
	APlayerCharacter* LocalCharacter; // 0x2d8(0x08)
	AFSDPlayerState* LocalPlayerState; // 0x2e0(0x08)
	bool LookingAtSupplyPod; // 0x2e8(0x01)
	UHUDVisibilityGroup* VisibilityGroup; // 0x2f0(0x08)
