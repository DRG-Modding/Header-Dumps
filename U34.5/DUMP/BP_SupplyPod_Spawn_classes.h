...
struct ABP_SupplyPod_Spawn_C : ARessuplyPodSpawn {
	...
	UChildActorComponent* CaveData; // 0x2d0(0x08)
	UStaticMeshComponent* Cube; // 0x2d8(0x08)
	UChildActorComponent* MisisonData; // 0x2e0(0x08)
	UStaticMeshComponent* Mesh_Left; // 0x2e8(0x08)
	UBoxComponent* Box_Left; // 0x2f0(0x08)
	UStaticMeshComponent* Mesh_Back; // 0x2f8(0x08)
	UBoxComponent* Box_Back; // 0x300(0x08)
	UStaticMeshComponent* Mesh_Right; // 0x308(0x08)
	UBoxComponent* Box_Right; // 0x310(0x08)
	UStaticMeshComponent* mesh_front; // 0x318(0x08)
	UBoxComponent* Box_Front; // 0x320(0x08)
	USceneComponent* Doors; // 0x328(0x08)
	UStaticMeshComponent* Cylinder; // 0x330(0x08)
	UParticleSystemComponent* P_DropPod_DoorRocks1; // 0x338(0x08)
	UParticleSystemComponent* P_DropPod_DoorRocks; // 0x340(0x08)
	UMeshCarverComponent* MeshCarver; // 0x348(0x08)
	UAudioComponent* DropPodDrilling_Supply_Cue; // 0x350(0x08)
	UPointLightComponent* PointLight; // 0x358(0x08)
	USimpleObjectInfoComponent* SimpleObjectInfo; // 0x360(0x08)
	USceneComponent* PlayerSpawn; // 0x368(0x08)
	UStaticMeshComponent* Mesh_Bottom; // 0x370(0x08)
	UPathfinderCollisionComponent* PathfinderCollision; // 0x378(0x08)
	USkeletalMeshComponent* SK_DropPod_Drill; // 0x380(0x08)
	UAudioComponent* Audio; // 0x388(0x08)
	UOutlineComponent* outline; // 0x390(0x08)
	UAutoCarverComponent* AutoCarver; // 0x398(0x08)
	URadarPointComponent* radarPoint; // 0x3a0(0x08)
	float Timeline_0_RedLightIntensity_B6127BD049EFB0C47436D5B0D49067CC; // 0x3a8(0x04)
	enum class ETimelineDirection Timeline_0__Direction_B6127BD049EFB0C47436D5B0D49067CC; // 0x3ac(0x01)
	UTimelineComponent* Timeline_1; // 0x3b0(0x08)
	AFSDPlayerController* Player; // 0x3b8(0x08)
	APlayerCharacter* Character; // 0x3c0(0x08)
