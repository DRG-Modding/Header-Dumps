// BlueprintGeneratedClass Proxy_CallEscortGarage.Proxy_CallEscortGarage_C
// Size: 0x238 (Inherited: 0x220)
struct AProxy_CallEscortGarage_C : AActor {
	...
	void ExecuteUbergraph_Proxy_CallEscortGarage(int32_t EntryPoint);
};
