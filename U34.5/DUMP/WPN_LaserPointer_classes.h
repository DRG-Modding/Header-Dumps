...
struct AWPN_LaserPointer_C : ALaserPointerItem {
	...
	UFirstPersonWidgetComponent* FirstPersonWidget; // 0x520(0x08)
	USceneComponent* FPTransform; // 0x528(0x08)
	UStaticMeshComponent* LightBeam_Cylinder; // 0x530(0x08)
	USceneComponent* LightBeam; // 0x538(0x08)
	UAudioComponent* LaserLight_On_Cue; // 0x540(0x08)
	UCrosshairAggregator* CrosshairAggregator; // 0x548(0x08)
	USceneComponent* TPTransform; // 0x550(0x08)
	UHUD_LaserPointerDisplay_C* HUD; // 0x558(0x08)
	float Delay; // 0x560(0x04)
	UMaterialInstanceDynamic* BackgroundMaterial; // 0x568(0x08)
	FLinearColor BackgroundDefaultColor; // 0x570(0x10)
	TArray<ABP_PointOfInterest_C*> PointsOfInterest; // 0x580(0x10)
	UTexture2D* PreviousPOI; // 0x590(0x08)
	float PreviousPOITime; // 0x598(0x04)
	UAudioComponent* StartStop; // 0x5a0(0x08)
	FGuid PreviousLookAtID; // 0x5a8(0x10)
