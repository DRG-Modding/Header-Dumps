...
struct UBPL_UpgradeHelpers_C : UBlueprintFunctionLibrary {
	...
	void UPGDESC_Armor(AFSDPlayerState* Player, AArmorPiece* armorClass, enum class EArmorUpgradeType Armor Upgrade Type, FText Text, enum class FormatWeaponStatType Format, UObject* __WorldContext, FGearStatEntry GearStatEntry);
	...
	void UPGDESC_ShieldRegenerator(AItem* Item, AFSDPlayerState* Player, enum class EArmorRegeneratorUpgrades upgradeType, UObject* __WorldContext, FGearStatEntry GearStatEntry, bool HasUpgradedValue);
	...
	void FormatValue(float BaseValue, float UpgradeValue, float OldUpgradeValue, enum class EItemPreviewStatus PreviewStatus, float FinalValue, enum class FormatWeaponStatType Format, UObject* __WorldContext, FText BaseText, FText UpgradeText, FText Value);
	...
	void UPGDESC_SentryGun_Capacity(AItem* Item, AFSDPlayerState* Player, UObject* __WorldContext, FGearStatEntry GearStatEntry);
	...
	void UPGDESC_Capacity(AActor* upgradedItem, AFSDPlayerState* Player, UObject* __WorldContext, FGearStatEntry GearStatEntry);
	void UPGDESC_Explosion_Damage(AActor* upgradedItem, AActor* componentItem, AFSDPlayerState* Player, UObject* __WorldContext, FGearStatEntry GearStatEntry);
	void UPGDESC_Explosion_Radius(AActor* upgradedItem, AActor* componentItem, AFSDPlayerState* Player, UObject* __WorldContext, FGearStatEntry GearStatEntry);
