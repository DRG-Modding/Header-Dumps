...
struct UMenu_RestoreSaves_C : UWindowWidget {
	...
	UBasic_Menu_LargeWindowWithHeader_C* MainWindow; // 0x2c8(0x08)
	UVerticalBox* RetrieveCloudBox; // 0x2d0(0x08)
	UTextBlock* RetrieveText; // 0x2d8(0x08)
	UScrollBox* SavesScrollBox; // 0x2e0(0x08)
	UCircularThrobber* WaitinForCloudCircularThrobber; // 0x2e8(0x08)
	UBasic_ButtonTab_C* ActiveTabButton; // 0x2f0(0x08)
	TArray<UFSDSaveGame*> SaveFilesForUser; // 0x2f8(0x10)
	AFSDPlayerState* PlayerState; // 0x308(0x08)
	TArray<UFSDSaveGame*> CloudSavesForUser; // 0x310(0x10)
