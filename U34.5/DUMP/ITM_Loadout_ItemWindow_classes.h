...
struct UITM_Loadout_ItemWindow_C : UUserWidget {
	...
	UTextBlock* DATA_ItemCount; // 0x278(0x08)
	UTextBlock* DATA_ItemName2; // 0x280(0x08)
	UImage* GearIcon_BG; // 0x288(0x08)
	UImage* GearIcon_Outline; // 0x290(0x08)
	UImage* HeaderGradient; // 0x298(0x08)
	UITM_ItemUnlockedIcon_C* ItemNotification; // 0x2a0(0x08)
	UITM_Loadout_UpgradeBar_C* ITM_Loadout_UpgradeBar_C_1; // 0x2a8(0x08)
	UITM_MasteryBar_C* ITM_MasteryBar; // 0x2b0(0x08)
	UITM_Overclock_Icon_C* ITM_Overclock_Icon; // 0x2b8(0x08)
	UBorder* Main_BG; // 0x2c0(0x08)
	UButton* MainButton; // 0x2c8(0x08)
	UCanvasPanel* NavigationPanel; // 0x2d0(0x08)
	UOverlay* Overlay_3; // 0x2d8(0x08)
	UBorder* Upgrades_BG; // 0x2e0(0x08)
	FMulticastInlineDelegate On Clicked; // 0x2e8(0x10)
	APlayerCharacter* CharacterClass; // 0x2f8(0x08)
	...
	void GetOwnedItems(APlayerCharacter* InCharacterClass, enum class EItemCategory InCategory, TArray<AActor*> Owned Items, bool NewWeaponNotification);
	void GetSelectedItem(AActor* itemClass, enum class EItemCategory Item Category);
	void SetCharacterClass(APlayerCharacter* InCharacterClass);
