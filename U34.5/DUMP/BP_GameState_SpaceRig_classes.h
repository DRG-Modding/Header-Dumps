...
struct ABP_GameState_SpaceRig_C : ABP_GameState_C {
	...
	FMulticastInlineDelegate OnMisionSelected; // 0x6c0(0x10)
	float MissionCountdown; // 0x6d0(0x04)
	bool MissionCountdownActive; // 0x6d4(0x01)
	FMulticastInlineDelegate OnMissionCountdownChanged; // 0x6d8(0x10)
	bool HostReady; // 0x6e8(0x01)
	bool HostCountdownActive; // 0x6e9(0x01)
	float HostCountdown; // 0x6ec(0x04)
	FMulticastInlineDelegate OnHostCountdownChanged; // 0x6f0(0x10)
	FMulticastInlineDelegate OnCountdownCompleted; // 0x700(0x10)
	FMulticastInlineDelegate OnHostTimerChanged; // 0x710(0x10)
	FMulticastInlineDelegate OnMissionTimerChanged; // 0x720(0x10)
	bool AllReady; // 0x730(0x01)
	TArray<FBlueprintSessionResult> ServerList; // 0x738(0x10)
	FMulticastInlineDelegate OnServerListChanged; // 0x748(0x10)
	bool SearchingInProgress; // 0x758(0x01)
	bool ForceQuickJoinSearch; // 0x759(0x01)
	FMulticastInlineDelegate OnCountdownChanged; // 0x760(0x10)
