// BlueprintGeneratedClass Proxy_CallSupplyPod.Proxy_CallSupplyPod_C
// Size: 0x238 (Inherited: 0x220)
struct AProxy_CallSupplyPod_C : AActor {
	...
	void ExecuteUbergraph_Proxy_CallSupplyPod(int32_t EntryPoint);
};
