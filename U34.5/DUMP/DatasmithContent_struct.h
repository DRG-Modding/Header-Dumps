...
struct FDatasmithCameraLookatTrackingSettingsTemplate {
	...
	TSoftObjectPtr<AActor> ActorToTrack; // 0x08(0x28)
};
...
struct FDatasmithPostProcessSettingsTemplate {
	...
	FLinearColor FilmWhitePoint; // 0x10(0x10)
	FVector4 ColorSaturation; // 0x20(0x10)
...
struct FDatasmithImportBaseOptions {
	...
	FDatasmithAssetImportOptions AssetOptions; // 0x08(0x08)
	FDatasmithStaticMeshImportOptions StaticMeshOptions; // 0x10(0x04)
};
...
struct FDatasmithStaticParameterSetTemplate {
	TMap<FName, bool> StaticSwitchParameters; // 0x00(0x50)
};

// ScriptStruct DatasmithContent.DatasmithMeshSectionInfoMapTemplate
// Size: 0x50 (Inherited: 0x00)
struct FDatasmithMeshSectionInfoMapTemplate {
	TMap<uint32_t, FDatasmithMeshSectionInfoTemplate> Map; // 0x00(0x50)
};
...
struct FDatasmithStaticMaterialTemplate {
	FName MaterialSlotName; // 0x00(0x08)
	UMaterialInterface* MaterialInterface; // 0x08(0x08)
};
