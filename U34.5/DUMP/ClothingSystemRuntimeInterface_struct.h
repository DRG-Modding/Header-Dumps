...
struct FClothCollisionData {
	TArray<FClothCollisionPrim_Sphere> Spheres; // 0x00(0x10)
...
struct FClothCollisionPrim_Box {
	FVector LocalPosition; // 0x00(0x0c)
	FQuat LocalRotation; // 0x10(0x10)
	FVector HalfExtents; // 0x20(0x0c)
...
struct FClothCollisionPrim_Convex {
	TArray<FPlane> Planes; // 0x00(0x10)
...
struct FClothCollisionPrim_Sphere {
	...
	FVector LocalPosition; // 0x08(0x0c)
};
