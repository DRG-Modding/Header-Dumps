...
struct ABP_FloatingLightPlant2_C : AActor {
	...
	USkeletalMeshComponent* SK_FloatingLightPlant_A; // 0x240(0x08)
	...
	USphereComponent* ProximityTrigger; // 0x268(0x08)
	USceneComponent* DefaultSceneRoot; // 0x270(0x08)
	float VariationLoop_Variation_1D8B412C4585AB2E56DAE8A298D8B484; // 0x278(0x04)
	enum class ETimelineDirection VariationLoop__Direction_1D8B412C4585AB2E56DAE8A298D8B484; // 0x27c(0x01)
	UTimelineComponent* VariationLoop; // 0x280(0x08)
	...
	enum class ETimelineDirection FloaterValues__Direction_D91E97D14BA4C776610A308453452A23; // 0x290(0x01)
	UTimelineComponent* FloaterValues; // 0x298(0x08)
	float BaseFloaterHeight; // 0x2a0(0x04)
	float FloaterHeightVariation; // 0x2a4(0x04)
	UMaterialInstanceDynamic* DynamicMaterial; // 0x2a8(0x08)
	...
	FName Param_EmmisiveMult; // 0x2d0(0x08)
	FName Param_DisplacementSpeed; // 0x2d8(0x08)
	FName Param_DisplacementIntensity; // 0x2e0(0x08)
	float BaseMaterialDisplacement; // 0x2e8(0x04)
	FMulticastInlineDelegate OnChangeState; // 0x2f0(0x10)
	...
	void BndEvt__ProximityTrigger_K2Node_ComponentBoundEvent_2_ComponentEndOverlapSignature__DelegateSignature(UPrimitiveComponent* OverlappedComponent, AActor* OtherActor, UPrimitiveComponent* OtherComp, int32_t OtherBodyIndex);
	void BndEvt__ProximityTrigger_K2Node_ComponentBoundEvent_1_ComponentBeginOverlapSignature__DelegateSignature(UPrimitiveComponent* OverlappedComponent, AActor* OtherActor, UPrimitiveComponent* OtherComp, int32_t OtherBodyIndex, bool bFromSweep, FHitResult SweepResult);
	...
	void ExecuteUbergraph_BP_FloatingLightPlant2(int32_t EntryPoint);
