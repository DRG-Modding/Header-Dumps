...
struct UMenu_StatusScreen_C : UWindowWidget {
	...
	UTextBlock* dataReadout_SeedMission; // 0x2a8(0x08)
	UTextBlock* dataReadout_SeedPLS; // 0x2b0(0x08)
	UHUD_TabPlayerList_InteractableV2_C* FriendsTab; // 0x2b8(0x08)
	UImage* Image_BottomSmoke; // 0x2c0(0x08)
	UImage* Image_GradientBottom; // 0x2c8(0x08)
	UImage* Image_Separator; // 0x2d0(0x08)
	UImage* Image_Separator_2; // 0x2d8(0x08)
	UImage* Image_Separator_3; // 0x2e0(0x08)
	UITM_EscMenu_BriefingV2_C* ITM_EscMenu_BriefingV2; // 0x2e8(0x08)
	UITM_PreventDuplicateCharacters_C* ITM_PreventDuplicateCharacters; // 0x2f0(0x08)
	UITM_PrivatePublic_C* ITM_PrivatePublic; // 0x2f8(0x08)
	UITM_WeaponAndPerkInfo_C* ITM_WeaponAndPerkInfo1; // 0x300(0x08)
	UHUD_TabPlayerListEntry_InteractableV2_C* LocalPlayer; // 0x308(0x08)
	UImage* PlayerCharacterImage; // 0x310(0x08)
	UTextBlock* TextBlock; // 0x318(0x08)
	UTextBlock* TextBlock_4; // 0x320(0x08)
	FMulticastInlineDelegate OpenMinersManual; // 0x328(0x10)
