// BlueprintGeneratedClass Proxy_TeleportPlayers.Proxy_TeleportPlayers_C
// Size: 0x238 (Inherited: 0x220)
struct AProxy_TeleportPlayers_C : AActor {
	...
	void ExecuteUbergraph_Proxy_TeleportPlayers(int32_t EntryPoint);
};
