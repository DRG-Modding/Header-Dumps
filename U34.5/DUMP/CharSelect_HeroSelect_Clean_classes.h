...
struct UCharSelect_HeroSelect_Clean_C : UUserWidget {
	...
	void Prev();
	void Next();
	void OnCharacterSelected_Event(APlayerCharacter* Character);
	void Update();
	void BndEvt__BTN_Select_K2Node_ComponentBoundEvent_0_OnClicked__DelegateSignature();
	void OnHovered_Event_1(APlayerCharacter* Character);
	void OnSelect();
	void RetirementHovered(APlayerCharacter* Character);
	void RetirementUnHovered(APlayerCharacter* Character);
	void RetireCharacter(APlayerCharacter* Character);
	void ExecuteUbergraph_CharSelect_HeroSelect_Clean(int32_t EntryPoint);
	void OnRetireCharacter__DelegateSignature(APlayerCharacter* Character);
	...
	void OnCharacterHovered__DelegateSignature(APlayerCharacter* Character);
