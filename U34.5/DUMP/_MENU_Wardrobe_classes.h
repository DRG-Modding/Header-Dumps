...
struct U_MENU_Wardrobe_C : UWindowWidget {
	...
	UButton* ShuffleButton; // 0x2a8(0x08)
	UUI_RandomizeIcon_C* ShuffleIcon; // 0x2b0(0x08)
	UITM_Wardrobe_ItemSlot_Vanity_C* Slot_Armor; // 0x2b8(0x08)
	UITM_Wardrobe_ItemSlot_Vanity_C* Slot_ArmorColor; // 0x2c0(0x08)
	UITM_Wardrobe_ItemSlot_Vanity_C* Slot_Beard; // 0x2c8(0x08)
	UITM_Wardrobe_ItemSlot_Vanity_C* Slot_BeardColor; // 0x2d0(0x08)
	UITM_Wardrobe_ItemSlot_Vanity_C* Slot_EyeBrows; // 0x2d8(0x08)
	UITM_Wardrobe_ItemSlot_Vanity_C* Slot_Head; // 0x2e0(0x08)
	UITM_Wardrobe_ItemSlot_Vanity_C* Slot_Moustache; // 0x2e8(0x08)
	UITM_Wardrobe_ItemSlot_Vanity_C* Slot_SideBurns; // 0x2f0(0x08)
	UITM_Wardrobe_ItemSlot_Vanity_C* Slot_SkinColor; // 0x2f8(0x08)
	UITM_Wardrobe_ItemSlot_VictoryMoves_C* Slot_VictoryMoves; // 0x300(0x08)
	UVerticalBox* SlotsLeftBox; // 0x308(0x08)
	UVerticalBox* SlotsRightBox; // 0x310(0x08)
	UPlayerCharacterID* PlayerCharacter; // 0x318(0x08)
	TArray<UITM_Wardrobe_ItemSlot_Base_C*> ItemSlots; // 0x320(0x10)
