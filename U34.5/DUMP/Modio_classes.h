...
// Size: 0x28 (Inherited: 0x28)
struct UModioExampleLibrary : UBlueprintFunctionLibrary {

	void ListUserSubscriptionAsync(FModioFilterParams FilterParams, FDelegate Callback);
...
// Class Modio.ModioTestValidationData
// Size: 0x90 (Inherited: 0x28)
struct UModioTestValidationData : UObject {
	FModioTestFilterParamData SortDateMarkedLive; // 0x28(0x10)
	FModioTestFilterParamData SortDateUpdated; // 0x38(0x10)
	FModioTestFilterParamData SortDownloadsToday; // 0x48(0x10)
	FModioTestFilterParamData SortID; // 0x58(0x10)
	FModioTestFilterParamData SortRating; // 0x68(0x10)
	FModioTestFilterParamData SortSubCount; // 0x78(0x10)
	FModioModID NameSubstringSearchFirstID; // 0x88(0x08)
};
