...
struct FFractureMaterial {
	FVector2D UVScale; // 0x00(0x08)
	FVector2D UVOffset; // 0x08(0x08)
	FVector Tangent; // 0x10(0x0c)
...
struct FDestructibleParameters {
	FDestructibleDamageParameters DamageParameters; // 0x00(0x1c)
	FDestructibleDebrisParameters DebrisParameters; // 0x1c(0x2c)
	FDestructibleAdvancedParameters AdvancedParameters; // 0x48(0x10)
	FDestructibleSpecialHierarchyDepths SpecialHierarchyDepths; // 0x58(0x14)
	TArray<FDestructibleDepthParameters> DepthParameters; // 0x70(0x10)
	FDestructibleParametersFlag Flags; // 0x80(0x04)
};
