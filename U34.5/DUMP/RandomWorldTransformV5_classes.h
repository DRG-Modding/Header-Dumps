...
struct URandomWorldTransformV5_C : UBlueprintFunctionLibrary {
	...
	void Is Near Avoid Locations(FVector Point, TArray<FVector> Avoid, float Radius, UObject* __WorldContext, bool Is Near);
	void Get Terrain Trace Points(FVector Terrain Centre, float Terrain Radius, UObject* __WorldContext, FVector Start, FVector End);
