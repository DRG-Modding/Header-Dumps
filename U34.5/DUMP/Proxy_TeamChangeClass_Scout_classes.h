// BlueprintGeneratedClass Proxy_TeamChangeClass_Scout.Proxy_TeamChangeClass_Scout_C
// Size: 0x238 (Inherited: 0x220)
struct AProxy_TeamChangeClass_Scout_C : AActor {
	...
	void ExecuteUbergraph_Proxy_TeamChangeClass_Scout(int32_t EntryPoint);
};
