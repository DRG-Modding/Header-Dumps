...
struct FGeomComponentCacheParameters {
	...
	UGeometryCollectionCache* TargetCache; // 0x08(0x08)
...
struct FChaosCollisionEventData {
	...
	FVector Velocity1; // 0x18(0x0c)
	FVector Velocity2; // 0x24(0x0c)
	float Mass1; // 0x30(0x04)
	float Mass2; // 0x34(0x04)
	FVector Impulse; // 0x38(0x0c)
};
...
struct FGeometryCollectionDebugDrawActorSelectedRigidBody {
	...
	AChaosSolverActor* Solver; // 0x08(0x08)
	AGeometryCollectionActor* GeometryCollection; // 0x10(0x08)
};
