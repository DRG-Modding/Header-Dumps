...
struct UABP_Refinery_C : UFSDRefineryAnimInstance {
	...
	FAnimNode_TransitionResult AnimGraphNode_TransitionResult_11; // 0x2a8(0x28)
	FAnimNode_TransitionResult AnimGraphNode_TransitionResult_10; // 0x2d0(0x28)
	FAnimNode_TransitionResult AnimGraphNode_TransitionResult_9; // 0x2f8(0x28)
	FAnimNode_TransitionResult AnimGraphNode_TransitionResult_8; // 0x320(0x28)
	FAnimNode_TransitionResult AnimGraphNode_TransitionResult_7; // 0x348(0x28)
	...
	FAnimNode_SequenceEvaluator AnimGraphNode_SequenceEvaluator_2; // 0x460(0x48)
	FAnimNode_StateResult AnimGraphNode_StateResult_10; // 0x4a8(0x30)
	FAnimNode_SequencePlayer AnimGraphNode_SequencePlayer_8; // 0x4d8(0x78)
	FAnimNode_StateResult AnimGraphNode_StateResult_9; // 0x550(0x30)
	FAnimNode_SequencePlayer AnimGraphNode_SequencePlayer_7; // 0x580(0x78)
	FAnimNode_StateResult AnimGraphNode_StateResult_8; // 0x5f8(0x30)
	FAnimNode_SequencePlayer AnimGraphNode_SequencePlayer_6; // 0x628(0x78)
	FAnimNode_StateResult AnimGraphNode_StateResult_7; // 0x6a0(0x30)
	FAnimNode_SequenceEvaluator AnimGraphNode_SequenceEvaluator; // 0x6d0(0x48)
	FAnimNode_StateResult AnimGraphNode_StateResult_6; // 0x718(0x30)
	...
	void ExecuteUbergraph_ABP_Refinery(int32_t EntryPoint);
};
