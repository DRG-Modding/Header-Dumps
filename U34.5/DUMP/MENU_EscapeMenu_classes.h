...
struct UMENU_EscapeMenu_C : UWindowWidget {
	...
	UMENU_Credits_C* MENU_Credits; // 0x348(0x08)
	UMenu_StatusScreen_C* Menu_StatusScreen; // 0x350(0x08)
	UUI_AdvancedLabel_C* OptionIconNext; // 0x358(0x08)
	UUI_AdvancedLabel_C* OptionIconPrev; // 0x360(0x08)
	UOverlay* Overlay_Status; // 0x368(0x08)
	UOverlay* Overlay_SubMenuHolder; // 0x370(0x08)
	...
	void OnFailure_2723501B4F5B15367D2461B5F901451A();
	void OnSuccess_2723501B4F5B15367D2461B5F901451A(FBlueprintSessionResult Result);
