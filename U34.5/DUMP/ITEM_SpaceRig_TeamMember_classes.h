...
struct UITEM_SpaceRig_TeamMember_C : UUserWidget {
	...
	UImage* Image_1; // 0x280(0x08)
	UTextBlock* IncomingPlayerNameTxt; // 0x288(0x08)
	UITM_RetirementBadge_C* ITM_RetirementBadge; // 0x290(0x08)
	UOverlay* Overlay_1; // 0x298(0x08)
	UImage* PlayerIconBG; // 0x2a0(0x08)
	UImage* PlayerIconBorder; // 0x2a8(0x08)
	UCircularThrobber* PlayerOnHisWayIndicator; // 0x2b0(0x08)
	UTextBlock* PlayerRank; // 0x2b8(0x08)
	UWidgetSwitcher* StateSwitcher; // 0x2c0(0x08)
	UTextBlock* TXT_CharacterName; // 0x2c8(0x08)
	UTextBlock* TXT_PlayerName; // 0x2d0(0x08)
	UUI_NameTags_C* UI_NameTags; // 0x2d8(0x08)
	UUI_NameTags_C* UI_NameTags_C_1; // 0x2e0(0x08)
	APlayerCharacter* PlayerCharacter; // 0x2e8(0x08)
	AFSDPlayerState* PlayerState; // 0x2f0(0x08)
	AFSDPlayerState* NewVar_1; // 0x2f8(0x08)
