...
struct ABP_Phys_Barrel01_C : AFSDPhysicsActor {
	...
	UCapsuleComponent* BarrelRiderCollission; // 0x238(0x08)
	UGravityChangedComponent* GravityChanged; // 0x240(0x08)
	UInstantUsable* InstantUsable; // 0x248(0x08)
	UCapsuleComponent* UseCapsule; // 0x250(0x08)
	UStaticMeshComponent* StaticMeshComponent0; // 0x258(0x08)
	bool CanTriggerSound; // 0x260(0x01)
	FVector KickSoundLocation; // 0x264(0x0c)
	APlayerCharacter* KickedBy; // 0x270(0x08)
	bool KickedIntoHoop; // 0x278(0x01)
	UFSDAchievement* BarrelRiderAchievement; // 0x280(0x08)
	float RideBeginTime; // 0x288(0x04)
	APlayerCharacter* CurrentRider; // 0x290(0x08)
