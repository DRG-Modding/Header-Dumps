...
struct UWeaponDisplay_Autocannon_AmmoCount_C : UWeaponDisplay_Base_AmmoCount_C {
	...
	UAnimatedStaticOverlay_C* AnimatedStaticOverlay; // 0x270(0x08)
	UBorder* Border_4; // 0x278(0x08)
	UTextBlock* DATA_AmmoCurrent; // 0x280(0x08)
	UTextBlock* DATA_AmmoTotal; // 0x288(0x08)
	UTextBlock* TEXT_Reloading; // 0x290(0x08)
