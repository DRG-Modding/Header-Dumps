// BlueprintGeneratedClass Proxy_SFX_XMasHoHoHo.Proxy_SFX_XMasHoHoHo_C
// Size: 0x238 (Inherited: 0x220)
struct AProxy_SFX_XMasHoHoHo_C : AActor {
	...
	void ExecuteUbergraph_Proxy_SFX_XMasHoHoHo(int32_t EntryPoint);
};
