...
struct UWeaponDisplay_SMG_AmmoCount_C : UWeaponDisplay_Base_AmmoCount_C {
	...
	UAnimatedStaticOverlay_C* AnimatedStaticOverlay; // 0x260(0x08)
	UTextBlock* DATA_AmmoCurrent; // 0x268(0x08)
	UTextBlock* DATA_AmmoTotal; // 0x270(0x08)
	UTextBlock* TXT_Loading; // 0x278(0x08)
