...
struct UAnnouncement_Vanity_C : UUserWidget {
	...
	UUI_GenericLabel_C* NameLabel; // 0x278(0x08)
	UCanvasPanel* Root; // 0x280(0x08)
	float StartDelay; // 0x288(0x04)
	UVanityItem* VanityItem; // 0x290(0x08)
	UPlayerCharacterID* VanityOwner; // 0x298(0x08)

	void PreConstruct(bool IsDesignTime);
	void Construct();
	void OnAnnounceAnimFinished();
	void ExecuteUbergraph_Announcement_Vanity(int32_t EntryPoint);
};
