...
struct U_SCREEN_MissionSelectionMK3_C : UWindowWidget {
	...
	UImage* ControllerButton; // 0x2a0(0x08)
	UImage* ImageAsteroids01; // 0x2a8(0x08)
	UImage* ImageAsteroids02; // 0x2b0(0x08)
	UImage* ImageClouds01; // 0x2b8(0x08)
	UImage* ImageClouds02; // 0x2c0(0x08)
	UITM_MisSel_Biome_C* ITEM_Biome_AzureWeald; // 0x2c8(0x08)
	UITM_MisSel_Biome_C* ITEM_Biome_Crystal; // 0x2d0(0x08)
	UITM_MisSel_Biome_C* ITEM_Biome_Dense; // 0x2d8(0x08)
	UITM_MisSel_Biome_C* ITEM_Biome_Fungus; // 0x2e0(0x08)
	UITM_MisSel_Biome_C* ITEM_Biome_Glacial; // 0x2e8(0x08)
	UITM_MisSel_Biome_C* ITEM_Biome_HollowBough; // 0x2f0(0x08)
	UITM_MisSel_Biome_C* ITEM_Biome_Magma; // 0x2f8(0x08)
	UITM_MisSel_Biome_C* ITEM_Biome_Radioactive; // 0x300(0x08)
	UITM_MisSel_Biome_C* ITEM_Biome_Salt; // 0x308(0x08)
	UITM_MisSel_Biome_C* ITEM_Biome_Sandblasted; // 0x310(0x08)
	UITM_MisSel_BG_Planet_C* ITEM_MissionSelection_BG; // 0x318(0x08)
	UITM_MisSel_FullBiome_C* ITEM_MissionSelection_FullBiome; // 0x320(0x08)
	UITM_MisSel_Timer_C* ITEM_MissionSelection_Timer; // 0x328(0x08)
	UITM_CampaignProgress_C* ITM_CampaignProgressMain; // 0x330(0x08)
	...
	UITM_MisSel_ZoneImage_C* Region_AzureWeald; // 0x358(0x08)
	UITM_MisSel_ZoneImage_C* Region_CrystallineCaverns; // 0x360(0x08)
	UITM_MisSel_ZoneImage_C* Region_DenseBiozone; // 0x368(0x08)
	UITM_MisSel_ZoneImage_C* Region_FungusBogs; // 0x370(0x08)
	UITM_MisSel_ZoneImage_C* Region_GlacialStrata; // 0x378(0x08)
	UITM_MisSel_ZoneImage_C* Region_HollowBough; // 0x380(0x08)
	UITM_MisSel_ZoneImage_C* Region_MagmaCore; // 0x388(0x08)
	UITM_MisSel_ZoneImage_C* Region_Radioactive; // 0x390(0x08)
	UITM_MisSel_ZoneImage_C* Region_SaltPits; // 0x398(0x08)
	UITM_MisSel_ZoneImage_C* Region_Sandblasted; // 0x3a0(0x08)
	UHorizontalBox* SelectionBox_Active; // 0x3a8(0x08)
	UWND_MisSel_BiomeDescription_C* WINDOW_MissionSelection_BiomeDescription; // 0x3b0(0x08)
	UWND_MisSel_MissionDescription_C* WINDOW_MissionSelection_MissionDescription; // 0x3b8(0x08)
	UWND_MisSel_MissionOptions_C* WINDOW_MissionSelection_MissionOptions; // 0x3c0(0x08)
	UImage* Zone_Outlines; // 0x3c8(0x08)
	UImage* ZoneBorders; // 0x3d0(0x08)
	TArray<UITM_MisSel_Biome_C*> Biomes; // 0x3d8(0x10)
	UITM_MisSel_MissionMapIcon_C* SelectedMissionIcon; // 0x3e8(0x08)
	UITM_MisSel_Biome_C* SelectedBiome; // 0x3f0(0x08)
	TArray<UITM_MisSel_ZoneLock_C*> ZoneLocks; // 0x3f8(0x10)
	TArray<UBiome*> NewBiomes; // 0x408(0x10)
	FVector2D CurrPos; // 0x418(0x08)
	FVector2D TargetPos; // 0x420(0x08)
