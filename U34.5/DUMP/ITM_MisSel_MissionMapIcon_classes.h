...
struct UITM_MisSel_MissionMapIcon_C : UUserWidget {
	...
	UOverlay* Content; // 0x278(0x08)
	UImage* ICON_TargetDot; // 0x280(0x08)
	UITM_MisSel_MissionIconBasic_C* ITEM_MissionSelection_MissionIconBasic; // 0x288(0x08)
	UITM_Campaign_Icon_C* ITM_Campaign_Icon; // 0x290(0x08)
	UITM_MisSel_DotMarker_CaveDifficulty_C* ITM_MisSel_DotMarker_CaveDifficulty; // 0x298(0x08)
	UITM_MutatorIcon_C* ITM_MutatorIcon; // 0x2a0(0x08)
	UITM_MutatorIcon_C* ITM_MutatorIcon_2; // 0x2a8(0x08)
	UVerticalBox* VerticalBox_Anomalies; // 0x2b0(0x08)
	UVerticalBox* VerticalBox_Warnings; // 0x2b8(0x08)
	UITM_MissionMapIcon_LevelLock_C* WDG_LevelLock; // 0x2c0(0x08)
	UITM_MissionMapIcon_Objective_C* WDG_Resource; // 0x2c8(0x08)
	UITM_MissionMap_Icon_BG_C* WindowBG; // 0x2d0(0x08)
	UGeneratedMission* mission; // 0x2d8(0x08)
	UITM_MisSel_FullBiome_C* BiomeController; // 0x2e0(0x08)
	FLinearColor Tint_MissionIconColor; // 0x2e8(0x10)
