// BlueprintGeneratedClass Proxy_CallBombDispenser.Proxy_CallBombDispenser_C
// Size: 0x238 (Inherited: 0x220)
struct AProxy_CallBombDispenser_C : AActor {
	...
	void ExecuteUbergraph_Proxy_CallBombDispenser(int32_t EntryPoint);
};
