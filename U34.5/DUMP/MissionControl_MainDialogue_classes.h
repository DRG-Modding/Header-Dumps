...
struct UMissionControl_MainDialogue_C : UFSDUserWidget {
	...
	UTextBlock* HiddenLayoutText; // 0x280(0x08)
	UImage* Image_109; // 0x288(0x08)
	UImage* Image_110; // 0x290(0x08)
	UTextBlock* MessageLabel; // 0x298(0x08)
	UDialogDataAsset* PreviewShout; // 0x2a0(0x08)
	bool ManuallyControlled; // 0x2a8(0x01)
	FText Text; // 0x2b0(0x18)
	float Duration; // 0x2c8(0x04)
	float StartTime; // 0x2cc(0x04)
	FTimerHandle TickHandle; // 0x2d0(0x08)
	UAudioComponent* ManualSpeakComponent; // 0x2d8(0x08)
	FTimerHandle HideHandle; // 0x2e0(0x08)
