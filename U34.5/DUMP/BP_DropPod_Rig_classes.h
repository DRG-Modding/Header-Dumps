...
struct ABP_DropPod_Rig_C : ABP_DropPod_Base_C {
	...
	UCapsuleComponent* ATeamAchievementCollider4; // 0x848(0x08)
	UCapsuleComponent* ATeamAchievementCollider3; // 0x850(0x08)
	UCapsuleComponent* ATeamAchievementCollider2; // 0x858(0x08)
	UCapsuleComponent* ATeamAchievementCollider1; // 0x860(0x08)
	UBoxComponent* Box1; // 0x868(0x08)
	UAudioComponent* AudioLower; // 0x870(0x08)
	UAudioComponent* Audio_1; // 0x878(0x08)
	UAudioComponent* DroppodLaunch; // 0x880(0x08)
	UBoxComponent* DwarfChecker_1; // 0x888(0x08)
	FMulticastInlineDelegate OnLeaveSpacerig; // 0x890(0x10)
	TArray<APlayerCharacter*> PlayersInside; // 0x8a0(0x10)
	UAudioComponent* PlayLeftAudioOnOpenDoor; // 0x8b0(0x08)
	UAudioComponent* PlayRightAudioOnOpenDoor; // 0x8b8(0x08)
	UAudioComponent* SpaceRigDrillIdle; // 0x8c0(0x08)
	int32_t OldCountdownValue; // 0x8c8(0x04)
	int32_t Amount of barrels in seats; // 0x8cc(0x04)
	UFSDAchievement* ATeamAchievement; // 0x8d0(0x08)
