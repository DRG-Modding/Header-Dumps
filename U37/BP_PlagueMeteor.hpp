...
class ABP_PlagueMeteor_C : public APlagueMeteor
{
    ...
    class USceneComponent* Crevace2;
    class UStaticMeshComponent* Crevasse2_NotUsed;
    class UStaticMeshComponent* Crevasse1_NotUsed;
    class USceneComponent* Crevace1;
    class UStaticMeshComponent* Crevasse_NotUsed;
