...
class UUI_ClassInfo_CharacterSelector_C : public UUserWidget
{
    ...
    void ButtonHoverBegin(class UUI_ClassInfo_CharacterIcon_C* Button, bool CallFunc_Not_PreBool_ReturnValue);
    void SelectClass(TSubclassOf<class APlayerCharacter> Class);
    void ButtonClicked(class UUI_ClassInfo_CharacterIcon_C* Button, bool CallFunc_Not_PreBool_ReturnValue, bool CallFunc_IsValid_ReturnValue);
    void AddClass(TSubclassOf<class APlayerCharacter> Class, class APlayerController* CallFunc_GetOwningPlayer_ReturnValue, class UUI_ClassInfo_CharacterIcon_C* CallFunc_Create_ReturnValue, class UHorizontalBoxSlot* CallFunc_AddChildToHorizontalBox_ReturnValue);
    void Construct();
