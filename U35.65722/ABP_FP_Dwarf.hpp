...
class UABP_FP_Dwarf_C : public UPlayerFPAnimInstance
{
    ...
    void ExecuteUbergraph_ABP_FP_Dwarf(int32 EntryPoint, class UItemCharacterAnimationSet* CallFunc_GetAnimationSet_ReturnValue, float CallFunc_Montage_Play_ReturnValue);
};
