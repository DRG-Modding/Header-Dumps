...
class UMenu_ServerStatus_C : public UUserWidget
{
    ...
    void ExecuteUbergraph_Menu_ServerStatus(int32 EntryPoint, class AFSDPlayerState* K2Node_CustomEvent_PlayerState, class UGeneratedMission* K2Node_CustomEvent_Mission);
};
