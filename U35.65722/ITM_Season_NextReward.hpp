...
class UITM_Season_NextReward_C : public UUserWidget
{
    ...
    void ExecuteUbergraph_ITM_Season_NextReward(int32 EntryPoint, FSeasonLevel K2Node_CustomEvent_Season_Level, bool K2Node_Event_IsDesignTime, FText CallFunc_GetRewardText_Title, FText CallFunc_GetRewardText_Category, FText CallFunc_GetRewardText_Description, bool CallFunc_GetRewardText_HasOptionalCharacterID, class UPlayerCharacterID* CallFunc_GetRewardText_CharacterID, FLinearColor CallFunc_MenuColorsAndOpacity_OutputColor);
};
