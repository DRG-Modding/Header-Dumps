...
class UWidget_DropPod_GarbageGen_C : public UUserWidget
{
    ...
    void ExecuteUbergraph_Widget_DropPod_GarbageGen(int32 EntryPoint, FText CallFunc_MakeLiteralText_ReturnValue, FString CallFunc_Conv_TextToString_ReturnValue, bool K2Node_Event_IsDesignTime, FGeometry K2Node_Event_MyGeometry, float K2Node_Event_InDeltaTime, float CallFunc_Add_FloatFloat_ReturnValue, class UFSDGameInstance* CallFunc_GetFSDGameInstance_ReturnValue, class UGeneratedMission* K2Node_CustomEvent_OutGeneratedMission, bool CallFunc_IsValid_ReturnValue, bool CallFunc_IsDeepDive_ReturnValue, FSlateColor K2Node_MakeStruct_SlateColor, FSlateColor K2Node_MakeStruct_SlateColor_1, class UFSDGameInstance* CallFunc_GetFSDGameInstance_ReturnValue_1, FExecuteUbergraph_Widget_DropPod_GarbageGenK2Node_CreateDelegate_OutputDelegate K2Node_CreateDelegate_OutputDelegate, FText CallFunc_MakeLiteralText_ReturnValue_1, FText CallFunc_MakeLiteralText_ReturnValue_2, FString CallFunc_Conv_TextToString_ReturnValue_1, FString CallFunc_Conv_TextToString_ReturnValue_2, FText CallFunc_MakeLiteralText_ReturnValue_3, FString CallFunc_Conv_TextToString_ReturnValue_3, TArray<FString>& K2Node_MakeArray_Array);
};
