...
class UOptions_MouseKeyboard_KeyBinding_C : public UUserWidget
{
    ...
    void Construct();
    void ExecuteUbergraph_Options_MouseKeyboard_KeyBinding(int32 EntryPoint, bool K2Node_Event_IsDesignTime, class UUMGSequencePlayer* CallFunc_PlayAnimation_ReturnValue);
};
