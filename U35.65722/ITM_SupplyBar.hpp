...
class UITM_SupplyBar_C : public UUserWidget
{
    ...
    void SetProgress(float Progress (0-1), class UITM_SupplyBarItem_C* BarItem, float ChunkSize, int32 ChunkNo, float Percent, float CallFunc_FClamp_ReturnValue, float CallFunc_Multiply_IntFloat_ReturnValue, float CallFunc_Subtract_FloatFloat_ReturnValue, int32 CallFunc_Add_IntInt_ReturnValue, float CallFunc_Divide_FloatFloat_ReturnValue, int32 Temp_int_Variable, class UWidget* CallFunc_GetChildAt_ReturnValue, int32 CallFunc_Add_IntInt_ReturnValue_1, class UITM_SupplyBarItem_C* K2Node_DynamicCast_AsITM_Supply_Bar_Item, bool K2Node_DynamicCast_bSuccess, int32 Temp_int_Variable_1, int32 CallFunc_GetChildrenCount_ReturnValue, float CallFunc_Conv_IntToFloat_ReturnValue, int32 CallFunc_Subtract_IntInt_ReturnValue, float CallFunc_Divide_FloatFloat_ReturnValue_1, bool CallFunc_LessEqual_IntInt_ReturnValue);
