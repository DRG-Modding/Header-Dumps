...
class UCheat_ConvertSave_C : public UUserWidget
{
    ...
    void ExecuteUbergraph_Cheat_ConvertSave(int32 EntryPoint, class UFSDSaveGame* CallFunc_GetFSDSaveGame_ReturnValue, class UFSDSaveGame* CallFunc_GetFSDSaveGame_ReturnValue_1, class UFSDSaveGame* CallFunc_GetFSDSaveGame_ReturnValue_2);
};
