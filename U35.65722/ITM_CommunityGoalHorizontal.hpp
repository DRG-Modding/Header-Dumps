...
class UITM_CommunityGoalHorizontal_C : public UFSDUserWidget
{
    FPointerToUberGraphFrame UberGraphFrame;
    class UWidgetAnimation* ShowGoalInfoBox_Large;
    ...
    class UBorder* Selected_Border;
    class UImage* Selected_Fading_Background;
    ...
    void ShowAnimation(class UWidgetAnimation*& Animation, bool Temp_bool_Variable, class UWidgetAnimation* K2Node_Select_Default);
