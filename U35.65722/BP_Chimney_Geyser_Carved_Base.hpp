...
class ABP_Chimney_Geyser_Carved_Base_C : public AActor
{
    ...
    void ExecuteUbergraph_BP_Chimney_Geyser_Carved_Base(int32 EntryPoint, bool CallFunc_HasAuthority_ReturnValue, FVector CallFunc_K2_GetActorLocation_ReturnValue, class UAudioComponent* CallFunc_SpawnSoundAtLocation_ReturnValue);
};
