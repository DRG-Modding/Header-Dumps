...
class UOptions_RestoreSave_C : public UUserWidget
{
    ...
    void ExecuteUbergraph_Options_RestoreSave(int32 EntryPoint, class UWindowManager* CallFunc_GetWindowManager_ReturnValue, class UMenu_RestoreSaves_C* CallFunc_OpenWindowFromClass_ReturnValue);
};
