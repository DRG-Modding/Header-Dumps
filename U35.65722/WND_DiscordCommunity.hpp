...
class UWND_DiscordCommunity_C : public UWindowWidget
{
    ...
    void ExecuteUbergraph_WND_DiscordCommunity(int32 EntryPoint, class UPresenceSubSystem* CallFunc_GetGameInstanceSubsystem_ReturnValue, class UWindowManager* CallFunc_GetWindowManager_ReturnValue, class UFSDSaveGame* CallFunc_GetFSDSaveGame_ReturnValue);
};
