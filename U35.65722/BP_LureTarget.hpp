...
class ABP_LureTarget_C : public APawn
{
    ...
    void UserConstructionScript(FLinearColor CallFunc_K2_GetVectorParameterValue_ReturnValue, class UMaterialInstanceDynamic* CallFunc_CreateDynamicMaterialInstance_ReturnValue, int32 CallFunc_Array_LastIndex_ReturnValue, int32 CallFunc_RandomIntegerInRange_ReturnValue, class UMaterialInstanceDynamic* CallFunc_CreateDynamicMaterialInstance_ReturnValue_1, class UAnimSequence* CallFunc_Array_Get_Item);
    ...
    void ExecuteUbergraph_BP_LureTarget(int32 EntryPoint, bool CallFunc_LessEqual_FloatFloat_ReturnValue, float CallFunc_Multiply_FloatFloat_ReturnValue, bool CallFunc_IsValid_ReturnValue, FVector CallFunc_K2_GetActorLocation_ReturnValue, float K2Node_ComponentBoundEvent_health_1, class UParticleSystemComponent* CallFunc_SpawnEmitterAttached_ReturnValue, FVector CallFunc_Conv_LinearColorToVector_ReturnValue, FVector CallFunc_Conv_LinearColorToVector_ReturnValue_1, int32 CallFunc_Array_LastIndex_ReturnValue, int32 CallFunc_RandomIntegerInRange_ReturnValue, class UAnimSequence* CallFunc_Array_Get_Item, float CallFunc_RandomFloatInRange_ReturnValue, int32 CallFunc_RandomIntegerInRange_ReturnValue_1, bool CallFunc_EqualEqual_IntInt_ReturnValue, float CallFunc_RandomFloatInRange_ReturnValue_1, float CallFunc_RandomFloatInRange_ReturnValue_2, int32 CallFunc_RandomIntegerInRange_ReturnValue_2, bool CallFunc_EqualEqual_IntInt_ReturnValue_1, class UHealthComponentBase* K2Node_ComponentBoundEvent_HealthComponent_1, int32 CallFunc_RandomIntegerInRange_ReturnValue_3, bool CallFunc_EqualEqual_IntInt_ReturnValue_2, FVector CallFunc_K2_GetActorLocation_ReturnValue_1, class UHealthComponentBase* K2Node_ComponentBoundEvent_HealthComponent, float K2Node_ComponentBoundEvent_health, float CallFunc_Divide_FloatFloat_ReturnValue, bool CallFunc_Not_PreBool_ReturnValue, float CallFunc_MapRangeClamped_ReturnValue, bool CallFunc_BooleanAND_ReturnValue, float CallFunc_FClamp_ReturnValue, FVector CallFunc_VLerp_ReturnValue, FLinearColor CallFunc_Conv_VectorToLinearColor_ReturnValue, class UParticleSystem* K2Node_Event_particles, FVector K2Node_Event_location, FRotator K2Node_Event_orientation, bool CallFunc_HasAuthority_ReturnValue);
};
