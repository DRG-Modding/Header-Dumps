...
enum class ESonyInputSettingsBools {
    ...
    AdaptiveTriggersEnabled = 3,
    TouchPadTerrainScannerEnabled = 4,
    TouchPadGesturesEnabled = 5,
    ControllerSpeakerMissionControl = 6,
    ControllerSpeakerSalute = 7,
    ControllerSpeakerFlare = 8,
    ControllerSpeakerMineralCollection = 9,
    ESonyInputSettingsBools_MAX = 10,
};
