#ifndef UE4SS_SDK_UI_UpdateAvailable_HPP
#define UE4SS_SDK_UI_UpdateAvailable_HPP

class UUI_UpdateAvailable_C : public UWindowWidget
{
    ...
    void Close();
    void ExecuteUbergraph_UI_UpdateAvailable(int32 EntryPoint, class APlayerController* CallFunc_GetPlayerController_ReturnValue, bool K2Node_Event_IsDesignTime);
};
