...
class UHUD_Main_C : public UFSDMainHUDWidget
{
    ...
    class UHUD_AmmoCount_C* BS_AmmoCount_66;
    ...
    class UBasic_HUD_BracketWindowBig_Single_C* Holder_AmmoCounter;
    ...
    void ToggleHUD(bool IsVisible, bool Instant, ESlateVisibility Temp_byte_Variable, ESlateVisibility Temp_byte_Variable_1, bool Temp_bool_Variable, class UUMGSequencePlayer* CallFunc_PlayAnimation_ReturnValue, ESlateVisibility K2Node_Select_Default, bool CallFunc_NotEqual_BoolBool_ReturnValue, class UUMGSequencePlayer* CallFunc_PlayAnimation_ReturnValue_1);
    void Destruct();
    void AllDwarvesDown();
    ...
    void ExecuteUbergraph_HUD_Main(int32 EntryPoint, bool Temp_bool_Variable, FMargin K2Node_MakeStruct_Margin, class APlayerController* CallFunc_GetOwningPlayer_ReturnValue, class APawn* CallFunc_K2_GetPawn_ReturnValue, class APlayerCharacter* K2Node_DynamicCast_AsPlayer_Character, bool K2Node_DynamicCast_bSuccess, bool CallFunc_Not_PreBool_ReturnValue, class UFSDGameUserSettings* CallFunc_FSDGameUserSettings_ReturnValue, class UFSDGameUserSettings* CallFunc_FSDGameUserSettings_ReturnValue_1, class AFSDGameState* CallFunc_GetFSDGameState_ReturnValue, ECharacterCameraMode K2Node_CustomEvent_NewCameraMode, ECharacterCameraMode K2Node_CustomEvent_OldCameraMode, FExecuteUbergraph_HUD_MainK2Node_CreateDelegate_OutputDelegate K2Node_CreateDelegate_OutputDelegate, bool CallFunc_IsDown_ReturnValue, ECharacterState K2Node_CustomEvent_newState, class UWidget* K2Node_CustomEvent_EventWidget, bool K2Node_CustomEvent_Left, bool Temp_bool_Variable_1, class UWidget* K2Node_Select_Default, FGeometry K2Node_Event_MyGeometry, float K2Node_Event_InDeltaTime, class UVerticalBox* K2Node_Select_Default_1, FExecuteUbergraph_HUD_MainK2Node_CreateDelegate_OutputDelegate_1 K2Node_CreateDelegate_OutputDelegate_1, class UVerticalBoxSlot* CallFunc_AddChildToVerticalBox_ReturnValue, class UVerticalBoxSlot* CallFunc_AddChildToVerticalBox_ReturnValue_1, class UVerticalBoxSlot* CallFunc_AddChildToVerticalBox_ReturnValue_2, bool CallFunc_HasChild_ReturnValue, bool CallFunc_HasChild_ReturnValue_1, bool CallFunc_Not_PreBool_ReturnValue_1, class UHUDVisibilityGroup* K2Node_ComponentBoundEvent_Group_2, bool K2Node_ComponentBoundEvent_IsVisible_2, bool CallFunc_IsVisible_ReturnValue, class UHUDVisibilityGroup* K2Node_ComponentBoundEvent_Group_1, bool K2Node_ComponentBoundEvent_IsVisible_1, bool CallFunc_Not_PreBool_ReturnValue_2, class UHUDVisibilityGroup* K2Node_ComponentBoundEvent_Group, bool K2Node_ComponentBoundEvent_IsVisible, bool CallFunc_BooleanOR_ReturnValue, bool CallFunc_SelectVisibility_IsVisible, bool CallFunc_SelectVisibility_VisibilityChanged, ESlateVisibility CallFunc_SelectVisibility_New_Visibility, bool CallFunc_IsHudGroupVisible_ReturnValue, bool CallFunc_IsHudGroupVisible_ReturnValue_1, bool CallFunc_IsHudGroupVisible_ReturnValue_2, bool CallFunc_BooleanOR_ReturnValue_1, FExecuteUbergraph_HUD_MainK2Node_CreateDelegate_OutputDelegate_2 K2Node_CreateDelegate_OutputDelegate_2, bool CallFunc_BooleanOR_ReturnValue_2, bool CallFunc_SelectVisibility_IsVisible_1, bool CallFunc_SelectVisibility_VisibilityChanged_1, ESlateVisibility CallFunc_SelectVisibility_New_Visibility_1);
};
