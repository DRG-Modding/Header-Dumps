...
class UPopup_Saveslots_C : public UWindowWidget
{
    ...
    void Close();
    void ExecuteUbergraph_Popup_Saveslots(int32 EntryPoint, class UWindowManager* CallFunc_GetWindowManager_ReturnValue);
};
