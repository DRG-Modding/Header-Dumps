...
class UUI_SaveGame_CharacterClass_C : public UUserWidget
{
    ...
    void ExecuteUbergraph_UI_SaveGame_CharacterClass(int32 EntryPoint, bool K2Node_Event_IsDesignTime, FLinearColor CallFunc_MenuColors_OutputColor, class UTexture2D* CallFunc_GetHeroImage_ReturnValue);
};
