...
class UCheat_CharacterPointLight_C : public UUserWidget
{
    ...
    void Update(class UPointLightComponent* Light, float CallFunc_GetValue_ReturnValue, float CallFunc_Lerp_ReturnValue, float CallFunc_GetValue_ReturnValue_1, float CallFunc_Lerp_ReturnValue_1, class APawn* CallFunc_GetOwningPlayerPawn_ReturnValue, class ABP_PlayerCharacter_C* K2Node_DynamicCast_AsBP_Player_Character, bool K2Node_DynamicCast_bSuccess, float CallFunc_GetValue_ReturnValue_2, bool CallFunc_Greater_FloatFloat_ReturnValue, float CallFunc_GetValue_ReturnValue_3, bool CallFunc_Greater_FloatFloat_ReturnValue_1, bool CallFunc_BooleanAND_ReturnValue, bool CallFunc_Not_PreBool_ReturnValue);
