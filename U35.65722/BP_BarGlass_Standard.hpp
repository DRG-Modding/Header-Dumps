...
class ABP_BarGlass_Standard_C : public ABP_BarGlass_C
{
    ...
    void ExecuteUbergraph_BP_BarGlass_Standard(int32 EntryPoint, class UActorComponent* K2Node_ComponentBoundEvent_Component, bool K2Node_ComponentBoundEvent_bReset);
};
