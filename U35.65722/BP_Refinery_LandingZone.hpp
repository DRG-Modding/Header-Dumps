...
class ABP_Refinery_LandingZone_C : public AActor
{
    ...
    void ExecuteUbergraph_BP_Refinery_LandingZone(int32 EntryPoint, TArray<class UMaterialInstanceDynamic*>& CallFunc_CreateDynamicMaterialInstances_ReturnValue);
};
