...
class UABP_MiniMule_C : public USimpleMovingEnemyAnimInstance
{
    ...
    void ExecuteUbergraph_ABP_MiniMule(int32 EntryPoint, bool CallFunc_IsValid_ReturnValue, float CallFunc_Subtract_FloatFloat_ReturnValue, float CallFunc_Multiply_FloatFloat_ReturnValue, FRotator CallFunc_MakeRotator_ReturnValue, class AActor* CallFunc_GetOwningActor_ReturnValue, class ABP_MiniMule_Salvage_C* K2Node_DynamicCast_AsBP_Mini_Mule_Salvage, bool K2Node_DynamicCast_bSuccess, float K2Node_Event_DeltaTimeX);
};
