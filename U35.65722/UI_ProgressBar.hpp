...
class UUI_ProgressBar_C : public UUserWidget
{
    ...
    void SetPercent(float InPercent, float InEaseDuration, float Diff, bool Temp_bool_Variable, bool CallFunc_IsAnimationPlaying_ReturnValue, float CallFunc_Divide_FloatFloat_ReturnValue, float CallFunc_Subtract_FloatFloat_ReturnValue, float CallFunc_Abs_ReturnValue, float K2Node_Select_Default, class UUMGSequencePlayer* CallFunc_PlayAnimationForward_ReturnValue, bool CallFunc_Greater_FloatFloat_ReturnValue, bool CallFunc_Greater_FloatFloat_ReturnValue_1, bool CallFunc_BooleanAND_ReturnValue);
