...
class UABP_Caretaker_C : public UCaretagerBodyAnimInstance
{
    ...
    void ExecuteUbergraph_ABP_Caretaker(int32 EntryPoint, bool CallFunc_Not_PreBool_ReturnValue, bool CallFunc_HasMarkerBeenHitThisFrame_ReturnValue, bool CallFunc_BooleanAND_ReturnValue);
};
