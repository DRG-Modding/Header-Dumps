...
class AENE_FacilityTurret_Sniper_C : public AENE_FacilityTurret_Base_C
{
    ...
    void ExecuteUbergraph_ENE_FacilityTurret_Sniper(int32 EntryPoint, FVector CallFunc_K2_GetActorLocation_ReturnValue, bool K2Node_Event_engaged, bool K2Node_Event_lockedOn, class UNiagaraComponent* CallFunc_SpawnSystemAttached_ReturnValue);
};
