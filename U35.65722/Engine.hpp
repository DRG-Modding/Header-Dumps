...
class APlayerCameraManager : public AActor
{
    ...
    class UCameraShake* PlayCameraShakeFromSource(TSubclassOf<class UCameraShake> ShakeClass, class UCameraShakeSourceComponent* SourceComponent);
...
class UCameraShakeSourceComponent : public USceneComponent
{
    ...
    void StopAllCameraShakes(bool bImmediately);
    void PlayCameraShake(TSubclassOf<class UCameraShake> InCameraShake);
    void Play();
