...
class UScrollingText_HackingTool_C : public UUserWidget
{
    ...
    void Construct();
    void ExecuteUbergraph_ScrollingText_HackingTool(int32 EntryPoint, float CallFunc_RandomFloatInRange_ReturnValue, class UUMGSequencePlayer* CallFunc_PlayAnimation_ReturnValue);
};
