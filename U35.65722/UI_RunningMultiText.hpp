...
class UUI_RunningMultiText_C : public UBasic_Label_C
{
    ...
    void PlayCue(class USoundCue* InSound, bool CallFunc_IsValid_ReturnValue);
    void InitRun();
