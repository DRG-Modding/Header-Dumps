...
class UABP_SpikeyPlant_A_C : public UAnimInstance
{
    ...
    void ExecuteUbergraph_ABP_SpikeyPlant_A(int32 EntryPoint, bool K2Node_CustomEvent_Is_Extruded, bool K2Node_CustomEvent_Is_Triggered, FExecuteUbergraph_ABP_SpikeyPlant_AK2Node_CreateDelegate_OutputDelegate K2Node_CreateDelegate_OutputDelegate, class AActor* CallFunc_GetOwningActor_ReturnValue, class ABP_SpikeyPlant_C* K2Node_DynamicCast_AsBP_Spikey_Plant, bool K2Node_DynamicCast_bSuccess);
};
