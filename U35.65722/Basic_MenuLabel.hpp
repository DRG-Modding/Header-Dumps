...
class UBasic_MenuLabel_C : public UUserWidget
{
    ...
    void SetTypeFace(TEnumAsByte<ENUM_CarbonTypeface::Type> Typeface, FString CallFunc_GetEnumeratorUserFriendlyName_ReturnValue, FName CallFunc_Conv_StringToName_ReturnValue, FSlateFontInfo K2Node_MakeStruct_SlateFontInfo);
