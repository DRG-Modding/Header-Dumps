...
class UWeaponDisplay_ChargeBlaster_AmmoCounter_C : public UWeaponDisplay_Base_AmmoCount_C
{
    ...
    void UpdateAmount(int32 Value, bool CallFunc_Greater_IntInt_ReturnValue, class UUMGSequencePlayer* CallFunc_PlayAnimation_ReturnValue, FText CallFunc_Conv_IntToText_ReturnValue);
