...
class AAIC_Jelly_Spawn_C : public AFSDAIController
{
    ...
    void ExecuteUbergraph_AIC_Jelly_Spawn(int32 EntryPoint, FExecuteUbergraph_AIC_Jelly_SpawnK2Node_CreateDelegate_OutputDelegate K2Node_CreateDelegate_OutputDelegate, bool CallFunc_RunBehaviorTree_ReturnValue, class UHealthComponentBase* K2Node_CustomEvent_HealthComponent, class APawn* K2Node_Event_PossessedPawn, class UEnemyHealthComponent* CallFunc_GetComponentByClass_ReturnValue);
};
