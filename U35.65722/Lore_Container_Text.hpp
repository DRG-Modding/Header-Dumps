...
class ULore_Container_Text_C : public UUserWidget
{
    ...
    void ExecuteUbergraph_Lore_Container_Text(int32 EntryPoint, FText K2Node_CustomEvent_Headline, FText K2Node_CustomEvent_Body, bool K2Node_Event_IsDesignTime, class UOverlaySlot* CallFunc_SlotAsOverlaySlot_ReturnValue);
};
