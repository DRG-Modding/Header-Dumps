...
class UHUD_Directional_Damage_Indicator_C : public UUserWidget
{
    ...
    void Hit(float Damage, class AActor* DamageCauser, class APlayerCharacter* Victim, class UUserWidget*& Widget, FLinearColor Temp_struct_Variable, FLinearColor Temp_struct_Variable_1, FVector CallFunc_K2_GetActorLocation_ReturnValue, bool CallFunc_Greater_FloatFloat_ReturnValue, bool Temp_bool_Variable, FLinearColor K2Node_Select_Default);
