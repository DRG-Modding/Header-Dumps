...
class UITM_MisSel_MissionIconBasic_C : public UUserWidget
{
    ...
    void SetTemplate(class UMissionTemplate* Template, bool UseSimpleIcon, bool CallFunc_IsValid_ReturnValue, FObjectiveMissionIcon CallFunc_GetPrimaryObjectiveIcon_ReturnValue);
    void SetSelected(bool inSelected);
    void SetMission(class UGeneratedMission* InMission, bool CallFunc_IsValid_ReturnValue, FObjectiveMissionIcon CallFunc_GetPrimaryObjectiveIcon_ReturnValue);
