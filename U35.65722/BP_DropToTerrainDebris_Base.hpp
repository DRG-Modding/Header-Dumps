...
class ABP_DropToTerrainDebris_Base_C : public AActor
{
    ...
    void ExecuteUbergraph_BP_DropToTerrainDebris_Base(int32 EntryPoint, bool K2Node_ComponentBoundEvent_IsFalling, FVector CallFunc_K2_GetActorLocation_ReturnValue, class UAudioComponent* CallFunc_SpawnSoundAtLocation_ReturnValue);
};
