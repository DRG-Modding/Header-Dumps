...
class ABP_LaserPointerWaypoint_C : public ALaserPointerWaypoint
{
    ...
    void ExecuteUbergraph_BP_LaserPointerWaypoint(int32 EntryPoint, FRotator CallFunc_RLerp_ReturnValue, FHitResult CallFunc_K2_SetWorldRotation_SweepHitResult, class ADeepCSGWorld* CallFunc_GetCSGWorld_ReturnValue, bool CallFunc_IsValid_ReturnValue);
};
