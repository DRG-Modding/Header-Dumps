...
class UGooCannon_AmmoCounter_C : public UWeaponDisplay_Base_AmmoCount_C
{
    ...
    void UpdateClipCount(FUpdateClipCountK2Node_CreateDelegate_OutputDelegate K2Node_CreateDelegate_OutputDelegate, bool CallFunc_GreaterEqual_IntInt_ReturnValue, FTimerHandle CallFunc_K2_SetTimerDelegate_ReturnValue, bool CallFunc_Less_IntInt_ReturnValue, int32 CallFunc_Add_IntInt_ReturnValue, int32 CallFunc_SetNumber_OutValue, int32 CallFunc_SetNumber_OutValue_1, bool CallFunc_Less_IntInt_ReturnValue_1, bool CallFunc_BooleanAND_ReturnValue);
    void UpdateAmmoCritical(class UUMGSequencePlayer* CallFunc_PlayAnimation_ReturnValue, bool CallFunc_Greater_IntInt_ReturnValue, bool CallFunc_IsAnimationPlaying_ReturnValue, bool CallFunc_Not_PreBool_ReturnValue);
    void SetNumber(int32 Value, class UTextBlock* Label, int32& OutValue, FText CallFunc_Conv_IntToText_ReturnValue);
