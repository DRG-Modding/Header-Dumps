...
class APRW_LockedWeapon_C : public AActor
{
    ...
    void ExecuteUbergraph_PRW_LockedWeapon(int32 EntryPoint, class UUserWidget* CallFunc_GetUserWidgetObject_ReturnValue, class UUI_ImageTinted_C* K2Node_DynamicCast_AsUI_Image_Tinted, bool K2Node_DynamicCast_bSuccess);
};
