...
class UHUD_EnemyTargeting_HealthBar_Elite_C : public ULookingAtContentWidget
{
    ...
    void Construct();
    void ExecuteUbergraph_HUD_EnemyTargeting_HealthBar_Elite(int32 EntryPoint, bool Temp_bool_Variable, class UUMGSequencePlayer* CallFunc_PlayAnimation_ReturnValue, bool K2Node_Event_IsDesignTime, class AActor* K2Node_Event_InCurrentTarget_1, class AActor* K2Node_Event_InCurrentTarget, float K2Node_Event_DeltaTime, class UWidgetAnimation* K2Node_Select_Default, FLinearColor CallFunc_MenuColors_OutputColor, FLinearColor CallFunc_MenuColors_OutputColor_1, FSlateColor K2Node_MakeStruct_SlateColor);
};
