...
class UBasic_ExpandableMenu_C : public UUserWidget
{
    ...
    void GetButtonStyle(TEnumAsByte<ENUM_MenuColors::Type> Color, FSlateBrush& SlateBrush, FLinearColor CallFunc_MenuColors_OutputColor, FSlateColor K2Node_MakeStruct_SlateColor, FSlateBrush K2Node_MakeStruct_SlateBrush);
    ...
    void ExecuteUbergraph_Basic_ExpandableMenu(int32 EntryPoint, bool Temp_bool_Variable, TEnumAsByte<EUMGSequencePlayMode::Type> Temp_byte_Variable, TEnumAsByte<EUMGSequencePlayMode::Type> Temp_byte_Variable_1, bool Temp_bool_Variable_1, float Temp_float_Variable, bool Temp_bool_Variable_2, float Temp_float_Variable_1, float Temp_float_Variable_2, FSlateBrush CallFunc_GetButtonStyle_SlateBrush, FSlateBrush CallFunc_GetButtonStyle_SlateBrush_1, FSlateBrush CallFunc_GetButtonStyle_SlateBrush_2, FSlateBrush CallFunc_GetButtonStyle_SlateBrush_3, bool CallFunc_SetMenuOpen_OutIsOpen, FButtonStyle K2Node_MakeStruct_ButtonStyle, float K2Node_Select_Default, float K2Node_CustomEvent_NewScale, bool CallFunc_Not_PreBool_ReturnValue, bool CallFunc_SetMenuOpen_OutIsOpen_1, bool CallFunc_IsAnimationPlaying_ReturnValue, TEnumAsByte<EUMGSequencePlayMode::Type> K2Node_Select_Default_1, float CallFunc_GetAnimationCurrentTime_ReturnValue, float K2Node_Select_Default_2, class UUMGSequencePlayer* CallFunc_PlayAnimation_ReturnValue, bool K2Node_Event_IsDesignTime, float CallFunc_Lerp_ReturnValue, float CallFunc_Multiply_FloatFloat_ReturnValue, float CallFunc_Lerp_ReturnValue_1, float CallFunc_Multiply_FloatFloat_ReturnValue_1, FVector2D CallFunc_MakeVector2D_ReturnValue);
};
