...
class AENE_Mactera_TripleShooter_C : public AENE_Mactera_Shooter_Base_C
{
    ...
    void MakeElite();
    void ExecuteUbergraph_ENE_Mactera_TripleShooter(int32 EntryPoint, class UAttackBaseComponent* CallFunc_ReplaceAttackComponent_ReturnValue, bool CallFunc_HasAuthority_ReturnValue);
};
