...
class ABP_WormholeLocation_Base_C : public AActor
{
    ...
    void ExecuteUbergraph_BP_WormholeLocation_Base(int32 EntryPoint, class APlayerCharacter* K2Node_CustomEvent_character, class APlayerCharacter* K2Node_CustomEvent_character_1);
};
