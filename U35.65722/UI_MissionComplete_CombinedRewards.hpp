...
class UUI_MissionComplete_CombinedRewards_C : public UUserWidget
{
    ...
    void ExecuteUbergraph_UI_MissionComplete_CombinedRewards(int32 EntryPoint, FExecuteUbergraph_UI_MissionComplete_CombinedRewardsK2Node_CreateDelegate_OutputDelegate K2Node_CreateDelegate_OutputDelegate, bool CallFunc_IsValid_ReturnValue, bool K2Node_Event_IsDesignTime, class UAudioComponent* CallFunc_SpawnSound2D_ReturnValue);
