...
class ABP_GameState_SpaceRig_C : public ABP_GameState_C
{
    ...
    bool AreDeepDiveRequirementsMet(class UFSDGameInstance* CallFunc_GetFSDGameInstance_ReturnValue, bool CallFunc_AreAllSelectedClassesQualified_ReturnValue, bool CallFunc_IsValid_ReturnValue, bool CallFunc_IsSingleMission_ReturnValue, bool CallFunc_BooleanOR_ReturnValue);
    ...
    void ExecuteUbergraph_BP_GameState_SpaceRig(int32 EntryPoint, const TArray<FBlueprintSessionResult>& K2Node_CustomEvent_Results_2, const TArray<FBlueprintSessionResult>& K2Node_CustomEvent_Results_1, FExecuteUbergraph_BP_GameState_SpaceRigK2Node_CreateDelegate_OutputDelegate K2Node_CreateDelegate_OutputDelegate, const TArray<FBlueprintSessionResult>& K2Node_CustomEvent_Results, FExecuteUbergraph_BP_GameState_SpaceRigK2Node_CreateDelegate_OutputDelegate_1 K2Node_CreateDelegate_OutputDelegate_1, TArray<FBlueprintSessionResult>& Temp_struct_Variable, bool CallFunc_HasAuthority_ReturnValue, bool CallFunc_HasAuthority_ReturnValue_1, FExecuteUbergraph_BP_GameState_SpaceRigK2Node_CreateDelegate_OutputDelegate_2 K2Node_CreateDelegate_OutputDelegate_2, bool CallFunc_HasAuthority_ReturnValue_2, FTimerHandle CallFunc_K2_SetTimerDelegate_ReturnValue, float K2Node_Event_DeltaSeconds, float CallFunc_Subtract_FloatFloat_ReturnValue, float CallFunc_Subtract_FloatFloat_ReturnValue_1, bool Temp_bool_Has_Been_Initd_Variable, bool CallFunc_Greater_FloatFloat_ReturnValue, bool CallFunc_BooleanAND_ReturnValue, bool CallFunc_Greater_FloatFloat_ReturnValue_1, bool CallFunc_BooleanAND_ReturnValue_1, FExecuteUbergraph_BP_GameState_SpaceRigK2Node_CreateDelegate_OutputDelegate_3 K2Node_CreateDelegate_OutputDelegate_3, class UFSDGameInstance* CallFunc_GetFSDGameInstance_ReturnValue, class APlayerController* CallFunc_GetPlayerController_ReturnValue, class UFSDFindSessionsCallbackProxy* CallFunc_FSDFindSessions_ReturnValue, bool CallFunc_IsValid_ReturnValue, class UFSDGameInstance* CallFunc_GetFSDGameInstance_ReturnValue_1, class UFSDGameUserSettings* CallFunc_GetFSDGameUserSettings_ReturnValue, bool CallFunc_GetAutoRefreshServerlist_ReturnValue, bool CallFunc_BooleanOR_ReturnValue, bool CallFunc_LessEqual_FloatFloat_ReturnValue, bool CallFunc_AreDeepDiveRequirementsMet_ReturnValue, bool Temp_bool_IsClosed_Variable, bool CallFunc_LessEqual_FloatFloat_ReturnValue_1, class UFSDGameInstance* CallFunc_GetFSDGameInstance_ReturnValue_2);
