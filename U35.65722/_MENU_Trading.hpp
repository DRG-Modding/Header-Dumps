...
class U_MENU_Trading_C : public UWindowWidget
{
    ...
    void ExecuteUbergraph__MENU_Trading(int32 EntryPoint, class UWindowManager* CallFunc_GetWindowManager_ReturnValue, bool CallFunc_IsCampaignComplete_ReturnValue, bool CallFunc_Not_PreBool_ReturnValue, bool K2Node_Event_IsDesignTime, bool CallFunc_SetMenuLocked_Locked, FLinearColor CallFunc_MenuColors_OutputColor, FLinearColor CallFunc_MenuColors_OutputColor_1, bool CallFunc_IsShippingBuild_ReturnValue, bool CallFunc_Not_PreBool_ReturnValue_1);
};
