...
class UConsoleScreenMemorialWall_C : public UUserWidget
{
    ...
    void SetLinesSpeed(float Speed, int32 Temp_int_Array_Index_Variable, int32 Temp_int_Loop_Counter_Variable, int32 CallFunc_Add_IntInt_ReturnValue, int32 CallFunc_Array_Length_ReturnValue, class UUI_ConsoleMemorialLine_C* CallFunc_Array_Get_Item, bool CallFunc_Less_IntInt_ReturnValue);
    void RemoveLine(class UUI_ConsoleMemorialLine_C* NewParam, bool CallFunc_Array_RemoveItem_ReturnValue);
    ...
    void SpawnNewLine(int32 Temp_int_Variable, TArray<FName>& CallFunc_GetDataTableRowNames_OutRowNames, int32 CallFunc_Array_Length_ReturnValue, bool CallFunc_GreaterEqual_IntInt_ReturnValue, int32 CallFunc_Add_IntInt_ReturnValue, class UUI_ConsoleMemorialLine_C* CallFunc_Create_ReturnValue, FText CallFunc_GetNameFromRow_ReturnValue, int32 CallFunc_Array_Add_ReturnValue, class UOverlaySlot* CallFunc_AddChildToOverlay_ReturnValue);
