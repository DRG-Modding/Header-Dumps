...
class UHUD_TutorialLevelManager_C : public UTutorialLevelWidget
{
    ...
    void Construct();
    void ExecuteUbergraph_HUD_TutorialLevelManager(int32 EntryPoint, class UTutorialContentWidget* K2Node_Event_Widget, class UVerticalBoxSlot* CallFunc_AddChildToVerticalBox_ReturnValue, bool CallFunc_IsValid_ReturnValue);
};
