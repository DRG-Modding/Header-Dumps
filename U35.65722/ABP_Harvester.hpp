...
class UABP_Harvester_C : public USimpleMovingEnemyAnimInstance
{
    ...
    void ExecuteUbergraph_ABP_Harvester(int32 EntryPoint, class USkeletalMeshComponent* CallFunc_GetOwningComponent_ReturnValue, class UAudioComponent* CallFunc_SpawnSoundAttached_ReturnValue);
};
