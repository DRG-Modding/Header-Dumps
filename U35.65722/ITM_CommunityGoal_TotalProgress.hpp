...
class UITM_CommunityGoal_TotalProgress_C : public UFSDUserWidget
{
    ...
    void SendButtonToolTipOpen(class UWidget* Button, int32 Tier, class UUserWidget* CallFunc_CreateToolTip_OutToolTip, bool CallFunc_IsValid_ReturnValue, class UITM_CommunityGoalRewardToolTip_C* K2Node_DynamicCast_AsITM_Community_Goal_Reward_Tool_Tip, bool K2Node_DynamicCast_bSuccess);
    ...
    void Construct();
    void ExecuteUbergraph_ITM_CommunityGoal_TotalProgress(int32 EntryPoint, ESlateVisibility Temp_byte_Variable, class UUserWidget* CallFunc_CreateToolTip_OutToolTip, class UITM_FactionToolTip_C* K2Node_DynamicCast_AsITM_Faction_Tool_Tip, bool K2Node_DynamicCast_bSuccess, ESlateVisibility Temp_byte_Variable_1, bool CallFunc_IsValid_ReturnValue, bool K2Node_Event_IsDesignTime, FGeometry K2Node_Event_MyGeometry, float K2Node_Event_InDeltaTime, float CallFunc_Add_FloatFloat_ReturnValue, bool CallFunc_GreaterEqual_FloatFloat_ReturnValue, const TArray<FString>& K2Node_CustomEvent_GoalID, const TArray<float>& K2Node_CustomEvent_GoalValue, const TArray<int32>& K2Node_CustomEvent_Members, bool Temp_bool_Variable, int32 CallFunc_Array_Length_ReturnValue, int32 CallFunc_Array_Length_ReturnValue_1, int32 CallFunc_Array_Length_ReturnValue_2, int32 Temp_int_Variable, int32 CallFunc_Min_ReturnValue, int32 CallFunc_Min_ReturnValue_1, int32 CallFunc_Subtract_IntInt_ReturnValue, bool CallFunc_LessEqual_IntInt_ReturnValue, int32 CallFunc_Add_IntInt_ReturnValue, class UGameData* CallFunc_GetFSDGameData_ReturnValue, class UCommunityGoal* CallFunc_FindGoal_ReturnValue, float CallFunc_Add_FloatFloat_ReturnValue_1, float CallFunc_Multiply_FloatFloat_ReturnValue, float CallFunc_Add_FloatFloat_ReturnValue_2, float CallFunc_FMin_ReturnValue, ESlateVisibility K2Node_Select_Default, float K2Node_CustomEvent_TierProgress);
