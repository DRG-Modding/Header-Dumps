...
class UBasic_Popup_YesNoPrompt_C : public UYesNoPromptWidget
{
    ...
    void ExecuteUbergraph_Basic_Popup_YesNoPrompt(int32 EntryPoint, const class UResourceData* Temp_object_Variable, int32 Temp_int_Array_Index_Variable, int32 Temp_int_Loop_Counter_Variable, int32 CallFunc_Add_IntInt_ReturnValue, const FText K2Node_Event_Title, const FText K2Node_Event_Message, FText CallFunc_TextToUpper_ReturnValue, bool K2Node_Event_IsDesignTime, FLinearColor CallFunc_MenuColors_OutputColor, FSlateColor K2Node_MakeStruct_SlateColor, FLinearColor CallFunc_MenuColors_OutputColor_1, FSlateColor K2Node_MakeStruct_SlateColor_1, class APlayerController* CallFunc_GetOwningPlayer_ReturnValue, class UWindowManager* CallFunc_GetWindowManager_ReturnValue, class UResourceData* K2Node_CustomEvent_InResource, float K2Node_CustomEvent_InAmount, const TArray<FCraftingCost>& K2Node_CustomEvent_Resources, int32 CallFunc_Array_Length_ReturnValue, int32 Temp_int_Loop_Counter_Variable_1, const TMap<UResourceData*, int32> K2Node_Event_resources, bool CallFunc_Less_IntInt_ReturnValue, TArray<class UResourceData*>& CallFunc_Map_Keys_Keys, class UResourceData* CallFunc_Array_Get_Item, int32 CallFunc_Array_Length_ReturnValue_1, int32 CallFunc_Map_Find_Value, bool CallFunc_Map_Find_ReturnValue, bool CallFunc_Less_IntInt_ReturnValue_1, float CallFunc_Conv_IntToFloat_ReturnValue, bool CallFunc_Array_RemoveItem_ReturnValue, int32 CallFunc_Add_IntInt_ReturnValue_1, int32 Temp_int_Array_Index_Variable_1, const class UResourceData* Temp_object_Variable_1, FCraftingCost CallFunc_Array_Get_Item_1, bool CallFunc_Greater_FloatFloat_ReturnValue);
};
