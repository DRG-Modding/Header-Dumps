...
class ABP_Fossil_BigLizard_Ribcage_C : public ABP_FossilsBase_C
{
    ...
    void ExecuteUbergraph_BP_Fossil_BigLizard_Ribcage(int32 EntryPoint, class AActor* K2Node_Event_OtherActor, FVector CallFunc_K2_GetActorLocation_ReturnValue);
};
