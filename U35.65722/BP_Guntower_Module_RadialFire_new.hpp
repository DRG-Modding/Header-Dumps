...
class ABP_Guntower_Module_RadialFire_new_C : public ARadialFireModule
{
    ...
    void OnFire();
    void OnTearArmor();
    void ExecuteUbergraph_BP_Guntower_Module_RadialFire_new(int32 EntryPoint, class UAudioComponent* CallFunc_SpawnSoundAttached_ReturnValue, class UAudioComponent* CallFunc_SpawnSoundAttached_ReturnValue_1);
};
