...
class UOBJ_2nd_KillFleas_C : public UKillEnemiesObjective
{
    ...
    class UTexture2D* GetInMissionCounterIcon(TSubclassOf<class APawn> CallFunc_GetEnemyClass_ReturnValue, class UObjectInfoComponent* CallFunc_GetComponentFromClass_ReturnValue, class UTexture2D* CallFunc_GetInGameIcon_ReturnValue, bool CallFunc_IsValid_ReturnValue);
