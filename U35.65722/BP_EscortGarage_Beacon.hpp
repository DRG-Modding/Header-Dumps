...
class ABP_EscortGarage_Beacon_C : public AActor
{
    ...
    void FadeOut();
    void ExecuteUbergraph_BP_EscortGarage_Beacon(int32 EntryPoint, bool CallFunc_HasAuthority_ReturnValue, TArray<class UMaterialInstanceDynamic*>& CallFunc_CreateDynamicMaterialInstances_ReturnValue);
};
