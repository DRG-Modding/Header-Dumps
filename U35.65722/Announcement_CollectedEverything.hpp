...
class UAnnouncement_CollectedEverything_C : public UUserWidget
{
    ...
    void ExecuteUbergraph_Announcement_CollectedEverything(int32 EntryPoint, FExecuteUbergraph_Announcement_CollectedEverythingK2Node_CreateDelegate_OutputDelegate K2Node_CreateDelegate_OutputDelegate, bool K2Node_Event_IsDesignTime, class UUMGSequencePlayer* CallFunc_PlayAnimation_ReturnValue, FLinearColor CallFunc_MenuColors_OutputColor);
};
