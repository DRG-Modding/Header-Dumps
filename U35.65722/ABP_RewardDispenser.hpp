...
class UABP_RewardDispenser_C : public UCoreInfuserAnimInstance
{
    ...
    void ExecuteUbergraph_ABP_RewardDispenser(int32 EntryPoint, bool K2Node_CustomEvent_isVisible, class USkeletalMeshComponent* CallFunc_GetOwningComponent_ReturnValue, FName CallFunc_MakeLiteralName_ReturnValue);
};
