...
class UITM_Trading_ResourcePoster_C : public UUserWidget
{
    ...
    void ExecuteUbergraph_ITM_Trading_ResourcePoster(int32 EntryPoint, class UTexture2D* K2Node_CustomEvent_Icon, class UMaterialInstanceDynamic* CallFunc_GetDynamicMaterial_ReturnValue);
};
