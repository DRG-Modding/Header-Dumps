...
class UCheat_MakeMainSave_C : public UUserWidget
{
    ...
    void ExecuteUbergraph_Cheat_MakeMainSave(int32 EntryPoint, class UFSDSaveGame* CallFunc_GetFSDSaveGame_ReturnValue, class UFSDSaveGame* CallFunc_GetFSDSaveGame_ReturnValue_1);
};
