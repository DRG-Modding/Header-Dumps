...
class UCheat_Resupply_C : public UUserWidget
{
    ...
    void ExecuteUbergraph_Cheat_Resupply(int32 EntryPoint, class UCheatMenu_BasicButtonWText_C* K2Node_ComponentBoundEvent_Button, class UFSDCheatManager* CallFunc_GetCheatManager_ReturnValue);
};
