...
class UCheat_ShowHUD_C : public UUserWidget
{
    ...
    void ExecuteUbergraph_Cheat_ShowHUD(int32 EntryPoint, bool K2Node_ComponentBoundEvent_bIsChecked, class UFSDCheatManager* CallFunc_GetCheatManager_ReturnValue);
};
