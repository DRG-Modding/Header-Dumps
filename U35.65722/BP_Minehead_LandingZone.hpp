...
class ABP_Minehead_LandingZone_C : public AActor
{
    ...
    void ExecuteUbergraph_BP_Minehead_LandingZone(int32 EntryPoint, bool CallFunc_HasAuthority_ReturnValue, TArray<class UMaterialInstanceDynamic*>& CallFunc_CreateDynamicMaterialInstances_ReturnValue);
};
