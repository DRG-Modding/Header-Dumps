...
class AAIC_FlyingSmartRock_C : public AFSDAIController
{
    ...
    void ExecuteUbergraph_AIC_FlyingSmartRock(int32 EntryPoint, FExecuteUbergraph_AIC_FlyingSmartRockK2Node_CreateDelegate_OutputDelegate K2Node_CreateDelegate_OutputDelegate, bool CallFunc_RunBehaviorTree_ReturnValue, class UHealthComponentBase* K2Node_CustomEvent_HealthComponent, class APawn* K2Node_Event_PossessedPawn, class UEnemyHealthComponent* CallFunc_GetComponentByClass_ReturnValue, FName CallFunc_MakeLiteralName_ReturnValue, TArray<class AEscortMule*>& CallFunc_GetAllActorsOfClass_OutActors, class AEscortMule* CallFunc_Array_Get_Item, int32 CallFunc_Array_Length_ReturnValue, bool CallFunc_Greater_IntInt_ReturnValue);
};
