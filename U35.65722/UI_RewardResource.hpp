...
class UUI_RewardResource_C : public URewardWidget
{
    ...
    void ExecuteUbergraph_UI_RewardResource(int32 EntryPoint, bool K2Node_Event_IsDesignTime, class UUMGSequencePlayer* CallFunc_PlayAnimation_ReturnValue, float CallFunc_Conv_IntToFloat_ReturnValue);
};
