...
class UScrollingText01_C : public UUserWidget
{
    ...
    void Construct();
    void ExecuteUbergraph_ScrollingText01(int32 EntryPoint, float CallFunc_RandomFloatInRange_ReturnValue, class UUMGSequencePlayer* CallFunc_PlayAnimation_ReturnValue);
};
