...
class ABP_TruckerBalls_C : public AActor
{
    ...
    void CustomEvent_0();
    void ExecuteUbergraph_BP_TruckerBalls(int32 EntryPoint, FVector CallFunc_MakeVector_ReturnValue, class APlayerCharacter* K2Node_ComponentBoundEvent_user, EInputKeys K2Node_ComponentBoundEvent_key, float CallFunc_RandomFloatInRange_ReturnValue, FVector CallFunc_MakeVector_ReturnValue_1, FVector CallFunc_K2_GetActorLocation_ReturnValue);
};
