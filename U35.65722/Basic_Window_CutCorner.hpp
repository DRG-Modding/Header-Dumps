...
class UBasic_Window_CutCorner_C : public UUserWidget
{
    ...
    void ExecuteUbergraph_Basic_Window_CutCorner(int32 EntryPoint, bool K2Node_Event_IsDesignTime, FLinearColor CallFunc_MakeColor_ReturnValue, class UOverlaySlot* CallFunc_SlotAsOverlaySlot_ReturnValue, FLinearColor K2Node_CustomEvent_InColorAndOpacity, TEnumAsByte<ENUM_MenuColors::Type> K2Node_CustomEvent_Colorbar_Tint);
};
