...
class UTEST_SeasonMissionComplete_C : public UUserWidget
{
    ...
    void Construct();
    void SeasonFlowEnd();
    void ExecuteUbergraph_TEST_SeasonMissionComplete(int32 EntryPoint, FExecuteUbergraph_TEST_SeasonMissionCompleteK2Node_CreateDelegate_OutputDelegate K2Node_CreateDelegate_OutputDelegate);
};
