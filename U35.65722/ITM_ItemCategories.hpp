...
class UITM_ItemCategories_C : public UUserWidget
{
    ...
    void GetButton(EVanitySlot Slot, class UBTN_ItemCategory_C*& Button, bool K2Node_SwitchEnum_CmpSuccess);
    ...
    void OnClosed();
    void ExecuteUbergraph_ITM_ItemCategories(int32 EntryPoint, class UPlayerCharacterID* K2Node_CustomEvent_characterID);
