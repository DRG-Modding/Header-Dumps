...
class U_MENU_CheatConsole_C : public UWindowWidget
{
    ...
    class UUI_ForceSpecialEvent_C* UI_ForceSpecialEvent;
    ...
    void ExecuteUbergraph__MENU_CheatConsole(int32 EntryPoint, class UWindowManager* CallFunc_GetWindowManager_ReturnValue, UClass* K2Node_CustomEvent_Loaded, FExecuteUbergraph__MENU_CheatConsoleK2Node_CreateDelegate_OutputDelegate K2Node_CreateDelegate_OutputDelegate, UClass* Temp_class_Variable, TSubclassOf<class UWindowWidget> K2Node_ClassDynamicCast_AsWindow_Widget, bool K2Node_ClassDynamicCast_bSuccess, class UWindowWidget* CallFunc_OpenWindowFromClass_ReturnValue, bool K2Node_Event_IsDesignTime, class UWindowManager* CallFunc_GetWindowManager_ReturnValue_1, FText CallFunc_GetText_ReturnValue, FString CallFunc_Conv_TextToString_ReturnValue, FString CallFunc_Concat_StrStr_ReturnValue, class ABP_GameState_SpaceRig_C* CallFunc_GetSRGameState_gameState, bool CallFunc_IsServer_ReturnValue, class UFSDGameInstance* CallFunc_GetFSDGameInstance_ReturnValue, class UGeneratedMission* CallFunc_GetGeneratedMission_ReturnValue, bool CallFunc_IsValid_ReturnValue, bool CallFunc_BooleanAND_ReturnValue);
};
