...
class UTSK_FindRandomPointFrom_WithinHeight_C : public UBTTask_BlueprintBase
{
    ...
    FVector GetLocation(bool Temp_bool_Variable, class AActor* CallFunc_GetBlackboardValueAsActor_ReturnValue, FVector CallFunc_GetBlackboardValueAsVector_ReturnValue, FVector CallFunc_K2_GetActorLocation_ReturnValue, bool CallFunc_IsValid_ReturnValue, FVector K2Node_Select_Default);
