...
class UITM_LoadoutIcon_C : public UUserWidget
{
    ...
    void ExecuteUbergraph_ITM_LoadoutIcon(int32 EntryPoint, class UTexture2D* K2Node_CustomEvent_Texture, int32 K2Node_CustomEvent_Index, class UTexture2D* CallFunc_GetBrushResourceAsTexture2D_ReturnValue, bool CallFunc_IsValid_ReturnValue);
