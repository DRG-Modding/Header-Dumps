...
class UCheat_QuadPickAxe_C : public UUserWidget
{
    ...
    void ExecuteUbergraph_Cheat_QuadPickAxe(int32 EntryPoint, class UFSDCheatManager* CallFunc_GetCheatManager_ReturnValue, bool K2Node_ComponentBoundEvent_bIsChecked);
};
