...
class UUI_MissionComplete_CombinedRewardLine_C : public UUserWidget
{
    ...
    void SetIcon(class UTexture2D* Texture, FLinearColor TextureTint, bool CallFunc_IsValid_ReturnValue, FSlateColor K2Node_MakeStruct_SlateColor, bool CallFunc_SelectVisibility_IsVisible, bool CallFunc_SelectVisibility_VisibilityChanged, ESlateVisibility CallFunc_SelectVisibility_New_Visibility);
    ...
    void ExecuteUbergraph_UI_MissionComplete_CombinedRewardLine(int32 EntryPoint, float CallFunc_Divide_FloatFloat_ReturnValue, bool K2Node_Event_IsDesignTime, class UUI_MissionComplete_RewardColumn_C* K2Node_CustomEvent_InColumn, float K2Node_CustomEvent_Duration, float CallFunc_Divide_FloatFloat_ReturnValue_1, class UUMGSequencePlayer* CallFunc_PlayAnimation_ReturnValue, float K2Node_CustomEvent_InProgress, float CallFunc_Conv_IntToFloat_ReturnValue, float CallFunc_Lerp_ReturnValue, int32 CallFunc_FFloor_ReturnValue, FText CallFunc_Conv_IntToText_ReturnValue, int32 CallFunc_Subtract_IntInt_ReturnValue, float CallFunc_Conv_IntToFloat_ReturnValue_1, float CallFunc_Divide_FloatFloat_ReturnValue_2, float CallFunc_Multiply_IntFloat_ReturnValue, int32 CallFunc_Round_ReturnValue, float CallFunc_Multiply_IntFloat_ReturnValue_1, FVector2D CallFunc_MakeVector2D_ReturnValue);
};
