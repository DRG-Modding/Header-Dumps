...
class UConsoleScreen_SelectCharacterOnly_C : public UUserWidget
{
    ...
    void Construct();
    void ExecuteUbergraph_ConsoleScreen_SelectCharacterOnly(int32 EntryPoint, float CallFunc_RandomFloat_ReturnValue, class UUMGSequencePlayer* CallFunc_PlayAnimation_ReturnValue);
};
