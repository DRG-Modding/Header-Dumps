...
class UTutorial_Hint_MinersManual_C : public UTutorialHintComponent
{
    ...
    void ExecuteUbergraph_Tutorial_Hint_MinersManual(int32 EntryPoint, class UFSDSaveGame* CallFunc_GetFSDSaveGame_ReturnValue, bool CallFunc_Not_PreBool_ReturnValue);
};
