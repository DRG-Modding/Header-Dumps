...
class UW_TutorialContent_Base_C : public UTutorialContentWidget
{
    ...
    void ExecuteUbergraph_W_TutorialContent_Base(int32 EntryPoint, int32 K2Node_CustomEvent_Counter, int32 K2Node_CustomEvent_Denominator, FText K2Node_CustomEvent_TaskHeader, FText K2Node_CustomEvent_TaskText, FText K2Node_CustomEvent_CheckBoxText, class UTexture2D* K2Node_CustomEvent_Image);
};
