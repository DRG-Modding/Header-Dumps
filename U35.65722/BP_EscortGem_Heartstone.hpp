...
class ABP_EscortGem_Heartstone_C : public ABP_Gem_C
{
    ...
    void ExecuteUbergraph_BP_EscortGem_Heartstone(int32 EntryPoint, float CallFunc_Multiply_FloatFloat_ReturnValue, class APlayerCharacter* K2Node_Event_fromPlayer);
};
