...
class UHUD_BossFight_Entry_C : public UHUD_BossFight_BaseEntry_C
{
    ...
    void GetBossFight(FBossFight& BossFight, class UObject* CallFunc_Conv_InterfaceToObject_ReturnValue, class USimpleBossFight* K2Node_DynamicCast_AsSimple_Boss_Fight, bool K2Node_DynamicCast_bSuccess);
    ...
    void ExecuteUbergraph_HUD_BossFight_Entry(int32 EntryPoint, FExecuteUbergraph_HUD_BossFight_EntryK2Node_CreateDelegate_OutputDelegate K2Node_CreateDelegate_OutputDelegate, class UEnemyTemperatureReplicatorComponent* CallFunc_GetComponentByClass_ReturnValue, FExecuteUbergraph_HUD_BossFight_EntryK2Node_CreateDelegate_OutputDelegate_1 K2Node_CreateDelegate_OutputDelegate_1, bool CallFunc_IsValid_ReturnValue, float K2Node_CustomEvent_floatValue, float CallFunc_GetTemperatureEffect_ReturnValue, TArray<class UPawnAffliction*>& K2Node_MakeArray_Array, bool CallFunc_IsValid_ReturnValue_1, FExecuteUbergraph_HUD_BossFight_EntryK2Node_CreateDelegate_OutputDelegate_2 K2Node_CreateDelegate_OutputDelegate_2, FText CallFunc_TextToUpper_ReturnValue);
};
