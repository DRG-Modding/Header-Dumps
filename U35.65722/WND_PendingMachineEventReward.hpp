...
class UWND_PendingMachineEventReward_C : public UWindowWidget
{
    ...
    void ExecuteUbergraph_WND_PendingMachineEventReward(int32 EntryPoint, class USchematic* CallFunc_TryGivePendingReward_ReturnValue, bool CallFunc_IsValid_ReturnValue, class UUMGSequencePlayer* CallFunc_PlayAnimation_ReturnValue);
};
