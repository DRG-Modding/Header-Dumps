...
class AENE_Mactera_Shooter_Normal_C : public AENE_Mactera_Shooter_Base_C
{
    ...
    void MakeElite();
    void ExecuteUbergraph_ENE_Mactera_Shooter_Normal(int32 EntryPoint, bool CallFunc_HasAuthority_ReturnValue, class UAttackBaseComponent* CallFunc_ReplaceAttackComponent_ReturnValue);
};
