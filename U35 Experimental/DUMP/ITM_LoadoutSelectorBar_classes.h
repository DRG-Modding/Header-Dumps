...
struct UITM_LoadoutSelectorBar_C : UUserWidget {
	...
	UITM_LoadoutSelectButton_C* ITM_LoadoutSelectButton_4; // 0x268(0x08)
	UITM_LoadoutSelectButton_C* ITM_LoadoutSelectButton_5; // 0x270(0x08)
	FMulticastInlineDelegate NewLoadoutSelected; // 0x278(0x10)
	UPlayerCharacterID* CharacterClass; // 0x288(0x08)
	TArray<UITM_LoadoutSelectButton_C*> LoadoutButtons; // 0x290(0x10)
	UITM_LoadoutSelectButton_C* SelectedLoadoutButton; // 0x2a0(0x08)
	UBasic_ToolTip_HeadlineAndText_C* HoverTooltipWidget; // 0x2a8(0x08)
	bool CanSwitchIcon; // 0x2b0(0x01)
