// BlueprintGeneratedClass Proxy_HideDropPod.Proxy_HideDropPod_C
// Size: 0x248 (Inherited: 0x220)
struct AProxy_HideDropPod_C : AActor {
	...
	UFUNCTION(BlueprintCallable) void ExecuteUbergraph_Proxy_HideDropPod(int32_t EntryPoint);
};
