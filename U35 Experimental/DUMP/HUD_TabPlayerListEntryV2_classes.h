...
struct UHUD_TabPlayerListEntryV2_C : UUserWidget {
	...
	UImage* IsTalking; // 0x268(0x08)
	UITM_CharacterIcon_C* ITM_CharacterIcon; // 0x270(0x08)
	UITM_HealthBar_C* ITM_HealthBar; // 0x278(0x08)
	UTextBlock* PingText; // 0x280(0x08)
	UNamedSlot* PutStuffHere_Rightside; // 0x288(0x08)
	UUI_NameTags_C* UI_NameTags; // 0x290(0x08)
