// BlueprintGeneratedClass Proxy_NormalMotion.Proxy_NormalMotion_C
// Size: 0x238 (Inherited: 0x220)
struct AProxy_NormalMotion_C : AActor {
	...
	UFUNCTION(BlueprintCallable) void ExecuteUbergraph_Proxy_NormalMotion(int32_t EntryPoint);
};
