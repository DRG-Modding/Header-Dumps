// AnimBlueprintGeneratedClass ABP_PowerupSprinkler.ABP_PowerupSprinkler_C
// Size: 0x670 (Inherited: 0x270)
struct UABP_PowerupSprinkler_C : UGameEventAnimInstance {
	...
	UFUNCTION(BlueprintCallable) void ExecuteUbergraph_ABP_PowerupSprinkler(int32_t EntryPoint);
};
