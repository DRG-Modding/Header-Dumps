// BlueprintGeneratedClass SER_FindNearestPlayerTarget.SER_FindNearestPlayerTarget_C
// Size: 0xe8 (Inherited: 0x98)
struct USER_FindNearestPlayerTarget_C : UBTService_BlueprintBase {
	...
	void ExecuteUbergraph_SER_FindNearestPlayerTarget(int32_t EntryPoint);
};
