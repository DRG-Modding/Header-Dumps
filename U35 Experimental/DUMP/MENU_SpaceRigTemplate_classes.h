...
struct UMENU_SpaceRigTemplate_C : UUserWidget {
	...
	USafeZone* PlatformSafeZone; // 0x2c0(0x08)
	UBorder* ResourceBG; // 0x2c8(0x08)
	bool ShowCloseButton; // 0x2d0(0x01)
	AFSDPlayerState* PlayerState; // 0x2d8(0x08)
	bool ShowBackgroundBlur; // 0x2e0(0x01)
	FMulticastInlineDelegate OnClosedClicked; // 0x2e8(0x10)
	TArray<UResourceData*> AdditionalResources; // 0x2f8(0x10)
	bool IsCloseBack; // 0x308(0x01)
	FMulticastInlineDelegate OnBackClicked; // 0x310(0x10)
