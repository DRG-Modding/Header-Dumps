// BlueprintGeneratedClass Proxy_SFX_CaveLeech.Proxy_SFX_CaveLeech_C
// Size: 0x238 (Inherited: 0x220)
struct AProxy_SFX_CaveLeech_C : AActor {
	...
	UFUNCTION(BlueprintCallable) void ExecuteUbergraph_Proxy_SFX_CaveLeech(int32_t EntryPoint);
};
