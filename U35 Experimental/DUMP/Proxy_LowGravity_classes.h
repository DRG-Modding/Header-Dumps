// BlueprintGeneratedClass Proxy_LowGravity.Proxy_LowGravity_C
// Size: 0x238 (Inherited: 0x220)
struct AProxy_LowGravity_C : AActor {
	...
	UFUNCTION(BlueprintCallable) void ExecuteUbergraph_Proxy_LowGravity(int32_t EntryPoint);
};
