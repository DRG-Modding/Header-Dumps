...
struct ABP_ShieldRegenerator_Mover_C : ADeepPathfinderCharacter {
	...
	UAudioComponent* MovingAudioComponent; // 0x388(0x08)
	UParticleSystemComponent* RocketExhaust; // 0x390(0x08)
	UPointLightComponent* PointLight; // 0x398(0x08)
	float LiftOff_Progress_9B203DE44FAEAFAF13D1B3902168B574; // 0x3a0(0x04)
	enum class ETimelineDirection LiftOff__Direction_9B203DE44FAEAFAF13D1B3902168B574; // 0x3a4(0x01)
	UTimelineComponent* LiftOff; // 0x3a8(0x08)
	AActor* TargetActor; // 0x3b0(0x08)
	FVector HoverPoint; // 0x3b8(0x0c)
	FVector StartPoint; // 0x3c4(0x0c)
	UParticleSystem* ListoffBlastParticles; // 0x3d0(0x08)
	AShieldGeneratorItem* Item; // 0x3d8(0x08)
