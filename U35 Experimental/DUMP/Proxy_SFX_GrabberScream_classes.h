// BlueprintGeneratedClass Proxy_SFX_GrabberScream.Proxy_SFX_GrabberScream_C
// Size: 0x238 (Inherited: 0x220)
struct AProxy_SFX_GrabberScream_C : AActor {
	...
	UFUNCTION(BlueprintCallable) void ExecuteUbergraph_Proxy_SFX_GrabberScream(int32_t EntryPoint);
};
