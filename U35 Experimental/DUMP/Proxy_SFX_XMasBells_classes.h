// BlueprintGeneratedClass Proxy_SFX_XMasBells.Proxy_SFX_XMasBells_C
// Size: 0x238 (Inherited: 0x220)
struct AProxy_SFX_XMasBells_C : AActor {
	...
	UFUNCTION(BlueprintCallable) void ExecuteUbergraph_Proxy_SFX_XMasBells(int32_t EntryPoint);
};
