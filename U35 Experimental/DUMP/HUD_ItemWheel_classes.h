...
struct UHUD_ItemWheel_C : UItemsBar {
	...
	UUI_AdvancedLabel_C* dpaddown; // 0x298(0x08)
	UUI_AdvancedLabel_C* dpadleft; // 0x2a0(0x08)
	UUI_AdvancedLabel_C* dpadright; // 0x2a8(0x08)
	UUI_AdvancedLabel_C* dpadup; // 0x2b0(0x08)
