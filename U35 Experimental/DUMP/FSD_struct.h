...
struct FChallengeInfo {
	...
	int32_t CurrentWins; // 0x30(0x04)
	int32_t NumberOfWins; // 0x34(0x04)
	int32_t XPCompleteGain; // 0x38(0x04)
	int32_t TokenGain; // 0x3c(0x04)
	TSoftObjectPtr<UTexture2D> Stat1Image; // 0x40(0x28)
	TSoftObjectPtr<UTexture2D> Stat2Image; // 0x68(0x28)
	bool bIsSpecial; // 0x90(0x01)
};
