// BlueprintGeneratedClass Proxy_HideResupply.Proxy_HideResupply_C
// Size: 0x248 (Inherited: 0x220)
struct AProxy_HideResupply_C : AActor {
	...
	UFUNCTION(BlueprintCallable) void ExecuteUbergraph_Proxy_HideResupply(int32_t EntryPoint);
};
