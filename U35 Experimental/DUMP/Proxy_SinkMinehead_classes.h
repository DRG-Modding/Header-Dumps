// BlueprintGeneratedClass Proxy_SinkMinehead.Proxy_SinkMinehead_C
// Size: 0x250 (Inherited: 0x220)
struct AProxy_SinkMinehead_C : AActor {
	...
	UFUNCTION(BlueprintCallable) void ExecuteUbergraph_Proxy_SinkMinehead(int32_t EntryPoint);
};
