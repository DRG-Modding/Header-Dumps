// BlueprintGeneratedClass Proxy_TeamDash.Proxy_TeamDash_C
// Size: 0x238 (Inherited: 0x220)
struct AProxy_TeamDash_C : AActor {
	...
	UFUNCTION(BlueprintCallable) void ExecuteUbergraph_Proxy_TeamDash(int32_t EntryPoint);
};
