...
struct UBP_DownedState_C : UDownedStateComponent {
	FPointerToUberGraphFrame UberGraphFrame; // 0x148(0x08)
	TSoftObjectPtr<UObject> SeeYouInHell_Particles; // 0x150(0x28)
	TSoftObjectPtr<UObject> SeeYOuInHell_Charge_Particles; // 0x178(0x28)
