// BlueprintGeneratedClass Proxy_RaiseMinehead.Proxy_RaiseMinehead_C
// Size: 0x250 (Inherited: 0x220)
struct AProxy_RaiseMinehead_C : AActor {
	...
	UFUNCTION(BlueprintCallable) void ExecuteUbergraph_Proxy_RaiseMinehead(int32_t EntryPoint);
};
