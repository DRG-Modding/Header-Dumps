...
struct FChromaSDKColorFrame2D {
	UPROPERTY(BlueprintReadWrite) TArray<FChromaSDKColors> Colors; 
};

// ScriptStruct ChromaSDKPlugin.ChromaSDKColors
// Size: 0x10 (Inherited: 0x00)
struct FChromaSDKColors {
	UPROPERTY(BlueprintReadWrite) TArray<FLinearColor> Colors; 
};
...
struct FChromaSDKEffectResult {
	UPROPERTY(BlueprintReadWrite) int32_t Result; 
	UPROPERTY(BlueprintReadWrite) FChromaSDKGuid EffectId; 
};
