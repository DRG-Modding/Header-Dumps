// BlueprintGeneratedClass Proxy_SinkDroppod.Proxy_SinkDroppod_C
// Size: 0x250 (Inherited: 0x220)
struct AProxy_SinkDroppod_C : AActor {
	...
	UFUNCTION(BlueprintCallable) void ExecuteUbergraph_Proxy_SinkDroppod(int32_t EntryPoint);
};
