// BlueprintGeneratedClass Proxy_RespawnHost.Proxy_RespawnHost_C
// Size: 0x238 (Inherited: 0x220)
struct AProxy_RespawnHost_C : AActor {
	...
	UFUNCTION(BlueprintCallable) void ExecuteUbergraph_Proxy_RespawnHost(int32_t EntryPoint);
};
