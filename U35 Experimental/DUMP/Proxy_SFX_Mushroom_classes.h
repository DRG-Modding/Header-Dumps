// BlueprintGeneratedClass Proxy_SFX_Mushroom.Proxy_SFX_Mushroom_C
// Size: 0x238 (Inherited: 0x220)
struct AProxy_SFX_Mushroom_C : AActor {
	...
	UFUNCTION(BlueprintCallable) void ExecuteUbergraph_Proxy_SFX_Mushroom(int32_t EntryPoint);
};
