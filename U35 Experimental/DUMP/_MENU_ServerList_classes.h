...
struct U_MENU_ServerList_C : UWindowWidget {
	...
	UBasic_ButtonScalable2_C* BTN_DeepDives; // 0x2e8(0x08)
	UBasic_ButtonScalable2_C* BTN_Full_ServerList; // 0x2f0(0x08)
	UBasic_ButtonScalable2_C* BTN_QuickJoin; // 0x2f8(0x08)
	UBasic_ButtonScalable2_C* BTN_Refresh; // 0x300(0x08)
	...
	UScrollBox* ScrollBox_Servers; // 0x398(0x08)
	UVerticalBox* ScrollBox_Vertical; // 0x3a0(0x08)
	UVerticalBox* SearchingVBox; // 0x3a8(0x08)
	USizeBox* Size_Complexity; // 0x3b0(0x08)
	USizeBox* Size_Distance; // 0x3b8(0x08)
	USizeBox* Size_Hazard; // 0x3c0(0x08)
	USizeBox* Size_Length; // 0x3c8(0x08)
	USizeBox* Size_Mission; // 0x3d0(0x08)
	USizeBox* Size_Team; // 0x3d8(0x08)
	USizeBox* Size_Time; // 0x3e0(0x08)
	UTextBlock* TextDistanceClose; // 0x3e8(0x08)
	UTextBlock* TextDistanceFar; // 0x3f0(0x08)
	UTextBlock* TextDistanceMedium; // 0x3f8(0x08)
	UTextBlock* TextDistanceWorld; // 0x400(0x08)
	UTextBlock* TextOpenServerType; // 0x408(0x08)
	UTextBlock* TextPasswordServerType; // 0x410(0x08)
	UTextBlock* TXT_Category_Complexity; // 0x418(0x08)
	UTextBlock* TXT_Category_filters; // 0x420(0x08)
	UTextBlock* TXT_Category_Hazard; // 0x428(0x08)
	UTextBlock* TXT_Category_Length; // 0x430(0x08)
	UTextBlock* TXT_Category_MissionType; // 0x438(0x08)
	UTextBlock* TXT_Category_Team; // 0x440(0x08)
	UTextBlock* TXT_Category_Time; // 0x448(0x08)
	UTextBlock* TXT_Distance; // 0x450(0x08)
	UTextBlock* TXT_NoServersFound; // 0x458(0x08)
	UBasic_TextInputField_C* TXT_Search; // 0x460(0x08)
	UVerticalBox* VboxNoServerFound; // 0x468(0x08)
	UWND_Joining_C* JoinServerWidget; // 0x470(0x08)
	UWND_JoinFailed_C* JoinFailedWidget; // 0x478(0x08)
	UWND_JoiningPassword_C* JoinServerPasswordWidget; // 0x480(0x08)
	UWND_JoiningModded_C* JoinServerModdedWidget; // 0x488(0x08)
	UGeneratedMission* RestrictedMission; // 0x490(0x08)
	TArray<FBlueprintSessionResult> ServerList; // 0x498(0x10)
	TArray<UITM_ServerList_Entry_C*> ServerListEntryCache; // 0x4a8(0x10)
	TArray<UITM_ServerList_Entry_C*> ExistingEntries; // 0x4b8(0x10)
	int32_t ActiveEntryIndex; // 0x4c8(0x04)
	TArray<float> ColumnWidths; // 0x4d0(0x10)
	enum class EServerSortOrder SortingMethod; // 0x4e0(0x01)
	bool SortingReversed; // 0x4e1(0x01)
	bool ServerSideFiltering; // 0x4e2(0x01)
	TArray<FFriendInfo> NewFriends; // 0x4e8(0x10)
	TArray<FFriendInfo> CurrentFriends; // 0x4f8(0x10)
	UObject* CurrentFriendSession; // 0x508(0x08)
	enum class EBlueprintablePrivilegeResults CurrentOnliineBlockingReason; // 0x510(0x01)
	TArray<FString> AllServernameWords; // 0x518(0x10)
	bool UGCDisallowed; // 0x528(0x01)
	bool isManuallySorted; // 0x529(0x01)
	FBlueprintSessionResult CurrentJoiningModdedSession; // 0x530(0x108)
	FString CurrentJoiningModdedPassword; // 0x638(0x10)

	FEventReply OnKeyDown(FGeometry MyGeometry, FKeyEvent InKeyEvent);
	void GetWidgetMousePosition(UWidget* InWidget, FVector2D OutLocalPos);
	void GetHoveredEntryInfo(UITM_ServerList_Entry_C* EntryWidget, float WidgetMouseOffset, FString serverID);
	...
	void AddOrUpdateEntry(FBlueprintSessionResult Result, FString OutServerID, UITM_ServerList_Entry_C* OutWidget);
	...
	void BndEvt__BTN_DeepDives_K2Node_ComponentBoundEvent_13_OnClicked__DelegateSignature();
