...
struct UHUD_Main_C : UFSDMainHUDWidget {
	...
	UHUD_ExperimentalBranch_C* HUD_ExperimentalBranch; // 0x328(0x08)
	UHUD_Flashlight_C* HUD_Flashlight_C_1; // 0x330(0x08)
	UHUD_Frozen_C* HUD_Frozen; // 0x338(0x08)
	UHUD_Itembar_C* HUD_Itembar; // 0x340(0x08)
	UHUD_ItemWheel_C* HUD_ItemWheel; // 0x348(0x08)
	UHUD_Milestone_Manager_C* HUD_KPI_Manager; // 0x350(0x08)
	UHUD_MapTool_C* HUD_MapTool_209; // 0x358(0x08)
	UHUD_MinersManualNotification_Manager_C* HUD_MinersManualNotification_Manager; // 0x360(0x08)
	UMissionControl_MainDialogue_C* HUD_MissionShout; // 0x368(0x08)
	UHUD_MutatorsAndWarnings_3_C* HUD_MutatorsAndWarnings_4; // 0x370(0x08)
	UHUD_ActorContext_Manager_C* HUD_ObjectContext_Manager; // 0x378(0x08)
	UHUD_ObjectivesBox_C* HUD_Objectives; // 0x380(0x08)
	UHUD_Oxygen_C* HUD_Oxygen; // 0x388(0x08)
	UHUD_PlayerDown_C* HUD_PlayerDown; // 0x390(0x08)
	UHUD_PlayerInfo_C* HUD_PlayerInfo; // 0x398(0x08)
	UHUD_Radar2_C* HUD_Radar2; // 0x3a0(0x08)
	UHUD_Resources_Player_C* HUD_Resources_Player; // 0x3a8(0x08)
	UHUD_Resources_Team_C* HUD_Resources_Team; // 0x3b0(0x08)
	UHUD_SentryGunManager_C* HUD_SentryGunManager; // 0x3b8(0x08)
	UHUD_TeamDisplay_Small_C* HUD_TeamDisplay_Small; // 0x3c0(0x08)
	UHUD_ThrowCarriable_C* HUD_ThrowCarriable; // 0x3c8(0x08)
	UHUD_TutorialWidget_C* HUD_TutorialWidget; // 0x3d0(0x08)
	UHUD_Warning_Manager_C* HUD_Warning_Manager; // 0x3d8(0x08)
	URetainerBox* Retainer_BottomRight; // 0x3e0(0x08)
	URetainerBox* Retainer_Chat; // 0x3e8(0x08)
	URetainerBox* Retainer_TeamDisplay; // 0x3f0(0x08)
	URetainerBox* Retainer_UpperLeft; // 0x3f8(0x08)
	URetainerBox* Retainer_UpperRight; // 0x400(0x08)
	URetainerBox* RetainerBox_1; // 0x408(0x08)
	URetainerBox* RetainerBox_2; // 0x410(0x08)
	URetainerBox* RetainerBox_3; // 0x418(0x08)
	URetainerBox* RetainerBox_5; // 0x420(0x08)
	URetainerBox* RetainerBox_DamageClass_Indicator; // 0x428(0x08)
	URetainerBox* RetainerBox_DamageClass_Indicator_2; // 0x430(0x08)
	UCanvasPanel* TopBar; // 0x438(0x08)
	UUI_FPS_C* UI_FPS; // 0x440(0x08)
	UUI_NetInfo_C* UI_NetInfo; // 0x448(0x08)
	UOnScreenIndicator_UsableItem_WithDescription_C* Usable; // 0x450(0x08)
	UVerticalBox* V_BossFightAndSpeak; // 0x458(0x08)
	UVerticalBox* VBox_Events; // 0x460(0x08)
	UVerticalBox* VBox_Events_Left; // 0x468(0x08)
	UVerticalBox* VerticalBox_EventsAndSpeak; // 0x470(0x08)
	APlayerCharacter* Character; // 0x478(0x08)
	bool hudVisible; // 0x480(0x01)
	float FPS; // 0x484(0x04)
	UObjective* ObjDummy; // 0x488(0x08)
	UHUDVisibilityGroup* VG_Grenades; // 0x490(0x08)
	UHUDVisibilityGroup* VG_Flares; // 0x498(0x08)
	UHUDVisibilityGroup* VG_Flashlight; // 0x4a0(0x08)
