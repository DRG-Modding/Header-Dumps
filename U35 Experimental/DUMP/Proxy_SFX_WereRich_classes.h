// BlueprintGeneratedClass Proxy_SFX_WereRich.Proxy_SFX_WereRich_C
// Size: 0x238 (Inherited: 0x220)
struct AProxy_SFX_WereRich_C : AActor {
	...
	UFUNCTION(BlueprintCallable) void ExecuteUbergraph_Proxy_SFX_WereRich(int32_t EntryPoint);
};
