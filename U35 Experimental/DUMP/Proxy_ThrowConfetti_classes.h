// BlueprintGeneratedClass Proxy_ThrowConfetti.Proxy_ThrowConfetti_C
// Size: 0x238 (Inherited: 0x220)
struct AProxy_ThrowConfetti_C : AActor {
	...
	UFUNCTION(BlueprintCallable) void ExecuteUbergraph_Proxy_ThrowConfetti(int32_t EntryPoint);
};
