...
struct UITM_Tab_Modding_C : UUserWidget {
	...
	UUI_Modding_SortBy_C* SortByBox; // 0x2c0(0x08)
	URichTextBlock* TextTermsAndConditionsBlocked; // 0x2c8(0x08)
	UBasic_BoolUserSetting_C* UserSetting_CompactView; // 0x2d0(0x08)
	UVerticalBox* WaitBox; // 0x2d8(0x08)
	TArray<UUGCPackage*> ModsPendingInstall; // 0x2e0(0x10)
	TArray<UUGCPackage*> ModsPendingUninstall; // 0x2f0(0x10)
	TMap<FString, UITM_PendingMod_C*> WidgetsPendingInstall; // 0x300(0x50)
	FTimerHandle RefreshWaitHandle; // 0x350(0x08)
	bool CompactView; // 0x358(0x01)
	enum class EPackageSortField SortField; // 0x359(0x01)
	bool SortAscending; // 0x35a(0x01)
	TArray<UITM_Mod_C*> ModWidgetsDueForUpdate; // 0x360(0x10)
	UITM_Mod_C* ModWidgetDueForUpdate; // 0x370(0x08)
