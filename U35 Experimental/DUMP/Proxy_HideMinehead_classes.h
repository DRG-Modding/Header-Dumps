// BlueprintGeneratedClass Proxy_HideMinehead.Proxy_HideMinehead_C
// Size: 0x248 (Inherited: 0x220)
struct AProxy_HideMinehead_C : AActor {
	...
	UFUNCTION(BlueprintCallable) void ExecuteUbergraph_Proxy_HideMinehead(int32_t EntryPoint);
};
