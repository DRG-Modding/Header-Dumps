// BlueprintGeneratedClass Proxy_RotateDropPod.Proxy_RotateDropPod_C
// Size: 0x248 (Inherited: 0x220)
struct AProxy_RotateDropPod_C : AActor {
	...
	UFUNCTION(BlueprintCallable) void ExecuteUbergraph_Proxy_RotateDropPod(int32_t EntryPoint);
};
