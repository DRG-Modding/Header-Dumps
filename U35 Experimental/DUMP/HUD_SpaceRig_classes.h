...
struct UHUD_SpaceRig_C : UFSDUserWidget {
	...
	UHUD_ThrowCarriable_C* HUD_ThrowCarriable; // 0x2a0(0x08)
	UHUD_TutorialWidget_C* HUD_TutorialWidget_2; // 0x2a8(0x08)
	UMenu_ServerStatus_C* Menu_ServerStatus; // 0x2b0(0x08)
	USafeZone* PlatformSafeZone; // 0x2b8(0x08)
	URetainerBox* RetainerBox_3; // 0x2c0(0x08)
	UScreen_CharacterInfo_C* Screen_CharacterInfo; // 0x2c8(0x08)
	UUI_BeerBuff_Spacerig_C* UI_BeerBuff_Spacerig; // 0x2d0(0x08)
	UUI_CurvedCanvas_C* UI_CurvedCanvas; // 0x2d8(0x08)
	UUI_FPS_C* UI_FPS; // 0x2e0(0x08)
	UUI_NetInfo_C* UI_NetInfo; // 0x2e8(0x08)
	UOnScreenIndicator_UsableItem_WithDescription_C* Usable; // 0x2f0(0x08)
