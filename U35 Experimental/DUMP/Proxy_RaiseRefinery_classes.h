// BlueprintGeneratedClass Proxy_RaiseRefinery.Proxy_RaiseRefinery_C
// Size: 0x250 (Inherited: 0x220)
struct AProxy_RaiseRefinery_C : AActor {
	...
	UFUNCTION(BlueprintCallable) void ExecuteUbergraph_Proxy_RaiseRefinery(int32_t EntryPoint);
};
