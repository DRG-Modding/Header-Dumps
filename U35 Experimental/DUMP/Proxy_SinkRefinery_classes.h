// BlueprintGeneratedClass Proxy_SinkRefinery.Proxy_SinkRefinery_C
// Size: 0x250 (Inherited: 0x220)
struct AProxy_SinkRefinery_C : AActor {
	...
	UFUNCTION(BlueprintCallable) void ExecuteUbergraph_Proxy_SinkRefinery(int32_t EntryPoint);
};
