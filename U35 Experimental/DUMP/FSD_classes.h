...
struct UDamageComponent : UActorComponent {
	...
	bool ShattersArmor; // 0xf0(0x01)
	UDamageClass* DamageClass; // 0xf8(0x08)
	float WeakpointDamageMultiplier; // 0x100(0x04)
	float FrozenDamageBonusScale; // 0x104(0x04)
	float friendlyFireModifier; // 0x108(0x04)
	FGameplayTag FriendlyFireTag; // 0x10c(0x08)
	bool StaggerOnlyOnWeakpointHit; // 0x114(0x01)
	float StaggerChance; // 0x118(0x04)
	float StaggerDuration; // 0x11c(0x04)
	float FearFactor; // 0x120(0x04)
	TArray<UDamageBonusBase*> DamageBonuses; // 0x128(0x10)
	TArray<UDamageModifier*> DamageModifiers; // 0x138(0x10)
	TArray<UDamageTag*> DamageTags; // 0x148(0x10)
	bool UseAreaOfEffect; // 0x168(0x01)
	float RadialDamage; // 0x16c(0x04)
	bool NoFriendlyFireFromRadial; // 0x170(0x01)
	UDamageClass* RadialDamageClass; // 0x178(0x08)
	float MinDamagePct; // 0x180(0x04)
	float DamageRadius; // 0x184(0x04)
	float MaxDamageRadius; // 0x188(0x04)
...
struct UEliminationObjective : UObjective {
	...
	TArray<TSoftObjectPtr<UDebrisBase>> ObjectDebris; // 0x1a8(0x10)
...
struct UFacilityHackingPodAnimInstance : UAnimInstance {
	bool IsHacking; // 0x268(0x01)
	enum class EHackingPodState PodState; // 0x269(0x01)
	float RadarDishAngle; // 0x26c(0x04)
};
...
// Size: 0x2c8 (Inherited: 0x150)
struct UFacilityObjective : UObjective {
	TSoftClassPtr<UObject> generatorClass; // 0x160(0x28)
	TSoftClassPtr<UObject> GeneratorBeaconClass; // 0x188(0x28)
	int32_t GeneratorCount; // 0x1b0(0x04)
	int32_t ObjectivesStage; // 0x1b4(0x04)
	TArray<FSubObjective> SubObjectives; // 0x1b8(0x10)
	FDelegate OnFirstEncounterDroneSpawned_Delegate; // 0x1c8(0x10)
	FDelegate OnSecondEncounterDroneSpawned_Delegate; // 0x1d8(0x10)
	TArray<UEnemyDescriptor*> TurretDescriptors; // 0x210(0x10)
	TArray<UEnemyDescriptor*> GeneratorRoomTurretDescriptors; // 0x220(0x10)
	TArray<UEnemyDescriptor*> EncounterEnemies; // 0x230(0x10)
	float EncounterDifficulty; // 0x240(0x04)
	FRandInterval Diversity; // 0x248(0x10)
	FIRandRange TurretEncountersRange; // 0x258(0x08)
	int32_t MinimumTurretEncounters; // 0x260(0x04)
	FIRandRange TunnelTurretsRange; // 0x264(0x08)
	TArray<AActor*> SmallGenerators; // 0x270(0x10)
	ATetherStation* mainFacility; // 0x280(0x08)
	TArray<int32_t> ShieldGeneratorRooms; // 0x288(0x10)
	int32_t MainFacilityRoom; // 0x298(0x04)
	TArray<AActor*> ShieldGenerators; // 0x2a0(0x10)
	UResourceData* GoalResource; // 0x2b0(0x08)
	float AmountRequired; // 0x2b8(0x04)
	float AmountCollected; // 0x2bc(0x04)
	int32_t GeneratorsActivated; // 0x2c0(0x04)
...
struct AFSDGameState : AGameState {
	...
	uint32_t MissionStartTime; // 0x604(0x04)
	uint32_t MissionHaz; // 0x608(0x04)
	bool PreventLatejoinCharacterDuplication; // 0x60c(0x01)
	bool StartPressed; // 0x60d(0x01)
	bool ContinuePressed; // 0x60e(0x01)
	int32_t ContinuesCountdown; // 0x610(0x04)
	bool AllDwarvesDown; // 0x614(0x01)
	bool MissionAborted; // 0x615(0x01)
	int32_t CountdownRemaining; // 0x618(0x04)
...
struct UFSDGameUserSettings : UGameUserSettings {
	...
	FModdingUISettings ModdingUISettings; // 0x200(0x58)
	int32_t ServerSearchRegion; // 0x258(0x04)
	bool ServerSearchPasswordRequired; // 0x25c(0x01)
	float volumeCharacterVoice; // 0x260(0x04)
	float volumeMissionControl; // 0x264(0x04)
	float volumeMaster; // 0x268(0x04)
	float volumeSFX; // 0x26c(0x04)
	float volumeMusic; // 0x270(0x04)
	FString CurrentAudioOutputDeviceId; // 0x278(0x10)
	bool UseDefaultAudioOutputDevice; // 0x288(0x01)
	float Sharpening; // 0x28c(0x04)
	int32_t AntiAliasingType; // 0x290(0x04)
	bool TemporalAAUpsamplingEnabled; // 0x294(0x01)
	float volumeVoice; // 0x298(0x04)
	USoundClass* soundClassCharacterVoices; // 0x2a0(0x08)
	USoundClass* soundClassMissionControl; // 0x2a8(0x08)
	USoundClass* soundClassMaster; // 0x2b0(0x08)
	USoundClass* soundClassSFX; // 0x2b8(0x08)
	USoundClass* soundClassUI; // 0x2c0(0x08)
	USoundClass* soundClassMusic; // 0x2c8(0x08)
	USoundClass* soundClassVoice; // 0x2d0(0x08)
	int32_t ChatFontSize; // 0x2d8(0x04)
	bool bUseVoiceChat; // 0x2dc(0x01)
	bool bUsePushToTalk; // 0x2dd(0x01)
	FString LocalGameServerName; // 0x2e0(0x10)
	FString LocalGameServerNameFiltered; // 0x2f0(0x10)
	bool AppearOffline; // 0x300(0x01)
	bool AutoRefreshServerlist; // 0x301(0x01)
	float MouseXSensitivity; // 0x304(0x04)
	float MouseYSensitivity; // 0x308(0x04)
	bool UseSeperateSensetivity; // 0x30c(0x01)
	bool InvertMouse; // 0x30d(0x01)
	bool InvertScroolWheel; // 0x30e(0x01)
	bool UseHoldToRun; // 0x30f(0x01)
	bool UseToggleLaserpointer; // 0x310(0x01)
	float FOV; // 0x314(0x04)
	float HeadbobbingScale; // 0x318(0x04)
	float CameraShakeScale; // 0x31c(0x04)
	float ChatFadeTime; // 0x320(0x04)
	bool UseStreamerProgram; // 0x324(0x01)
	bool SoundOnChatMessage; // 0x325(0x01)
	bool PhotosensitiveMode; // 0x326(0x01)
	bool ShowUIAnimations; // 0x327(0x01)
	bool UseProfanityFilter; // 0x328(0x01)
	float ForceFeedbackScale; // 0x32c(0x04)
	bool InvertFlightControls; // 0x330(0x01)
	bool EnableDx12ByDefault; // 0x331(0x01)
	float HDRColorGamma; // 0x334(0x04)
	enum class EConsoleGraphicsMode ConsoleGraphicsMode; // 0x338(0x01)
	FHUDElements HUDElements; // 0x33c(0x78)
	FCharacterOptions CharacterOptions; // 0x3b4(0x02)
	float DownedTurnDirection_Controller; // 0x3b8(0x04)
	float DownedTurnDirection_Mouse; // 0x3bc(0x04)
	float UIDPIScale; // 0x3c0(0x04)
	bool EnableCustomUIScale; // 0x3c8(0x01)
	FMulticastInlineDelegate OnInputSourceChanged; // 0x3d0(0x10)
	bool CheckCursorOutOfBounds; // 0x3e0(0x01)
	FMulticastInlineDelegate OnEnableTutorialHintsChanged; // 0x3e8(0x10)
	FMulticastInlineDelegate OnShowFPSChanged; // 0x3f8(0x10)
	FMulticastInlineDelegate OnShowNetInfoLevelChanged; // 0x408(0x10)
	FMulticastInlineDelegate OnDx12Enabled; // 0x418(0x10)
	FIntPoint ResolutionToBeApplied; // 0x428(0x08)
	bool VSyncToBeApplied; // 0x430(0x01)
	bool Dx12ToBeApplied; // 0x431(0x01)
	enum class EWindowMode InFullscreenModeToBeApplied; // 0x432(0x01)
	bool InFullscreenModeToBeAppliedValid; // 0x433(0x01)
	bool VSyncToBeAppliedValid; // 0x434(0x01)
	bool Dx12ToBeAppliedValid; // 0x435(0x01)
	bool ResolutionToBeAppliedValid; // 0x436(0x01)
	bool EscMenuActive; // 0x437(0x01)
	bool bShowUpgradeExtraDetails; // 0x438(0x01)
	FMulticastInlineDelegate OnShowUpgradeExtraDetailsChanged; // 0x440(0x10)
	FMulticastInlineDelegate OnCustomKeyBindingsChanged; // 0x450(0x10)
	enum class EFSDInputSource CurrentInputSource; // 0x460(0x01)
	enum class EFSDInputSource RequestedInputSource; // 0x461(0x01)
	TArray<FCustomKeyBinding> CustomKeyBindings; // 0x468(0x10)
	TArray<FCustomKeyBinding> CustomControllerBindings; // 0x478(0x10)
	bool SwapControllerThumbsticks; // 0x488(0x01)
	bool bTutorialHintsEnabled; // 0x489(0x01)
	bool bShowSubtitles; // 0x48a(0x01)
	bool bShowFPS; // 0x48b(0x01)
	int32_t ShowNetInfoLevel; // 0x48c(0x04)
	bool bCanShowBlood; // 0x490(0x01)
	bool PreventLatejoinCharacterDuplication; // 0x491(0x01)
	bool TranslatorDebugModeEnabled; // 0x492(0x01)
	FString PreviousCulture; // 0x498(0x10)
	FControllerSettings ControllerSettings; // 0x4a8(0x0c)
	TArray<FGuid> SelectedDifficultyLevels; // 0x4b8(0x10)
...
struct UGameData : UObject {
	...
	UAfflictionSettings* AfflictionSettings; // 0x190(0x08)
	UCommunityGoalSettings* CommunityGoalSettings; // 0x198(0x08)
	UDailyDealSettings* DailyDealSettings; // 0x1a0(0x08)
	FGDMissionStats MissionStats; // 0x1a8(0x158)
	FGDMilestones Milestones; // 0x300(0x10)
	FGDPerks perks; // 0x310(0x90)
	FGDItemCategoryIDs ItemCategoryIDs; // 0x3a0(0x38)
	TArray<UTexture2D*> LoadoutIconList; // 0x3d8(0x10)
	UMinersManual* MinersManual; // 0x3e8(0x08)
	FGDDamageClasses DamageClasses; // 0x3f0(0x48)
	FGDStats Stats; // 0x438(0x128)
	FGDResources Resources; // 0x560(0xe0)
	FGDTerrainTypes TerrainTypes; // 0x640(0x10)
	FGDGameStatsTracking GameStatsTracking; // 0x650(0x20)
	FGDAudio Audio; // 0x670(0x50)
	FGDDifficulty Difficulty; // 0x6c0(0x10)
	UStatusEffectSettings* StatusEffects; // 0x6d0(0x08)
	FGDCharacterRetirement Retirement; // 0x6d8(0xc0)
	FGDPlayerAndCharacterProgression PlayerAndCharacterProgression; // 0x798(0xa0)
	UCharacterSettings* CharacterSettings; // 0x838(0x08)
	UAchievementList* Achievements; // 0x840(0x08)
	UDataTable* SchematicGATable; // 0x848(0x08)
	TArray<UMissionTemplate*> TestMissions; // 0x850(0x10)
	TSoftObjectPtr<UBiome> TestBiome; // 0x860(0x28)
	UGlobalMissionSetup* MissionSetup; // 0x888(0x08)
	TSoftClassPtr<UObject> CampaignManagerClass; // 0x890(0x28)
	UPlayerCharacterID* BoscoID; // 0x8b8(0x08)
	TMap<UPlayerCharacterID*, UInventoryList*> InventoryLists; // 0x8c0(0x50)
	UBiome* DefaultBiome; // 0x910(0x08)
	TArray<FText> GenericBiomeQuotes; // 0x918(0x10)
	UMissionTemplate* DefaultMission; // 0x928(0x08)
	USeasonSettings* SeasonSettings; // 0x930(0x08)
	AProceduralSetup* CaveGeneratorPLSClass; // 0x938(0x08)
	TArray<UItemRefundList*> ItemRefunds; // 0x940(0x10)
	TArray<USubsystem*> BlueprintSubSystems; // 0x950(0x10)
	UPlayerCharacterID* DefaultCharacterID; // 0x960(0x08)
	UPlayerCharacterID* DefaultEditorCharacterID; // 0x968(0x08)
	FGameplayTag XBoxExcludeRoomTag; // 0x970(0x08)
...
struct ALockOnBeam : AActor {
	...
	FBeamCollision Collision; // 0x298(0xa0)

	void ReceiveItemSet();
};

// Class FSD.LockOnWeapon
// Size: 0x858 (Inherited: 0x6d8)
struct ALockOnWeapon : AAmmoDrivenWeapon {
	...
	AActor* AimTarget; // 0x718(0x08)
	float LockOnDamageMultiplier; // 0x720(0x04)
	int32_t ShotsPerTarget; // 0x724(0x04)
	int32_t MaxTargets; // 0x728(0x04)
	float TimeBetweenLockedShots; // 0x72c(0x04)
	float LockOnTime; // 0x730(0x04)
	float MaxLockOnDegree; // 0x734(0x04)
	float LoseLockOnDegree; // 0x738(0x04)
	float DegreeTolerance; // 0x73c(0x04)
	float MaxLockOnRange; // 0x740(0x04)
	bool bPrioritizeLowHitPoint; // 0x744(0x01)
	bool bAlwaysHitTarget; // 0x745(0x01)
	float MaxLockOnDuration; // 0x748(0x04)
	bool bLockOnControlsSentryGun; // 0x74c(0x01)
	bool bSentryGunShootsOnLockedShot; // 0x74d(0x01)
	bool bLockedShotsIgnoreArmor; // 0x74e(0x01)
	UActorTrackingWidget* TrackingWidgetClass; // 0x750(0x08)
	ALockOnBeam* LockOnBeamClass; // 0x758(0x08)
	AActor* AoeActorClass; // 0x760(0x08)
	int32_t AoeHitCountThreshhold; // 0x768(0x04)
	bool UseLockOnTargetStatusEffect; // 0x76c(0x01)
	UStatusEffect* LockOnTargetStatusEffect; // 0x770(0x08)
	int32_t PushStatusEffectEveryXLock; // 0x778(0x04)
	int32_t LockOnCount; // 0x7a4(0x04)
	UDamageComponent* DamageComponent; // 0x7d8(0x08)
	UHitscanBaseComponent* HitscanComponent; // 0x7e0(0x08)
	FTracerData ChargedShotTracer; // 0x7e8(0x30)
	float ChargeSpeed; // 0x818(0x04)
	float SlowMovementAtCharge; // 0x81c(0x04)
	bool IsMovementSlowed; // 0x822(0x01)
	bool Charging; // 0x823(0x01)
	float ChargeProgress; // 0x824(0x04)
	bool LastShotWasLockedOn; // 0x828(0x01)
	float LockOnRecoilMult; // 0x82c(0x04)
...
struct APlayerCharacter : ACharacter {
	...
	float PerkActivationTimer; // 0x8a0(0x04)
	FMulticastInlineDelegate OnCanEscapeGrabberChanged; // 0x8a8(0x10)
	AActor* GrabbedByClass; // 0x8b8(0x08)
	USoundCue* PowerAttackRefreshedSound; // 0x8c0(0x08)
	FMulticastInlineDelegate OnCoolDownProgress; // 0x8c8(0x10)
	bool bIsBeingBittenByCaveLeech; // 0x8d8(0x01)
	UWidgetInteractionComponent* WidgetInteraction; // 0x8e0(0x08)
	TArray<FPlatformComponent> PlatformComponentClasses; // 0x8e8(0x10)
	FDownCameraSettings DownCameraSettings; // 0x90c(0x18)
	TArray<TWeakObjectPtr<AShieldGeneratorActor>> ActiveShieldGenerators; // 0x938(0x10)
	FGuid SaveGameID; // 0x94c(0x10)
	FVector EstimatedVelocity; // 0x95c(0x0c)
	FHoldButton FlareHeadlightButton; // 0x978(0x28)
	FHoldButton CycleItemButton; // 0x9a0(0x28)
	FHoldButton ToggleHUDButton; // 0x9c8(0x28)
	float EquipLaserpointerHoldDuration; // 0x9f0(0x04)
	bool IsPressingMovementInputKey; // 0x9f4(0x01)
	UPlayerCharacterID* characterID; // 0xa10(0x08)
	ATutorialManager* TutorialManagerType; // 0xa18(0x08)
	ATutorialManager* TutorialManagerSpacerig; // 0xa20(0x08)
	USkeletalMeshComponent* FPMesh; // 0xa28(0x08)
	UCameraComponent* FirstPersonCamera; // 0xa30(0x08)
	USceneComponent* FirstPersonRoot; // 0xa38(0x08)
	UActorTrackingComponent* ActorTracking; // 0xa40(0x08)
	UCharacterIntoxicationComponent* IntoxicationComponent; // 0xa48(0x08)
	UMissionStatsCollector* MissionStatsCollector; // 0xa50(0x08)
	USpringArmComponent* ThirdPersonSpringArm; // 0xa58(0x08)
	UCameraComponent* ThirdPersonCamera; // 0xa60(0x08)
	UPointLightComponent* ThirdPersonLight; // 0xa68(0x08)
	USpringArmComponent* FollowSpringArm; // 0xa70(0x08)
	UCameraComponent* FollowCamera; // 0xa78(0x08)
	UCameraComponent* DownCamera; // 0xa80(0x08)
	UCharacterCameraController* CameraController; // 0xa88(0x08)
	UPlayerHealthComponent* HealthComponent; // 0xa90(0x08)
	UCharacterSightComponent* SightComponent; // 0xa98(0x08)
	UInventoryComponent* InventoryComponent; // 0xaa0(0x08)
	UCharacterUseComponent* UseComponent; // 0xaa8(0x08)
	USingleUsableComponent* UsableComponent; // 0xab0(0x08)
	UOutlineComponent* OutlineComponent; // 0xab8(0x08)
	UTrailComponent* TrailComponent; // 0xac0(0x08)
	UCharacterRecoilComponent* RecoilComponent; // 0xac8(0x08)
	UStatusEffectsComponent* StatusEffectsComponent; // 0xad0(0x08)
	UPawnStatsComponent* PawnStatsComponent; // 0xad8(0x08)
	UPlayerAfflictionComponent* PawnAfflictionComponent; // 0xae0(0x08)
	UPlayerAttackPositionComponent* AttackerPositioningComponent; // 0xae8(0x08)
	UCommunicationComponent* CommunicationComponent; // 0xaf0(0x08)
	UPlayerTemperatureComponent* TemperatureComponent; // 0xaf8(0x08)
	UPlayerReactiveTerrainTrackerComponent* ReactiveTerrainTracker; // 0xb00(0x08)
	UInstantUsable* TrackGrindUsableComponent; // 0xb08(0x08)
	float RunningSpeed; // 0xb10(0x04)
	float RunBoost; // 0xb14(0x04)
	float RunBoostChargeTime; // 0xb18(0x04)
	USoundCue* RunBoostActivationSound; // 0xb20(0x08)
	UParticleSystem* RunBoostParticles; // 0xb28(0x08)
	UPawnAffliction* RunBoostAffliction; // 0xb38(0x08)
	UPhysicsAsset* HangingPhysicsAsset; // 0xb40(0x08)
	float HangingSimulationBlend; // 0xb48(0x04)
	bool IsPlayableCharacter; // 0xb54(0x01)
	UAudioComponent* SprintSoundComponent; // 0xb58(0x08)
	USoundCue* SpringSound; // 0xb60(0x08)
	FAnalogAimSettings AimSettings; // 0xb68(0x50)
	float DownedCameraMinPitch; // 0xbb8(0x04)
	float DownedCameraMaxPitch; // 0xbbc(0x04)
	float TurnToFaceScannerAngularSpeed; // 0xbc0(0x04)
	float CarryingMovementSpeedPenalty; // 0xbc4(0x04)
	float CarryingMaxFallVelocity; // 0xbc8(0x04)
	float MaxThrowProgress; // 0xbcc(0x04)
	float MaxThrowHoldDuration; // 0xbd0(0x04)
	float CarryingThrowMinForce; // 0xbd8(0x04)
	float CarryingThrowMaxForce; // 0xbdc(0x04)
	UStatusEffect* CarryingThrowingStatusEffect; // 0xbe8(0x08)
	float ThrowCarriableProgress; // 0xbf4(0x04)
	TMap<char, UCharacterStateComponent*> CharacterStates; // 0xbf8(0x50)
	TWeakObjectPtr<ATutorialManager> TutorialManager; // 0xc48(0x08)
	UCharacterStateComponent* ActiveCharacterState; // 0xc50(0x08)
	bool IsInDropPod; // 0xc5b(0x01)
	bool IsInEscapePod; // 0xc5c(0x01)
	float ButtonMemoryDuration; // 0xc60(0x04)
	bool IsRunning; // 0xc64(0x01)
	bool CanDash; // 0xc65(0x01)
	float DashInputWindow; // 0xc6c(0x04)
	float DashFowardMovementMinRequirement; // 0xc70(0x04)
	float DashRightMovementMaxRequirement; // 0xc74(0x04)
	float DashControllerMinValueRequired; // 0xc78(0x04)
	float DashCooldown; // 0xc7c(0x04)
	UStatusEffect* DashStatusEffect; // 0xc80(0x08)
	float ForwardInput; // 0xc88(0x04)
	float RightInput; // 0xc8c(0x04)
	float StoppedRunningTime; // 0xc9c(0x04)
	float ShoutPressedTime; // 0xca0(0x04)
	bool bIsUsingItemPressed; // 0xca4(0x01)
	bool bIsUsingPressed; // 0xca5(0x01)
	float UsingDelay; // 0xca8(0x04)
	bool HeadLightOn; // 0xcac(0x01)
	bool IsUsing; // 0xcad(0x01)
	float JumpPressedTime; // 0xcb0(0x04)
	bool CanMove; // 0xcb4(0x01)
	bool CanAim; // 0xcb5(0x01)
	bool CanUseItem; // 0xcb6(0x01)
	bool CanChangeItems; // 0xcb7(0x01)
	bool CanMine; // 0xcb8(0x01)
	bool IsStandingDown; // 0xcb9(0x01)
	bool InDanceRange; // 0xcba(0x01)
	bool IsDancing; // 0xcbb(0x01)
	float DanceStartTime; // 0xcbc(0x04)
	UFSDAchievement* HappyFeetAchievement; // 0xcc0(0x08)
	int32_t DanceMove; // 0xcc8(0x04)
	enum class ECharacterCameraMode CameraMode; // 0xccc(0x01)
	bool IsInCharacterSelectionWorld; // 0xccd(0x01)
	float IdleTime; // 0xcd0(0x04)
	UAnimMontage* FPDrinkSalute; // 0xcd8(0x08)
	UAnimMontage* TPDrinkSalute; // 0xce0(0x08)
	UDialogDataAsset* SaluteShout; // 0xce8(0x08)
	UDialogDataAsset* DrinkShout; // 0xcf0(0x08)
	UAnimMontage* CurrentSaluteMontage; // 0xcf8(0x08)
	TArray<UMaterialInterface*> CachedMaterials; // 0xd08(0x10)
	bool BlockTrackGrindOnLanded; // 0xd18(0x01)
	FHeroInfo HeroInfo; // 0xd30(0x88)
	FString SteamClassID; // 0xdb8(0x10)
	UMaterialInstanceDynamic* RadarMaterialInstance; // 0xdc8(0x08)
	int32_t RadarMaterialAngleParameterIndex; // 0xdd0(0x04)
	FVector LastUpdateVisibiltyPos; // 0xdd4(0x0c)
	FVector SpawnLocation; // 0xde0(0x0c)
	UFSDPhysicalMaterial* FallbackPhysicalMaterial; // 0xdf0(0x08)
	bool ClientReady; // 0xdf9(0x01)
	UCharacterStateComponent* NextCharacterState; // 0xe00(0x08)
	bool PlayerIsLeavingInDroppod; // 0xe10(0x01)
	bool CanInstantRevive; // 0xe1c(0x01)
	bool HasInitializedPerks; // 0xe1e(0x01)
	UCharacterVanityComponent* CharacterVanity; // 0xe28(0x08)
	FCameraSpringSettings CameraSpringSettings; // 0xe38(0x3c)
...
struct UPlayerHealthComponent : UHealthComponent {
	...
	UPlayerDamageTakenMutator* DamageTakenMutator; // 0x350(0x08)
	UStatusEffect* IronWillStatusEffectClass; // 0x360(0x08)
	UStatusEffect* IronWillStatusEffect; // 0x368(0x08)
	bool IronWillActive; // 0x370(0x01)
	float IronWillTimeToActivate; // 0x374(0x04)
...
struct USalvageObjective : UObjective {
	...
	TArray<TSoftObjectPtr<UDebrisBase>> Debris; // 0x180(0x10)
	...
	TArray<AMiniMule*> AllSalvageActors; // 0x210(0x10)
	TArray<AMiniMule*> SalvagedActors; // 0x220(0x10)
...
struct USeasonChallenge : USavableDataAsset {
	...
	UTexture2D* Icon; // 0x70(0x08)
	FLinearColor Color; // 0x78(0x10)
	TArray<FTrackedStatInfo> TrackedStats; // 0x88(0x10)
	TArray<FChallengeVariation> Variations; // 0x98(0x10)
	int32_t NumberOfChoices; // 0xa8(0x04)
	bool bIsSpecialChallenge; // 0xac(0x01)
	int32_t MaxOccurences; // 0xb0(0x04)
	TArray<UCampaign*> RequiredCampaigns; // 0xb8(0x10)
};
